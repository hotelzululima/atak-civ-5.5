...
protobuf_build: protobuf_win32_build_cmextraargs=-Dprotobuf_BUILD_SHARED_LIBS=ON -Dprotobuf_BUILD_PROTOC_BINARIES=OFF
protobuf_build: protobuf_win32_build_vssetup=$(VS_SETUP)
protobuf_build: cmake_check $(protobuf_hosttools_builttouchfile) $(protobuf_srctouchfile)
