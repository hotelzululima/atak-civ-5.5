...
jassimp_libfile=jassimp.dll
jassimp_local_libfile=$(assimp_local_srcdir)/$(assimp_builddir)/jassimp.dll
jassimp_out_implib=$(OUTDIR)/lib/$(jassimp_libfile)
	...
	cd $(assimp_local_srcdir)/$(assimp_builddir)               &&     \
	    $(VS_SETUP)                                                   \
	          ...
	          -DCMAKE_BUILD_TYPE=Release                              \
                  ...
                  ../                      &&                             \
	$(VS_SETUP) nmake assimp jassimp

$(assimp_local_libfile): assimp_build
$(assimp_local_implibfile): assimp_build

$(assimp_out_lib): $(assimp_local_libfile) $(jassimp_local_libfile) $(assimp_local_implibfile)
	$(CP) $(assimp_local_implibfile) $(assimp_out_implib)
	$(CP) $(jassimp_local_libfile) $(jassimp_out_implib)
