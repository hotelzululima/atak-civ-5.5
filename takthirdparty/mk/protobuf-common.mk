...
$(protobuf_hosttools_srctouchfile): $(protobuf_src)
	...
	patch -p0 -d $(protobuf_hosttools_srcdir) < $(protobuf_patch)
...
$(protobuf_hosttools_builttouchfile): protobuf_win32_build_cmextraargs=-Dprotobuf_BUILD_PROTOC_BINARIES=ON
...
$(protobuf_hosttools_builttouchfile): $(protobuf_hosttools_srctouchfile)
	cd $(protobuf_hosttools_srcdir)/protobuf && DIST_LANG=cpp ./configure --prefix="$(protobuf_hosttools_dir)"
