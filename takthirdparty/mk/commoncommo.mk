...
commoncommo_commotest=commotest
commoncommo_commotest_out=$(OUTDIR)/bin/$(commoncommo_commotest)
commoncommo_local_commotest=$(OUTDIR)/$(commoncommo_local_srcdir)/test/console/$(commoncommo_commotest)

commoncommo_test_targets=$(if $(commoncommo_BUILDTEST),$(commoncommo_commotest_out),)
...
.PHONY: commoncommo_buildtest
commoncommo_buildtest:
	$(MAKE) -C $(OUTDIR)/$(commoncommo_local_srcdir)/test/console  \
            TAKTHIRDPARTYDIR=$(OUTDIR_CYGSAFE)
...
$(commoncommo_local_commotest): commoncommo_buildtest
	@echo "commoncommo test app built"

$(commoncommo_commotest_out): $(commoncommo_local_commotest)
	$(CP) $< $@
...
commoncommo: $(commoncommo_out_lib) $(commoncommo_java_targets) $(commoncommo_objc_targets) $(commoncommo_test_targets)
...
commoncommo_clean:
	...
	rm -f $(commoncommo_commotest_out)
