...
$(OUTDIR)/lib/libc++_shared.so: $(ANDROID_NDK)/toolchains/llvm/prebuilt/$(android_host)/sysroot/usr/lib/i686-linux-android/libc++_shared.so
	$(CP) $< $@
...
CPP=i686-linux-android$(ANDROID_API_LEVEL)-clang -E
LD=ld
RANLIB=llvm-ranlib
AR=llvm-ar
STRIP=llvm-strip -S
...
CONFIGURE_TARGET=--host i686-linux-android$(ANDROID_API_LEVEL)
...
CFLAGS_generic:=-fPIC -mno-sse -fstack-protector-all
CFLAGS_release:=-O3
CFLAGS_debug:=-g -O0
...
openssl_CONFIG=ANDROID_NDK_HOME=$(ANDROID_NDK) ./Configure android-x86 no-shared no-module -D__ANDROID_API__=$(ANDROID_API_LEVEL) --prefix=$(OUTDIR_CYGSAFE) $(openssl_CFLAGS)
openssl_LDFLAGS=
