...
openssl_CONFIG=./config --prefix=$(OUTDIR_CYGSAFE) $(openssl_CFLAGS) -DPURIFY no-asm no-shared no-module
openssl_LDFLAGS=
...
curl_LIBS=
# Disable ipv6 on mac due to extra system library dependencies it pulls in
curl_EXTRACONFIG=--disable-ipv6
proj_LIBS=
libkml_LIBS=
