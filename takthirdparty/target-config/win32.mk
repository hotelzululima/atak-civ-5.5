...
openssl_CONFIG_debug=./Configure debug-VC-WIN32 no-asm no-module --prefix=$(OUTDIR_CYGSAFE)
openssl_CONFIG_release=./Configure VC-WIN32 no-asm no-module --prefix=$(OUTDIR_CYGSAFE)
...
mrsid_BINBUNDLE_v142=$(DISTFILESDIR)/mrsid/win32-v142.zip
