...
openssl_CONFIG_debug=./Configure debug-VC-WIN64A-masm no-asm no-module no-tests --prefix=$(OUTDIR_CYGSAFE)
openssl_CONFIG_release=./Configure VC-WIN64A-masm no-asm no-module no-tests --prefix=$(OUTDIR_CYGSAFE)
