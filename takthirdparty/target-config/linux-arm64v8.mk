...
STRIP=aarch64-linux-gnu-strip -S
...
CONFIGURE_TARGET=--host aarch64-linux-gnu
...
openssl_CONFIG=./Configure linux-aarch64 --cross-compile-prefix=aarch64-linux-gnu- --prefix=$(OUTDIR_CYGSAFE) --libdir=lib $(openssl_CFLAGS) -DPURIFY no-asm no-module
openssl_LDFLAGS=
