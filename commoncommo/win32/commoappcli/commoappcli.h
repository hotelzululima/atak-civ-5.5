...
namespace TAK {
    namespace Commo {
        namespace test {
            ...
            private ref class EnrollInfo
            {
            public:
                array<uint8_t> ^trust;
                System::String ^clientPass;
                System::String ^caPass;
                System::String ^host;
                int port;
            ...
            public ref class CommoAppCLI : public ICoTMessageListener, public IContactPresenceListener,
                ...
                public IMissionPackageIO, public ICloudIO, public IEnrollmentIO
            {
            public:
                CommoAppCLI();
                virtual ~CommoAppCLI();
            ...
            private:
                ...
                System::Collections::Generic::Dictionary<int, EnrollInfo ^> activeEnrollments;
