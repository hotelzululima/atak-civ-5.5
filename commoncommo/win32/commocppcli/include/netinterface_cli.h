...
namespace TAK {
        ...
        public enum class StreamingTransport {
            TransportTcp,
            TransportSsl,
            TransportQuic
        };
        ...
        public ref class QuicInboundNetInterface : public NetInterface
        {
        public:
            const int port;

        internal:
            QuicInboundNetInterface(atakmap::commoncommo::QuicInboundNetInterface *impl, const int port);
            virtual ~QuicInboundNetInterface();

            atakmap::commoncommo::QuicInboundNetInterface *impl;
        };
