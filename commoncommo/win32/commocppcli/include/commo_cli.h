...
namespace TAK {
    namespace Commo {
        ...
        public:
            ...
            * Returns IllegalArgument if enrollmentIO is null, or
            * if this method has previously been called successfully for this
            * Commo instance. Otherwise returns Success.
            * </summary>
            * <param name="enrollmentIO">
            * reference to an implementation of the IEnrollmentIO interface that
            * this Commo instance can use to interface with the application 
            * during enrollment transactions
            * </param>
            */
            CommoResult EnableEnrollment(IEnrollmentIO ^enrollmentIO);
            ...
            /**
             * <summary>Register an ICoTDetailExtender that implements a specific CoT detail
             * extension for TAK Protocol. The provided ICoTDetailExtender will be used
             ...
             * The provided ICoTDetailExtender implementation will remain in use
             ...
             * Returns Success if registration is successful, or IllegalArgument
             * if another Extender has already been registered for
             * the given extensionId or any other error occurs.
             * </summary>
             *
             * <param name="extensionId">
             * unique and centrally registered identifier for the
             * TAK protocol extension being implemented by extender
             * </param>
             * <param name="extensionDetailElement">
             * name of the element node of the cot detail
             * the extension handles
             * </param>
             * <param name="extender">
             * ICoTDetailExtender to register
             * </param>
             */
            CommoResult RegisterCoTDetailExtender(System::UInt32 extensionId, System::String ^extensionDetailElement, ICoTDetailExtender ^extender);

            /**
             * <summary>Deregister any previously registered ICoTDetailExtender for the given
             * extensionId.
             * This method may cause one or more active streaming connections to
             * terminate and re-establish to renegotiate the extensions in use.
             * Returns Success if deregistration is successful, or IllegalArgument
             ...
             * </param>
             */
            CommoResult DeregisterCoTDetailExtender(System::UInt32 extensionId);

            /**
             * <summary>Enable or disable the insertion of destination UIDs in outbound 
             ...
             * </summary>
             *
             * <param name="insertDestUid">
             * true to enable insertion of destination UID
            ...
            * </summary>
            * <returns>
            * On success, a QuicInboundNetInterface object uniquely
            * identifying the added interface.  Remains valid as long as
            * it is not passed to removeQuicInboundInterface. nullptr if
            ...
            * </returns>
            * <param name="port">
            * the local (udp) port number to listen on
            * </param>
            * <param name="certificate">
            * certificate store, with key, in pkcs12 format
            * </param>
            * <param name="certPass">
            ...
            * </summary>
            * <param name="iface">
            * previously added NetInterface to remove from service
            * </param>
            * <returns>
            * SUCCESS if iface is valid and successfully removed from use,
            ...
            */
            ...
            /**
                ...
                *
                * This method is deprecated; use the form taking a
                * StreamingTransport specification as the first argument.
                * </summary>
                * <param name="hostname">
                ...
                * </returns>
                */
            [System::Obsolete("this method is deprecated in favor of the new overloaded form which takes a StreamingTransport specification as first argument")]
            ...
            /**
                ...
                * sending of all types of CoT messages to specific contacts, 
                * as well as for broadcasting CoTMessages of the types specified.
                * The connection will use the underlying transport protcol
                * specified in the first arugment. 
                * For TCP, nullptr MUST be specified for for clientCert, trustStore,
                * username, and password as these cannot be utilized on plain TCP
                * connections.
                * For SSL and QUIC, clientCert and trustStore must be valid/non-nullptr. 
                * Additionally, with these transports, a non-nullptr username and password
                * will result
                ...
                * </param>
                * <param name="clientCert">
                * if the connection is SSL based, this holds the 
                ...
                * Use nullptr for non-SSL connections
                * </param>
                * <param name="trustStore">
                * if the connection is SSL based, this holds the
                ...
                * and password specified will be sent to the TAK server upon
                * connection.  if non-nullptr, password must also be non-nullptr.
                * Not used for non-SSL connections.
                * </param>
                * <param name="password">
                * the accompanying password to go with the username in the
                * authentication message
            ...
            * with the unique identifier (enrollmentId).  The enrollment operation
            * will not commence processing until EnrollmentStart() is invoked 
            * with the returned enrollmentId.  Once started, updates on progress
            * and completion status of the operation will be delivered to the
            * IEnrollmentIO interface implementation previously registered with this
            ...
            *
            * Returns IllegalArgument if arguments are missing or otherwise invalid,
            *    or this Commo instance as not yet had
            *    Enrollment enabled by calling EnableEnrollment().
            * Returns CommoInvalidTruststore if the caCert is invalid.
            * Returns CommoInvalidTruststorePassword if caCertPassword
            *    is incorrect.
            * Returns Success if the enrollment was setup successfully. This
            *    is the only return value where enrollmentId is set to a valid
            *    id.
            * </summary>
            *
            * <param name"enrollmentId">
            * populated with the unique id of the enrollment process
            * if return value is Success
            * </param>
            * <param name="host">
            * the hostname or IP address of the server to enroll with
            * </param>
            * <param name="port">
            * the port that the specified server is configured to
            * provide the enrollment API on
            * </param>
            * <param name="verifyHost">
            * true to verify that the server's SSL
            * certificate, provided during the https transaction,
            * matches the information provided in caCert
            * </param>
            * <param name="user">
            * username to use when authenticating to the server's
            * enrollment process. 
            * </param>
            * <param name="password">
            * password to use when authenticating to the server's
            * enrollment process when useTokenAuth is false,
            * or the token to use for authentication when
            * useTokenAuth is true
            * </param>
            * <param name="useTokenAuth">
            * Specifies authentication mode and how the password parameter
            * is interpreted.  Passing true will result in token
            * based authentication being used and false will result in basic
            * username/password authentication.
            * </param>
            * <param name="caCert">
            * a PKCS#12 certificate store to use when performing
            ...
            * password used to decrypt caCert. May be null
            * if (and only if) caCert is null
            * </param>
            * <param name="enrolledTrustPassword">
            * password the enrollment operation should
            * use to encrypt the trust/ca store resulting from the
            * enrollment
            * </param>
            * <param name="keyPassword">
            * password the enrollment operation should use to
            * encrypt the private key generated
            * </param>
            * <param name="keyLength">
            * length of private key to generate, in bits
            * </param>
            * <param name="clientVersionInfo">
            * version identifier the enrollment operation
            ...
            *
            * Returns IllegalArgument if the specified enrollment id is invalid
            * </summary>
            *
            * <param name="enrollmentId">
            * id of the previously initialized enrollment process
            * </param>
            */
            ...
            * </param>
            * <param name="access">
            * the value to use for the "access" attribute when
            ...
            * </param>
            * <param name="caveat">
            * the value to use for the "caveat" attribute when
            * generating CoT messages associated with this transfer.
            * It is assumed the passed value is valid; no checks
            * are performed on the value.
            * NULL will omit the attribute.
            * </param>
            * <param name="releasableTo">
            * the value to use for the "releasableTo" attribute
            * when generating CoT messages associated with this transfer.
            * It is assumed the passed value is valid; no checks
            * are performed on the value.
            * </param>
            * <returns>
            ...
            */
             ...
             * entirely complete.
             *
             * This method is now deprecated in favor of the overload which receives security-related parameters.
             * </summary>
             * <param name="xferId">
             * Assigned an integer that uniquely identifies this transfer;
             * this is assigned to only when ContactGone or Success is returned.
             ...
             * </returns>
             */
            [System::Obsolete("Use SendMissionPackageInit overload which takes security parameters")]
            CommoResult SendMissionPackageInit(
                int % xferId,
                System::Collections::Generic::List<System::String ^> ^destinations,
                System::String ^filePath,
