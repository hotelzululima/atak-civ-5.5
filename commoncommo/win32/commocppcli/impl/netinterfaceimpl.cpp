...
TAK::Commo::QuicInboundNetInterface::QuicInboundNetInterface(atakmap::commoncommo::QuicInboundNetInterface *impl, const int port) : impl(impl), port(port)
{
}
TAK::Commo::QuicInboundNetInterface::~QuicInboundNetInterface()
{
}
