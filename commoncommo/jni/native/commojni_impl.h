...
namespace commoncommo {
    ...
    class EnrollmentIOJNI : public EnrollmentIO
    {
    public:
        EnrollmentIOJNI(JNIEnv *env, jobject jenrollmentio) COMMO_THROW (int);
        static void destroy(JNIEnv *env, EnrollmentIOJNI *enrollio);

        virtual void enrollmentUpdate(const EnrollmentIOUpdate *update);
    ...
    private:
        ~EnrollmentIOJNI();
        jglobalobjectref jenrollmentio;

        static jmethodID jmethod_enrollmentUpdate;
        
        static jclass jclass_enrollmentIOUpdate;
        static jmethodID jmethod_enrollmentIOUpdateCtor;

        static const int NUM_ENROLLMENT_STEPS = 3;
        static jglobalobjectref nativeEnrollmentStepToJava[NUM_ENROLLMENT_STEPS];
    ...
    class CoTDetailExtenderJNI : public JNIObjWrapper,
                                 public CoTDetailExtender
    {
    public:
        CoTDetailExtenderJNI(JNIEnv *env, jobject jcotDetailExtender) COMMO_THROW (int);
        static void destroy(JNIEnv *env, CoTDetailExtenderJNI *extender);
        
        virtual CommoResult encode(uint8_t **encodedExtension, size_t *encodedSize, const char *cotDetailElement);
        virtual CommoResult decode(const char **cotDetailElement, const uint8_t *encodedExtension, size_t encodedSize);
        virtual void releaseEncodeResult(const uint8_t *resultBuffer);
        virtual void releaseDecodeResult(const char *resultBuffer);
        virtual jglobalobjectref getWrappedRef() const;
    ...
    private:
        ...
        jglobalobjectref jcotDetailExtender;

        static jmethodID jmethod_encode;
        static jmethodID jmethod_decode;
    };
    ...
    public:
        ...
        void enableEnrollment(JNIEnv *env, jobject jenrollmentio) COMMO_THROW (int);
        ...
        bool registerCoTDetailExtender(JNIEnv *env, jint jextId, 
                                       jstring jelement, jobject jextender);
        bool deregisterCoTDetailExtender(JNIEnv *env, jint jextId);
        ...
        jobject wrapTcpNetInterface(JNIEnv *env,
                                    ...
                                    jint port);
        jobject wrapQuicNetInterface(JNIEnv *env,
    ...
    private:
        ...
        EnrollmentIOJNI *enrollmentio;

    public:
        CommoLoggerJNI *logger;
        jint jaddrMode;

        typedef std::map<jint, CoTDetailExtenderJNI *> ExtendersMap;
        std::mutex extendersMutex;
        ExtendersMap extenders;
        ...
        static jclass jclass_quicnetiface;
        static jmethodID jmethod_quicnetifaceCtor;
