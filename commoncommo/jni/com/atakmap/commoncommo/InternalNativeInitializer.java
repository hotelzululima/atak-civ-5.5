...
final class NativeInitializer {
    ...
    private final static int ARCH_arm64 = 0x04;
    private final static int ARCH_arm32 = 0x08;
    ...
    static {
        ...
        libPaths.put(OS_LINUX|ARCH_arm64, "linuxarm64");
        libPaths.put(OS_LINUX|ARCH_arm32, "linuxarm32");
    }
    ...
    private static boolean deployNativeLibraries() {
        ...
        if(arch.toLowerCase().indexOf("aarch64") >= 0) {
            key |= ARCH_arm64;
        } else if(arch.toLowerCase().indexOf("arm") >= 0) {
            key |= ARCH_arm32;
        } else if(arch.toLowerCase().indexOf("64") >= 0) {
            key |= ARCH_x64;
