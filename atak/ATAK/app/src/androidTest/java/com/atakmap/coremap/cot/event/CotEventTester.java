...
public class CotEventTester extends ATAKInstrumentedTest {
    ...
    public void validUTF8() {
        ...
        CotDetail cd = ce.getDetail();
        CotDetail testDetail = cd.getChild("test");
        assertEquals("test", testDetail.getElementName());
        assertEquals("Бі не по", testDetail.getInnerText());

        testDetail = cd.getChild("test2");
        assertEquals("test2", testDetail.getElementName());
        assertEquals("Бі не по", testDetail.getInnerText());
    }

    @Test
    public void validWithTabs() {
        CotEvent ce = CotEvent.parse(getDacoValid());
        CotDetail cd = ce.findDetail("Plan");
        CotDetail log = cd.getChild("Log");
        assertNotNull(cd);
        assertNotNull(log);
        assertEquals("Affogatto-A", log.getAttribute("callsign"));
    }
    ...
    private String getValid4() {
        return "<?xml version=\"1.0\" standalone=\"yes\"?>" +
                ...
                +
                "<detail><test>&#x411;&#x456; &#x43D;&#x435; &#x43F;&#x43E;</test>"
                +
                "<test2> \t&#x411;&#x456; &#x43D;&#x435; &#x43F;&#x43E;</test2></detail></event>";

    }

    private String getDacoValid() {
        String result = "<Plan id=\"c91c30c3-bfa3-48f5-8b6c-394b94d3f585\"><Log callsign=\"Affogatto-A\"/></Plan>";
        String eventString = "<event version=\"2.0\" uid=\"a35fad2e-f329-4ea6-a979-85c6b3969ba7\" type=\"a-f-A-manifestmaker\" time=\"2020-07-25T01:07:45.00Z\" start=\"2020-07-25T01:07:45.00Z\" stale=\"2020-07-25T01:07:45.00Z\" how=\"h-g-i-g-o\">"
                +
