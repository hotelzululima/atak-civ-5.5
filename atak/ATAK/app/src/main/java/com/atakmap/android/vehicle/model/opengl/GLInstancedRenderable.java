...
public abstract class GLInstancedRenderable implements GLMapRenderable2 {
    ...
    public void draw(GLMapView view, int renderPass) {
        ...
        if (!view.currentPass.scene.equals(_lcs.sceneModel)) {
            ...
            view.currentPass.scene.mapProjection.forward(view.scratch.geo,
                    view.scratch.pointD);
            LocalCoordinateSystem.deriveFrom(view.currentPass.scene,
                    view.scratch.pointD,
                    _lcs);
            updateMatrices = true;
        }
    ...
    protected void updateMatrices(GLMapView view) {
        ...
        for (GLInstanceData data : _drawInstances) {
            ...
            localFrame.translate(-_lcs.origin.x, -_lcs.origin.y,
                    -_lcs.origin.z);
            if (view.currentPass.drawSrid == ECEFProjection.INSTANCE
