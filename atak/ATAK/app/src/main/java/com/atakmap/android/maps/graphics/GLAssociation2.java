...
public class GLAssociation2 extends AbstractGLMapItem2 implements
    ...
    public GLAssociation2(MapRenderer surface, Association subject) {
        ...
        subject.addOnMetadataChangedListener("ignoreRender", new MapItem.OnMetadataChangedListener() {
            @Override
            public void onMetadataChanged(MapItem item, String field) {
                ignoreRender = item.hasMetaValue("ignoreRender");
            }
        });
        ignoreRender = subject.hasMetaValue("ignoreRender");
    }
