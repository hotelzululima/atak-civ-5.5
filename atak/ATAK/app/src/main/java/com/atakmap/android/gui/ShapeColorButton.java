...
public class ShapeColorButton extends ImageButton
    ...
    public void setShape(@NonNull Shape shape) {
        ...
        final boolean filled = MathUtils.hasBits(shape.getStyle(),
                ...
                MathUtils.hasBits(shape.getStyle(), Polyline.STYLE_CLOSED_MASK);
        if (filled)
    ...
    public int getStrokeColor() {
        if (_showAlpha)
            ...
            return _strokeColor | 0xFF000000;
    }
                        ...
                        public void onClick(DialogInterface d, int w) {
                            ...
                            if (_shape != null) {
                                if (_showAlpha)
                                    ...
                                    _shape.setStrokeColor(stroke | 0xFF000000);

                                _shape.setFillColor(fill);
                            }
                            if (_selectListener != null) {
                                if (_showAlpha)
                                    _selectListener.onColorsSelected(stroke,
                                            fill);
                                else
                                    _selectListener.onColorsSelected(
                                            stroke | 0xFF000000, fill);
                            }
                        }
                    });
