...
public class ExportOBJTask extends ExportFileTask implements
    ...
    protected File doInBackground(Void... params) {
        ...
        ZipCommentInfo zipGeoref = new ZipCommentInfo();
        zipGeoref.location = center;
        zipGeoref.altitudeMode = ModelInfo.AltitudeMode.Absolute;
        zipGeoref.projection_srid = GdalLibrary.getSpatialReferenceID(ref);
        zipGeoref.projection_wkt = wkt;
        zipGeoref.envelope = model.getAABB();
        zipGeoref.localFrame.setToTranslation(utm.getEasting(),
                utm.getNorthing(), alt);
        ...
        try {
            zipDirectory(tmpDir, zipFile, zipGeoref.toString(), this);
