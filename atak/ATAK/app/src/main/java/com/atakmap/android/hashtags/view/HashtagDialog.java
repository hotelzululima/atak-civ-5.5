...
public class HashtagDialog implements View.OnClickListener,
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.add_tag) {
            ...
            StickyHashtags.getInstance().setEnabled(tag,
                    ((Switch) v).isChecked());
    ...
    private class HashtagAdapter extends BaseAdapter {
        ...
        public View getView(int position, View row, ViewGroup parent) {
            ...
            if (row.getTag() == null) {
                ...
                h.active = row.findViewById(R.id.enable_tag);
            } else {
            ...
            if (h.active != null) {
                h.active.setTag(tag);
                h.active.setOnCheckedChangeListener(HashtagDialog.this);
                h.active.setChecked(
                        StickyHashtags.getInstance().isEnabled(tag));
