...
import com.atakmap.map.formats.kmz.KMZTileReaderSpi;
...
public class NativeRenderingMapComponent extends AbstractMapComponent {
    ...
    private final static String TAG = "NativeRenderingMapComponent";
    ...
    private final static TileReaderSpi2 GDAL_TILEREADER_SPI = new TileReaderSpi2() {
        ...
        public TileReader create(String uri, TileReaderFactory.Options opts) {
            ...
            try {
                ...
                if (dataset != null) {
                    ...
                    // force tiles to a _reasonable_ size to avoid situations like GeoTIFF scanline
                    // "tiles"
                    tileWidth = MathUtils.clamp(tileWidth, 256, 512);
                    tileHeight = MathUtils.clamp(tileHeight, 256, 512);
            ...
            Log.e(TAG, "Failed to open dataset " + uri, error);
            return null;
        }
        ...
        public boolean isSupported(String uri) {
            ...
            try {
                ...
                // ATAK-16488 - in any type of exception when opening a dataset from a path, return false
                return false;
            } finally {
                if (ds != null)
                    ds.delete();
    ...
    public void onCreate(Context context, Intent intent, MapView view) {
        synchronized (NativeRenderingMapComponent.class) {
            ...
            if (GdalLibrary.isInitialized()) {
                ...
                GLMapLayerFactory.registerSpi(GLMosaicMapLayer2.SPI);
