...
public class ServerListDialog {
    ...
    public interface Callback {
         ...
         */
        void onSelected(com.atakmap.comms.TAKServer server);
    }
     ...
     */
    public void show(String title, final com.atakmap.comms.TAKServer[] servers,
        ...
        b.setAdapter(adapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                com.atakmap.comms.TAKServer server = adapter.getItem(i);
                if (server == null) {
                    Log.w(TAG,
    ...
    public static void selectServer(Context context, String message,
            TAKServer[] servers, final Callback callback) {
        ...
        dialog.show(message, servers, new Callback() {
            @Override
            public void onSelected(com.atakmap.comms.TAKServer server) {
                TAKServer cp = null;
                if (server != null)
                    cp = new TAKServer(server);
                if (callback != null)
    ...
    public static String getBaseUrl(com.atakmap.comms.TAKServer server) {
    ...
    private static class ServerListArrayAdapter extends
            ArrayAdapter<com.atakmap.comms.TAKServer> {

        private final Context context;
        private final int layoutResourceId;
        private final com.atakmap.comms.TAKServer[] data;

        ServerListArrayAdapter(Context context, int layoutResourceId,
                com.atakmap.comms.TAKServer[] data) {
        ...
        public View getView(int position, View convertView,
            ...
            com.atakmap.comms.TAKServer server = data[position];
