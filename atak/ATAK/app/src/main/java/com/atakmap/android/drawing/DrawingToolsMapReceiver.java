...
public class DrawingToolsMapReceiver extends DropDownReceiver implements
    ...
    private final MapGroup.OnItemListChangedListener onKMLLoadedListener = new MapGroup.OnItemListChangedListener() {
        ...
        public void onItemAdded(final MapItem item, MapGroup group) {
            ...
            AttributeSet metaMap = item.getMetaAttributeSet("kmlExtendedData");
            String uid = null;

            if (metaMap != null)
                uid = (String) metaMap.getStringAttribute("uid");
            ...
            if (item instanceof Polyline) {
                ...
                if (points.length > 1100) {
                    Toast.makeText(
                            _context,
                            R.string.kml_large_number_of_points,
    ...
    public void onReceive(Context ignoreCtx, Intent intent) {
                ...
                b.setPositiveButton(R.string.yes, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface d, int w) {
                        MetricsUtils.record(MetricsUtils.CATEGORY_MAPITEM,
                                ...
                                "DrawingToolsMapReceiver",
                                fItem, MetricsUtils.EVENT_STATUS_SUCCESS);
                ...
                b.setNegativeButton(R.string.cancel, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        MetricsUtils.record(MetricsUtils.CATEGORY_MAPITEM,
                                MetricsUtils.EVENT_MAPITEM_REMOVED,
                                "DrawingToolsMapReceiver",
                                fItem, MetricsUtils.EVENT_STATUS_CANCELLED);
                    }
                });
                b.show();
                break;
        ...
        if (action.equals("com.atakmap.android.maps.TOOLSELECTOR_READY")) {
            ...
            PendingIntent act = PendingIntent.getBroadcast(context,
                    this.hashCode(),
                    myLocationIntent, PendingIntentHelper
                            .adaptFlags(0));
