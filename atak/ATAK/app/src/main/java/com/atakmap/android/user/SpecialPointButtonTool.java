...
public abstract class SpecialPointButtonTool extends Tool {
    ...
    public boolean onToolBegin(Bundle bundle) {
        ...
        skipDetailClosure = bundle.getBoolean("skipDetailClosure", false);
    ...
    public void onToolEnd() {
        ...
        if (_marker != null) {
            if (!skipDetailClosure) {
                hidePointDetails(_marker);
            }
        }
        super.onToolEnd();
    }
    ...
    protected void createMarker(final String assetURL,
        ...
        createMarker(assetURL, uid, callsign, menu, deleteAction, new Bundle());
    }
    ...
    protected void createMarker(final String assetURL,
        ...
        if (_marker == null) {
            ...
            _marker.setMetaString("parent_type",
                    _mapView.getMapData().getMetaString("deviceType", null));
            ...
            _marker.setMetaBoolean("remoteDelete", false);
        ...
        if (_marker.hasMetaValue("previouslyDisplayed")
            ...
            final GeoPoint point = bundle.getParcelable("point");
            if (point != null && _marker != null) {
    ...
    private final MapEventDispatcher.MapEventDispatchListener _mapClickListener = new MapEventDispatcher.MapEventDispatchListener() {
        ...
        public void onMapEvent(MapEvent event) {
            ...
            final boolean editing = _marker.getEditing();
            if (!editing)
                _marker.setEditing(true);
            _marker.setPoint(gp);
            if (!editing)
                _marker.setEditing(false);
    ...
    private boolean skipDetailClosure;

    private void hidePointDetails(Marker _marker) {
        // in the scenario where the tool is not still running and was
        Intent intent = new Intent(
    ...
    private void hideMenu(Marker _marker) {
        Intent intent = new Intent();
