...
public class TilesetMapComponent extends AbstractMapComponent {
    ...
    public void onCreate(Context context, Intent intent, MapView view) {
        synchronized (TilesetMapComponent.class) {
            ...
            DatasetDescriptorFactory2
                    .register(StreamingContentDatasetDescriptorSpi.INSTANCE);
            /** 
            ...
            prefs.registerListener(this.prefListener);
            this.prefListener.onSharedPreferenceChanged(prefs.getSharedPrefs(),
                    "wms_connect_timeout");
    ...
    protected void onDestroyImpl(Context context, MapView view) {
        AtakPreferences.getInstance(
                context).unregisterListener(this.prefListener);
    }
