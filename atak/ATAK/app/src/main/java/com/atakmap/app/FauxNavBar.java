...
public class FauxNavBar implements OnSharedPreferenceChangeListener {
    ...
    public FauxNavBar(final Activity a) {
        this.activity = a;
        this.prefs = AtakPreferences.getInstance(activity);
    ...
    /**
     * Attempt to simulate the current disappearing nav bar, so that the user experience within
    ...
    void setupFauxKeys() {
        ...
        } else if (prefs.get("faux_nav_bar", false)) {
            show();
        } else {
            hide();
        }
    ...
    private void setup() {
        ...
        if (!prefs.get("faux_nav_bar_reverse", false)) {
    ...
    private final View.OnClickListener recentAction = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            try {
                ...
                if (retbinder != null) {
                    String name = retbinder
                            .getInterfaceDescriptor();
                    if (name != null) {
                        Class statusBarClass = Class.forName(name);
