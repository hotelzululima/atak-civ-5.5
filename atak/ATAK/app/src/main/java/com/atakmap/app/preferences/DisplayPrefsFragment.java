...
public class DisplayPrefsFragment extends AtakPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Preference basicDisplayPreference = findPreference(
        ...
        Preference usableSettings = findPreference(
                "usableSettings");
        usableSettings
                .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    @Override
        ...
        Preference dexOptions = findPreference("dexOptions");
        dexOptions
                .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    @Override
                    public boolean onPreferenceClick(Preference preference) {
        ...
        Preference threeDRendering = findPreference("3DRendering");
        threeDRendering
                .setOnPreferenceClickListener(new OnPreferenceClickListener() {
