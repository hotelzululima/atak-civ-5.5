...
public interface HierarchyListItem {
    ...
    final class Builder {
        interface OnRefreshListener {
            HierarchyListItem.Sort onRefresh(HierarchyListItem.Sort sortHint);
        }

        private BuilderItem _item;

        public Builder(String title) {
            _item = new BuilderItem(title);
        }
        ...
        public Builder setPreferredListIndex(int index) {
            _item._preferredListIndex = index;
            return this;
        }

        // XXX - add child/children

        public Builder setIcon(String iconUri, int iconColor) {
            _item._iconUri = iconUri;
            _item._iconColor = iconColor;
            return this;
        }

        public Builder setAction(Action action) {
            _item._actions.add(action);
            return this;
        }

        public Builder setUserObject(Object userObject) {
            _item._userObject = userObject;
            return this;
        }

        public Builder setExtraView(View extraView) {
            _item._extraView = extraView;
            return this;
        }

        public Builder setOnRefreshListener(OnRefreshListener l) {
            _item._onRefreshListener = l;
            return this;
        }

        public HierarchyListItem build() {
            final BuilderItem item = _item;
            _item = new BuilderItem(item);
            return item;
        }
    }
}
