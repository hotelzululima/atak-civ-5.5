    ...
    public View getView(final int position, View convertView,
        ...
        convertView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) { //When long pressed, prompt for color selection
                ...
                if (color == HostileListItem.BLUE) {
                    group.check(R.id.blue_btn);
                } else if (color == HostileListItem.GREEN) {
                    group.check(R.id.green_btn);
                } else if (color == HostileListItem.YELLOW) {
                    group.check(R.id.yellow_btn);
                } else if (color == HostileListItem.RED) {
                    group.check(R.id.red_btn);
                } else {
                    group.check(R.id.white_btn);
                }
