...
public class RangeAndBearingTool extends ButtonTool implements
    ...
    public boolean onToolBegin(Bundle extras) {
        ...
        if (extras.containsKey("startingUID")) {
            ...
            if (endpoint instanceof PointMapItem)
                ...
                GeoPoint touchPoint = endpoint.getClickPoint();
                if (touchPoint != null) {
    ...
    View.OnLongClickListener onLongClickListener = new View.OnLongClickListener() {
        ...
        public boolean onLongClick(View view) {
            ...
            MetricsUtils.record(MetricsUtils.CATEGORY_TOOL,
                    MetricsUtils.EVENT_LONG_CLICKED,
                    "RangeAndBearingTool", "RangeAndBearingButton",
    ...
    void makeRabWidget() {
        if (_pt1 != null && _pt2 != null) {
            ...
            if (rab != null) {
                ATAKUtilities.setAuthorInformation(rab);
                AccessUtils.setAccessDefault(rab);
        ...
        switch (event.getType()) {
            ...
            case MapEvent.MAP_LONG_PRESS:
                MetricsUtils.record(MetricsUtils.CATEGORY_MAPITEM,
                        ...
                        "RangeAndBearingTool", "point " +
                                ((_pt1 != null) ? "2" : "1") + " selected");
