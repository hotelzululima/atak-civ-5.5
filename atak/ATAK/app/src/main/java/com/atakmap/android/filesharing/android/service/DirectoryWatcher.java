 ...
 *
 * @deprecated in 5.8, will no longer implement {@link ImportListener}
 */
@Deprecated
@DeprecatedApi(since = "5.5")
public class DirectoryWatcher extends FileObserver implements ImportListener, ImportResolver.ImportListener {
    ...
    public void startWatching() {
        if (!IOProviderFactory.isDefault()
            ...
            ImportResolverCallbackRegistry.getInstance().registerImportListener(this);
        }
        super.startWatching();
    }
    ...
    public void stopWatching() {
        super.stopWatching();
        ImportResolverCallbackRegistry.getInstance().unregisterImportListener(this);
    }
}
