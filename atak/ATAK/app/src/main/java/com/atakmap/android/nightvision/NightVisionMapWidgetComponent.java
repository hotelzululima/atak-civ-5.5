...
public class NightVisionMapWidgetComponent extends AbstractWidgetMapComponent
    ...
    protected void onCreateWidgets(final Context context, Intent intent,
        ...
        _prefs = AtakPreferences.getInstance(view
                .getContext());
        ...
        launchNightVisionLocation(_prefs.getSharedPrefs());//add the NV type if available onStart()
        ...
        view.postDelayed(new Runnable() {
            ...
            public void run() {
                if (!AppMgmtUtils.isInstalled(view.getContext(),
                        "com.atak.nightvision")) {
                    _prefs.set("night_vision_widget", false);
                    return;
                }
                launchNightVisionLocation(_prefs.getSharedPrefs());
            }
        }, 99);
    }
