...
public class AltTelephoneConnector extends Connector {

    public final static String CONNECTOR_TYPE = "connector.alttelephone";

    private final String _phoneNumber;

    public AltTelephoneConnector(String phoneNumber) {
    ...
    public String getConnectionLabel() {
        return MapView.getMapView().getContext()
                .getString(R.string.telephone_alternative);
    }
