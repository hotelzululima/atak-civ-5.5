...
public class RoutePanelViewModel {
    ...
    /**
     * Set the current speed units as part of the StateMode.
     * @param units the units as defined by 0  = MPH, 1 = km/h, 2 = Kts, 3 = MPS
     */
    ...
    public Pair<Double, String> getFormattedDistance(double distanceInMeters,
        ...
        switch (units) {
            ...
            case 1:
            case 3: // also used for meters per second
