...
public class MCIAGRGMapOverlay extends AbstractMapOverlay2 {
    ...
    private static class GRGListModel extends AbstractHierarchyListItem2
        ...
        GRGListModel(Context context, BaseAdapter listener,
            ...
            this.numFeatures = Parsers.parseInt(layerInfo.getExtraData("numFeatures"), 0);
            ...
            try {
                db = new PersistentDataSourceFeatureDataStore3(dbFile);
            } catch (Exception e) {
                if (dbFile.exists())
                    dbFile.delete();
                db = new PersistentDataSourceFeatureDataStore3(dbFile);
        ...
        public Set<HierarchyListItem> find(String terms) {
            ...
            params.order
                    .add(new FeatureQueryParameters.Order.Name());
