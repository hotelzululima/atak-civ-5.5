...
public class ViewShedLayer2 extends HeatMapOverlay {
    ...
    private int opacityUnseen = 50;
    private int opacitySeen = 50;
    ...
    public int getOpacitySeen() {
        return this.opacitySeen;
    }

    public void setOpacitySeen(int opacity) {
        int val = Math.max(1, Math.min(99, opacity));
        if (val != opacitySeen) {
            opacitySeen = val;
    ...
    public void setOpacityUnseen(int opacity) {
        int val = Math.max(1, Math.min(99, opacity));
        if (val != opacityUnseen) {
            opacityUnseen = val;
            this.dispatchOpacityChangedNoSync();
        }
    }

    public int getOpacityUnseen() {
        return this.opacityUnseen;
    }
