...
public class MissionPackageMapComponent extends AbstractWidgetMapComponent
    ...
    private boolean enableCommsFileSharing() {
        ...
        if (legacyEnabled) {
            try {
                unsecurePort = Integer
                        .parseInt(_prefs.get(WebServer.SERVER_PORT_KEY,
        ...
        try {
            securePort = Integer
                    .parseInt(_prefs.get(WebServer.SECURE_SERVER_PORT_KEY,
                            String.valueOf(
     ...
     * @return array of configured TAK servers
     */
