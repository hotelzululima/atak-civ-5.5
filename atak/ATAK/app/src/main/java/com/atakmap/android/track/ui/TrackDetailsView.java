...
public class TrackDetailsView extends LinearLayout implements
    ...
    public void init(MapView mapView, MapGroup mapGroup, TrackDetails track,
        ...
        _mapView = mapView;
        _prefs = AtakPreferences.getInstance(getContext());
    ...
    public void refresh() {
        ...
        // Update units
        final int spanUnits = Integer.parseInt(
                _prefs.get("rab_rng_units_pref", String.valueOf(Span.METRIC)));
    ...
    public void onClick(View v) {
        ...
        // Create new track
            ...
            TrackHistoryDropDown.promptNewTrack(_prefs.getSharedPrefs(),
                    _mapView, true);
        ...
        // Track line color
            ...
            palette.setColor(_track.getColor());
            b.setView(palette);
        ...
        // Change distance units
            ...
            try {
                units = Integer.parseInt(_prefs.get("rab_rng_units_pref",
            ...
            b.setSingleChoiceItems(adapter, units,
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface d, int w) {
                            _prefs.set("rab_rng_units_pref", String.valueOf(w));
                            refresh();
                            d.dismiss();
                        }
                    });
    ...
    private void showPolyline() {
        ...
        if (gi == null || gi != _track.getPolyline()) {
            if (gi != null)
                gi.removeFromGroup();
            int rad = Integer.parseInt(_prefs.get("track_crumb_size", "10"));
