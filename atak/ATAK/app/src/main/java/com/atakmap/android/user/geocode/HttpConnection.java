...
public class HttpConnection {
    ...
    private static final String LOG_TAG = "GeocoderHttpConnection";
    ...
    public HttpConnection() {
        ...
        /* useful?
        HttpProtocolParams.setContentCharset(httpParameters, FileSystemUtils.UTF8_CHARSET);
        HttpProtocolParams.setHttpElementCharset(httpParameters, FileSystemUtils.UTF8_CHARSET);
        */
