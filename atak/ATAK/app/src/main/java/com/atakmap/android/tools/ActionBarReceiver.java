...
public class ActionBarReceiver extends BroadcastReceiver implements
        NavButtonsVisibilityListener, Disposable {

    private static final String TAG = "ActionBarReceiver";

    public static final String SETTINGS_TOOL = "Settings";
    public static final String LAYOUT_MGR = "Toolbar Manager";
    public static final String QUIT_TOOL = "Quit";
    ...
    public ActionBarReceiver(Activity activity) {
        ...
        _instance = this;
        mActivity = activity;
        _prefs = AtakPreferences.getInstance(mActivity);
    ...
    private void clear(final View v) {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                Log.d(TAG,
                        "clearing tool view: " + v.getClass().getSimpleName());
    ...
    public static int getUserIconColor() {
        int color = 0;
        if (_prefs != null) {
            color = Color.parseColor(_prefs.get(
    ...
    private void addToolbarView(ViewGroup container, ActionBarView view) {
        ...
        if (view.showCloseButton() && view.findViewById(R.id.close) == null) {
            ...
            ImageButton closeBtn = (ImageButton) inflater.inflate(
                    R.layout.toolbar_close_button, container, false);
