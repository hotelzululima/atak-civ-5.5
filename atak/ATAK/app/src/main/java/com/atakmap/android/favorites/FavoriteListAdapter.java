...
public class FavoriteListAdapter extends BaseAdapter {
    ...
    //Note when this changes or is incremented please file a jira ticket so WinTAK can
    //also update this to support a new version of favorites.txt -SPA, seems to be some disconnect
    //when this changes WinTAK isnt updated to support new VERSION int in file.
    ...
    protected void setText(ViewHolder holder, int position) {
        ...
        CoordinateFormat coordForm = CoordinateFormat.find(_prefs.get(
                "coord_display_pref",
