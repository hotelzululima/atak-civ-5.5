...
public class DrawingToolsMapComponent extends AbstractWidgetMapComponent {
    ...
    private ShapeMsdDropDownReceiver _shapeMsdDropDownReceiver;
    ...
    protected void onCreateWidgets(Context context, Intent intent,
        ...
        try {
            ...
            _shapeMsdDropDownReceiver = new ShapeMsdDropDownReceiver(view,
                    context);
            DocumentedIntentFilter msd_filter = new DocumentedIntentFilter();
            msd_filter.addAction(ShapeMsdDropDownReceiver.MSD_ACTION,
                    "Intent to set or remove a minimum safe distance boundary around a shape.");

            AtakBroadcast.getInstance()
                    .registerReceiver(_shapeMsdDropDownReceiver, msd_filter);
            ...
            milSym = new MilSym(context, view);
    ...
    protected void onDestroyWidgets(Context context, MapView view) {
        ...
        if (_shapeMsdDropDownReceiver != null) {
            AtakBroadcast.getInstance()
                    .unregisterReceiver(_shapeMsdDropDownReceiver);
            _shapeMsdDropDownReceiver.disposeImpl();
        }
        _shapeMsdDropDownReceiver = null;
