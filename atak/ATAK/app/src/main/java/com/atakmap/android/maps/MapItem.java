...
public abstract class MapItem extends FilterMetaDataHolder implements
    ...
    public final static Comparator<MapItem> ZORDER_RENDER_COMPARATOR = new Comparator<MapItem>() {
        ...
        public int compare(MapItem item0, MapItem item1) {
            ...
            // continue in the case where they are both not null
    ...
    protected static final EventSet mapItemEventSet;
    private static final EventSet.Parameters1<OnVisibleChangedListener, MapItem> onVisibleChanged;
    private static final EventSet.Parameters1<OnTypeChangedListener, MapItem> onTypeChanged;
    private static final EventSet.Parameters1<OnClickableChangedListener, MapItem> onClickableChanged;
    private static final EventSet.Parameters1<OnZOrderChangedListener, MapItem> onZOrderChanged;
    private static final EventSet.Parameters1<OnHeightChangedListener, MapItem> onHeightChanged;
    private static final EventSet.Parameters1<OnAltitudeModeChangedListener, AltitudeMode> onAltitudeModeChanged;
    private static final EventSet.Parameters2<OnGroupChangedListener, MapItem, MapGroup> onGroupAdded;
    private static final EventSet.Parameters2<OnGroupChangedListener, MapItem, MapGroup> onGroupRemoved;
    private static final EventSet.Parameters2<OnMetadataChangedListener, MapItem, String> onMetaDataChanged;

    protected final EventSet.Listeners eventListeners = createEventListeners();

    /**
     * Create the event set listeners for this type. Must be overridden by derived classes
     * that wish to define further events.
     *
     * @return EventSet.Listeners instance
     */
    protected EventSet.Listeners createEventListeners() {
        return mapItemEventSet.createListeners();
    }

    static {
        EventSet.Builder builder = new EventSet.Builder("MapItem");
        onVisibleChanged = builder.addEvent(
                new EventSet.Invoker1<OnVisibleChangedListener, MapItem>() {
                    @Override
                    public void invoke(OnVisibleChangedListener listener,
                            MapItem mapItem) {
                        listener.onVisibleChanged(mapItem);
                    }
                });
        onTypeChanged = builder.addEvent(
                new EventSet.Invoker1<OnTypeChangedListener, MapItem>() {
                    @Override
                    public void invoke(OnTypeChangedListener listener,
                            MapItem mapItem) {
                        listener.onTypeChanged(mapItem);
                    }
                });
        onClickableChanged = builder.addEvent(
                new EventSet.Invoker1<OnClickableChangedListener, MapItem>() {
                    @Override
                    public void invoke(OnClickableChangedListener listener,
                            MapItem mapItem) {
                        listener.onClickableChanged(mapItem);
                    }
                });
        onZOrderChanged = builder.addEvent(
                new EventSet.Invoker1<OnZOrderChangedListener, MapItem>() {
                    @Override
                    public void invoke(OnZOrderChangedListener listener,
                            MapItem mapItem) {
                        listener.onZOrderChanged(mapItem);
                    }
                });
        onHeightChanged = builder.addEvent(
                new EventSet.Invoker1<OnHeightChangedListener, MapItem>() {
                    @Override
                    public void invoke(OnHeightChangedListener l,
                            MapItem mapItem) {
                        l.onHeightChanged(mapItem);
                    }
                });
        onAltitudeModeChanged = builder.addEvent(
                new EventSet.Invoker1<OnAltitudeModeChangedListener, AltitudeMode>() {
                    @Override
                    public void invoke(OnAltitudeModeChangedListener l,
                            AltitudeMode altitudeMode) {
                        l.onAltitudeModeChanged(altitudeMode);
                    }
                });
        onGroupAdded = builder.addEvent(
                new EventSet.Invoker2<OnGroupChangedListener, MapItem, MapGroup>() {
                    @Override
                    public void invoke(OnGroupChangedListener l,
                            MapItem mapItem, MapGroup mapGroup) {
                        l.onItemAdded(mapItem, mapGroup);
                    }
                });
        onGroupRemoved = builder.addEvent(
                new EventSet.Invoker2<OnGroupChangedListener, MapItem, MapGroup>() {
                    @Override
                    public void invoke(OnGroupChangedListener l,
                            MapItem mapItem, MapGroup mapGroup) {
                        l.onItemRemoved(mapItem, mapGroup);
                    }
                });
        onMetaDataChanged = builder.addEvent(
                new EventSet.Invoker2<OnMetadataChangedListener, MapItem, String>() {
                    @Override
                    public void invoke(OnMetadataChangedListener l,
                            MapItem mapItem, String key) {
                        l.onMetadataChanged(mapItem, key);
                    }
                });
        mapItemEventSet = builder.build();
    }
    ...
    MapItem(long serialId, MetaDataHolder2 metadata, final String uid) {
        super(metadata);
        _globalId = serialId;
    ...
    public void addOnClickableChangedListener(
        ...
        eventListeners.addListener(onClickableChanged, listener);
    }
    ...
    public void addOnVisibleChangedListener(OnVisibleChangedListener listener) {
        eventListeners.addListener(onVisibleChanged, listener);
    }
    ...
    public void addOnTypeChangedListener(OnTypeChangedListener listener) {
        eventListeners.addListener(onTypeChanged, listener);
    }
    ...
    public void removeOnClickableChangedListener(
            OnClickableChangedListener listener) {
        eventListeners.removeListener(onClickableChanged, listener);
    }
    ...
    public void removeOnVisibleChangedListener(
        ...
        eventListeners.removeListener(onVisibleChanged, listener);
    }
    ...
    public void removeOnTypeChangedListener(OnTypeChangedListener listener) {
        eventListeners.removeListener(onTypeChanged, listener);
    }
    ...
    public void addOnZOrderChangedListener(OnZOrderChangedListener listener) {
        eventListeners.addListener(onZOrderChanged, listener);
    }
    ...
    public void removeOnZOrderChangedListener(
        ...
        eventListeners.removeListener(onZOrderChanged, listener);
    }
    ...
    public void addOnMetadataChangedListener(
        ...
        eventListeners.addListener(onMetaDataChanged, listener);
    }
    ...
    public void removeOnMetadataChangedListener(
            OnMetadataChangedListener listener) {
        eventListeners.removeListener(onMetaDataChanged, listener);
    }
    ...
    /**
     * Marks the feature as being in an interactive _editing_ state. This flag
     * may be used as a hint by the rendering subsystem to give updates to this
     * item priority over other items during refresh.
     *
     * <P>Implementation supporting interactive updates is not massively
     * scalable. Clients making use of this hint should take care to only mark
     * those items that are interactively being updated and only for the
     * duration of those updates. Marking large numbers of items as _editing_
     * will cause significant performance degradation.
     *
     * @param editing   {@code true} if the item is being interactively edited,
     *                  {@code false} otherwise
     */
    public void setEditing(boolean editing) {
        this.setMetaBoolean("editing", editing);
    }

    /**
     * Returns a flag indicating whether or not the item is being interactively
     * edited by the user.
     *
     * @return  {@code true} if the item is being interactive edited,
     *          {@code false} otherwise
     *
     * @see #setEditing(boolean)
     */
    public boolean getEditing() {
        return this.getMetaBoolean("editing", false);
    }
    ...
    protected void onClickableChanged() {
        onClickableChanged.invoke(eventListeners, this);
    }
    ...
    protected void onVisibleChanged() {
        onVisibleChanged.invoke(eventListeners, this);
    }
    ...
    protected void onTypeChanged() {
        onTypeChanged.invoke(eventListeners, this);
    }
    ...
    protected void onZOrderChanged() {
        onZOrderChanged.invoke(eventListeners, this);
    }
    ...
    protected void onHeightChanged() {
        onHeightChanged.invoke(eventListeners, this);
    }
    ...
    protected void onAltitudeModeChanged() {
        ...
        // Fire listeners
        onAltitudeModeChanged.invoke(eventListeners, _altitudeMode);
    }
    ...
    public void notifyMetadataChanged(final String key) {
        onMetaDataChanged.invoke(eventListeners, this, key);
    }
    ...
    public void addOnGroupChangedListener(OnGroupChangedListener listener) {
        eventListeners.addListenerToProperties(listener, onGroupAdded,
                onGroupRemoved);
    }

    public void removeOnGroupChangedListener(OnGroupChangedListener listener) {
        eventListeners.removeListenerFromProperties(listener, onGroupAdded,
                onGroupRemoved);
    }

    protected void onGroupChanged(boolean added, MapGroup mapGroup) {
        if (added)
            onGroupAdded.invoke(eventListeners, this, mapGroup);
        else
            onGroupRemoved.invoke(eventListeners, this, mapGroup);
    }
    ...
    public void addOnHeightChangedListener(OnHeightChangedListener listener) {
        eventListeners.addListener(onHeightChanged, listener);
    }
    ...
    public void removeOnHeightChangedListener(
        ...
        eventListeners.removeListener(onHeightChanged, listener);
    }
    ...
    public void addOnAltitudeModeChangedListener(
        ...
        eventListeners.addListener(onAltitudeModeChanged, listener);
    }

    public void removeOnAltitudeModeChangedListener(
            OnAltitudeModeChangedListener listener) {
        eventListeners.removeListener(onAltitudeModeChanged, listener);
    }
    ...
    public void setMetaString(String key, String value) {
        ...
        final String prevVal = getMetaString(key, null);
    ...
    public void setMetaAttributeSet(String key, AttributeSet attributeSet) {
        super.setMetaAttributeSet(key, attributeSet);
        onMetadataChanged(key);
    }
