...
class VideoFolderHierarchyListItem extends VideoBrowserHierarchyListItem
        implements Visibility2, GroupDelete,
        HierarchyListStateListener {
    private static final String TAG = "VideoFolderHierarchyListItem";
    ...
    public Object toObjectOf(Class<?> target, ExportFilters filters)
        ...
        if (VideoExportWrapper.class.equals(target)) {
            ...
            for (Exportable e : exports) {
                ...
                if (!(o instanceof VideoExportWrapper))
                    continue;
                mp.getExports().addAll(((VideoExportWrapper) o).getExports());
            }
            return mp;
