...
public class NavigationFeedbackService
    ...
    @Override
    public synchronized void onNavigationStarted(RouteNavigator navigator,
            Route route) {
    ...
    @Override
    public synchronized void onNavigationStopping(RouteNavigator navigator,
            Route route) {
        ...
        if (routeNavigationViewModel != null)
