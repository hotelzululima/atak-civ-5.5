...
public class VideoBrowserMapOverlay extends AbstractMapOverlay2
        implements View.OnClickListener, VideoManager.Listener, Disposable {
    ...
    public class ListModel extends VideoFolderHierarchyListItem {
        ...
        protected List<ConnectionEntry> getEntries() {
            ...
            if (vm != null) {
                ...
                // to appease the null pointer exception in ATAK-17807
        ...
        public Drawable getIconDrawable() {
            return _context.getDrawable(R.drawable.nav_video);
        }
