...
public class GLCircleCrumb extends GLPointMapItem2 implements
    ...
    private void drawCircle(GLMapView ortho) {
        ...
        GLES20FixedPipeline.glTranslatef(ortho.currentPass.focusx,
                ortho.currentPass.focusy, 0f);
        GLES20FixedPipeline.glTranslatef(xpos - ortho.currentPass.focusx, ypos
                - ortho.currentPass.focusy, 0f);
    ...
    private void _updateOrthoVerts(GLMapView ortho) {
        ortho.currentPass.scene.forward(point, ortho.scratch.pointF);
    ...
    public void batch(GLMapView view, GLRenderBatch2 batch, int renderPass) {
        ...
        view.currentPass.scene.forward(point, view.scratch.pointF);
