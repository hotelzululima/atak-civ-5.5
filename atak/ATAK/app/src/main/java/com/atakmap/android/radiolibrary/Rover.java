...
public class Rover implements RoverDropDownReceiver.RadioStatusListener {
                ...
                .setOnCheckedChangeListener(new OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(
                        ...
                        if (isChecked) {
                            ...
                            roverToggleService.submit(new Runnable() {
                                @Override
                                public void run() {
    ...
    private final ExecutorService roverToggleService = Executors
            .newSingleThreadExecutor(new NamedThreadFactory("roverToggle"));
