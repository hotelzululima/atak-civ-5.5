...
public class RangeAndBearingMapComponent extends AbstractMapComponent {
    ...
    private BullseyeDetailHandler2 _bullseyeHandler;
    ...
    public void onCreate(Context context, Intent intent, MapView view) {
        AtakPreferences sp = AtakPreferences.getInstance(view.getContext());

        int ftToMiThresh = 5280;
        try {
            ftToMiThresh = Integer.parseInt(
                    sp.get("rng_feet_display_pref", String.valueOf(5280)));
        ...
        try {
            mToKmThresh = Integer.parseInt(
                    sp.get("rng_meters_display_pref", String.valueOf(2000)));
        } catch (NumberFormatException ignored) {
        }
        ...
        _bullseyeHandler = new BullseyeDetailHandler2();
        CotDetailManager.getInstance().registerHandler(_bullseyeHandler);
        ...
        // Bullseye
        _importers.add(
                new BullseyeMapItem.BullseyeMarkerImporter(view, _rabGroup));
    ...
    public void onDestroyImpl(Context context, MapView view) {
        ...
        CotDetailManager.getInstance().unregisterHandler(_bullseyeHandler);
        try {
