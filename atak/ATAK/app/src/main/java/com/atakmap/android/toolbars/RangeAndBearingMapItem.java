...
public class RangeAndBearingMapItem extends Arrow implements
    ...
    public RangeAndBearingMapItem(PointMapItem pt1, PointMapItem pt2,
        ...
        _northReference = NorthReference
                .findFromValue(Integer.parseInt(_prefs.get("rab_north_ref_pref",
                        String.valueOf(NorthReference.MAGNETIC.getValue()))));

        _bearingUnits = Angle
                .findFromValue(Integer.parseInt(_prefs.get("rab_brg_units_pref",
        ...
        try {
            setRangeUnits(
                    Integer.parseInt(_prefs.get("rab_rng_units_pref",
        ...
        setDisplaySlantRange(_prefs.get("rab_dist_slant_range", "clamped")
                .equals("slantrange"));
        ...
        try {
            _color = Color
                    .parseColor(_prefs.get("rab_color_pref", "red"));
    ...
    public static List<RangeAndBearingMapItem> getUsers(PointMapItem point) {
        ...
        rabItems = RangeAndBearingMapComponent.getGroup().getItems();
    ...
    private void updateLabel() {
        ...
        if (this.getMetaBoolean("displayBloodhoundEta", false)) {
            ...
            if (_prefs.get("rab_preference_show_eta", false)
    ...
    /**
     * For a range and bearing line, the changes to the global north reference and angular unit are
    ...
    public void onSharedPreferenceChanged(SharedPreferences sp,
        ...
        switch (key) {
            ...
            case "rab_dist_slant_range":
                setDisplaySlantRange(
                        _prefs.get("rab_dist_slant_range", "clamped")
                                .equals("slantrange"));
                break;
    ...
    public void setMetaBoolean(String key, boolean value) {
        ...
        if (changed && _onBooleanChanged != null) {
            ((RangeAndBearingDropDown) _onBooleanChanged).updateUnits();
        }
    }
