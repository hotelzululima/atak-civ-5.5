...
public class PanEditTextPreference extends EditTextPreference {
    ...
    protected void onClick() {
        super.onClick();
        MetricsUtils.record(MetricsUtils.CATEGORY_PREFERENCE,
                MetricsUtils.EVENT_PREFERENCE_CLICKED, "",
                getKey());
    }

    /**
     * Convenience method to automatically install the EmojiExclusion filter along with any other filters
     * that are provided.    
     ...
     * @param maxVal the maximum value supported by rhe preference
     *
     */
