...
public class DeviceProfileOperation extends HTTPOperation {
    ...
    public Bundle execute(Context context, Request request)
        ...
        try {
            ...
            if (portType == SslNetCotPort.Type.CERT_ENROLLMENT)
                httpClient = new TakHttpClient(baseUrl, sslSocketFactory);
            else {
                httpClient = TakHttpClient.GetHttpClient(baseUrl,
                        NetConnectString.fromString(
                                profileRequest.getServerConnectString()));
            }
