    ...
    protected Boolean doInBackground(Void... arg0) {
        ...
        try {
            ...
            if (CommsProviderFactory.getProvider()
                    .hasFeature(CommsProvider.CommsFeature.UNKNOWN_CONTACT)) {
                //If we are sending to unknown contacts, e.g. in an ICN environment,
                //a successful send is a successful upload.
                sendListener.mpUploadDone(true, null);
            }
        } catch (Exception ex) {
