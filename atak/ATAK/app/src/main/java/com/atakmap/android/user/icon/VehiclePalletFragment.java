...
public class VehiclePalletFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setGroup(_prefs.get(PREF_SELECTED_GROUP, "default"));
    ...
    private void setGroup(String group) {
        ...
        _prefs.set(PREF_SELECTED_GROUP, group);
    }
    ...
    public void onClick(View v) {
        if (v == _colorBtn) {
            ...
            palette.setColor(getVehicleColor());
            b.setView(palette);
    ...
    private int getVehicleColor() {
        return _prefs.get(PREF_SELECTED_COLOR, Color.GREEN);
    }
    ...
    protected MapItem getPointPlacedIntent(GeoPointMetaData gp, String uid) {
        ...
        int alpha = _prefs.get("shape_fill_alpha", 150);
