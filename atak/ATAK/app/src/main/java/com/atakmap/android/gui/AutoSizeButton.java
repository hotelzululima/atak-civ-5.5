 ...
 * <a href="https://stackoverflow.com/questions/5033012/auto-scale-textview-text-to-fit-within-bounds/5535672#5535672">TextView Autoscale</a>
 */
    ...
    private void resizeText() {
        ...
        while (getTextSize() > MIN_SIZE
            ...
            metrics = getPaint().getFontMetrics(); // old FontMetrics object is not valid after
                                                   // setTextSize() call
            width = getPaint().measureText(getText().toString());
        }
    }
}
