...
public class ATAKApplication extends Application {
    ...
    public void onCreate() {
        ...
        // set the filesystem root prior to loading any system components
        FileSystemUtils.setMountPoint(
                BuildConfig.REQUIRE_APP_DATA_STORAGE ? getFilesDir() : null);
        ...
        Log.d(TAG, "finished initialization in: "
    ...
    public static class CustomExceptionHandler implements
        ...
        public void uncaughtException(@NonNull Thread t, @NonNull Throwable e) {
            ...
            // (see https://issues.tak.gov/browse/ATAK-8098)
            ...
            // for the occurrence of secondary crash logs.
            try {
    ...
    private static class ActivityLifecycleHandler implements
        ...
        public void onActivityCreated(@NonNull Activity activity,
            ...
            //Log.d(TAG, "activity created: " + activity.getClass());
        ...
        public void onActivityResumed(@NonNull Activity activity) {
            //Log.d(TAG, "activity resumed: " + activity.getClass());
            currentActivity = activity;
        }
        ...
        public void onActivityStarted(@NonNull Activity activity) {
            //Log.d(TAG, "activity started: " + activity.getClass());
        }
    ...
    /**
     * Returns the current running activity in the ATAKApplication
