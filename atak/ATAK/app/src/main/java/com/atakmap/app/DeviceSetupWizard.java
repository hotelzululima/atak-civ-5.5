...
class DeviceSetupWizard implements CredentialsDialog.Callback {
    ...
    private void init_settings() {
        ...
        d.addButton(r.getDrawable(R.drawable.customize_actionbar_pref_icon),
                r.getString(R.string.action_bar_experience))
        ...
        d.addButton(r.getDrawable(R.drawable.nav_data_package),
                r.getString(R.string.mission_package_name))
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MissionPackageUtils.importMissionPackage(_context);
                    }
                });
        d.addButton(r.getDrawable(R.drawable.nav_plugins),
        ...
        d.addButton(r.getDrawable(R.drawable.nav_import),
        ...
        d.addButton(r.getDrawable(R.drawable.ic_link_eud),
                r.getString(R.string.actionbar_link_eud))
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(
                                EudApiDropDownReceiver.ACTION_LINK_EUD);
                        i.putExtra(EudApiDropDownReceiver.EXTRA_WORKFLOW_DIALOG,
                                true);
    ...
    private void init_creds() {
        ...
        int renewCertBeforeExpirationDays = sharedPreferences.get(
        ...
        for (Properties properties : cotStreamProperties) {
            ...
            final boolean enrollForCertificateWithTrust = !properties
                    ...
                    .equals("0");
            final boolean enrollUseTrust = !properties
                    .getProperty("enrollUseTrust", "1")
                    .equals("0");
    ...
    public void onCredentialsEntered(final String connectString,
        ...
        final boolean enrollUseTrust = prefs.getBoolean(
                "enrollUseTrust" + connectionIndex, true);
