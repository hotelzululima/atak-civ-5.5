...
public class FiresToolbar implements
        IToolbarExtension2, OnTouchListener, View.OnLongClickListener,
        ...
        if (_toolbarView == null) {
            ...
            mgrsGoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!prefs.get("rapid_mgrs_dialog", false)) {
                        Intent i = new Intent();
            ...
            prefs = AtakPreferences.getInstance(_mapView
                    .getContext());
    ...
    public Drawable getToolbarIcon() {
        return _mapView.getContext().getDrawable(R.drawable.ic_menu_fires);
    }
