...
public class SpeedFormatter implements
    ...
    private final AtakPreferences _pref;
    ...
    private SpeedFormatter() {
        ...
        _pref = AtakPreferences.getInstance(MapView
                .getMapView().getContext());
        _pref.registerListener(this);

        String type = _pref.get("speed_unit_pref", Integer.toString(MPH));
