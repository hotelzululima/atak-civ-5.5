...
public final class LayersNotificationManager {
    ...
    private static class NotificationImpl implements Impl {
        ...
        private void notifyUpdate(Context ignored2, boolean important) {
            ...
            if (summaryDirty) {
                ...
                if (summaryBuilder != null) {
                    synchronized (notificationLock) {
                        try {
                            this.summaryBuilder
                                    .setContentTitle("Loading Imagery ("
                                            + successful + " Loaded, " + failed
                                            + " Failed)");
                            NotificationUtil.getInstance().postNotification(
                                    this.notificationId,
                            ...
                            // ATAK-19714 ATAK Crash - ArrayIndexOutOfBoundsException - LayersNotificationManager
                        }
                    }
                }
