...
public class KMZExportMarshal extends KMLExportMarshal {
    ...
    public static void addFile(ZipOutputStream zos, String zipEntry,
        ...
        // Note, here we don't use write buffering as we've already got the whole
        // event in RAM...
    ...
    public static InputStream getInputStream(Context context, String file)
        ...
        } else if (file.startsWith("android.resource:")) {
            Uri uri = Uri.parse(file);
            in = context.getContentResolver().openInputStream(uri);
            Log.d(TAG, "resource input stream: " + file);
        } else if (file.startsWith("base64:")) {
            byte[] data = Base64.decode(file.substring("base64://".length()),
