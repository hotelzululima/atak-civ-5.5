...
public class DangerCloseReceiver extends DropDownReceiver implements
    ...
    public interface ExternalMunitionQuery {
        /**
         * Retrieves a munition list in xml format, otherwise null if no munitions exist.
         */
    ...
    private RelativeLayout favoritesToolbar;
        ...
        switch (action) {
            ...
            case OPEN:
                ...
                if (_category != null) {
                    ...
                    // off last.
                    final int screen = _prefs.get("msdred.screen", 0);
                    if (screen > 0)
    ...
    public void onDropDownVisible(boolean v) {
        ...
        setItemsVisible(_fromLine, hide.isChecked());
    ...
    protected void removeMunitionFromAllTargets(String weapon,
        ...
        for (MapItem i : _mapGroup.getItems()) {
            ...
            if (tar != null) {
                ...
                AttributeSet metaData = tar.getAttributes();
                // retrieve munitions meta data
                AttributeSet munitionsMap = metaData
                        .getAttributeSetAttribute("targetMunitions");
                if (munitionsMap != null) {
                    // make sure weapon is removed from the specified category
                    AttributeSet categoryMap = munitionsMap
                            .getAttributeSetAttribute(category);
                    if (categoryMap != null) {
                        AttributeSet weaponMap = categoryMap
                                .getAttributeSetAttribute(weapon);
                        if (weaponMap != null) {
                            // remove weapon
                            categoryMap.removeAttribute(weapon);
                            bRemoveRangeRing = true;
                            // Clear out category if empty
                            if (categoryMap.getAttributeNames().isEmpty()) {
                                //remove category from target munitions
                                munitionsMap.removeAttribute(category);
                            }
                        }
                    }
                }
    ...
    private void setViewToMode() {
        switch (mode) {
            ...
            case DEFAULT:
                ...
                favoritesToolbar.setVisibility(View.GONE);
                addCustom.setVisibility(View.GONE);
            ...
            case FAVORITES_VIEW:
                ...
                exit.setVisibility(View.VISIBLE);
                customToolbar.setVisibility(View.GONE);
                favoritesToolbar.setVisibility(View.VISIBLE);
