...
import com.atakmap.android.hashtags.overlay.HashtagDeleteSelect;
...
public class HashtagMapComponent extends DropDownMapComponent {
    ...
    public void onCreate(Context context, Intent intent, MapView view) {
        ...
        HierarchySelectHandler.register(HashtagDeleteSelect.class,
                new HashtagDeleteSelect(MapView.getMapView()));
    }
