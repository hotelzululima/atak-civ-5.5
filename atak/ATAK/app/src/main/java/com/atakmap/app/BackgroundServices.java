...
public class BackgroundServices extends Service implements LocationListener,
    ...
    public void onCreate() {
        ...
        Log.d(TAG, "oncreate started for the BackgroundService");
        _instance = this;
        ...
        Log.d(TAG, "initializing the local instance of constants");
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            try {
                ...
                Log.e(TAG,
                        "unable to start the foreground service with the ServiceInfo specified, attempting legacy start",
                        se);
                Log.e(TAG, "permission AccessFineLocation = "
                        + Permissions.checkPermission(this,
                                Manifest.permission.ACCESS_FINE_LOCATION));
                Log.e(TAG, "permission AccessCoarseLocation = "
                        + Permissions.checkPermission(this,
                ...
                try {
                    ...
                    Log.e(TAG,
                            "unable to start the foreground service using the legacy start",
                            t);
                }
            }
        } else {
            ...
            if (Permissions.checkPermission(this,
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    try {
                        ...
                        Log.e(TAG, "error occurred registering gps listener",
                                e);
                    }
        ...
        Log.d(TAG, "starting text to speech engine");
        ...
        Log.d(TAG, "oncreate finished for the BackgroundServices");
