...
public class GLDogHouse extends AbstractGLMapItem2 implements
    ...
    public void draw(GLMapView ortho, int renderPass) {
        ...
        ortho.currentPass.scene.forward(midpoint, ortho.scratch.pointD);
        // check clip
        ...
        if (sprites) {
            if (geometryDirty || _vertices == null) {
                ...
                if (ortho.currentPass.drawSrid == 4326)
                ...
                ortho.currentPass.scene.inverse(new PointF(
        ...
        if (surface) {
            ...
            ortho.currentPass.scene.forward(_doghouseOriginGeo,
