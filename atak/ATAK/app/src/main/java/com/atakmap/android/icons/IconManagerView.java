 ...
 */
public class IconManagerView extends LinearLayout implements Disposable {
    ...
    private void setDefaultCoTMapping() {
        ...
        String currentMapping = getDefaultCoTMapping(_prefs.getSharedPrefs());
        boolean forceMapping = getForceCoTMapping(_prefs.getSharedPrefs());
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int item,
                ...
                switch (item) {
                    case 0: {
                        setDefaultCoTMapping(_prefs.getSharedPrefs(),
                ...
                setForceCoTMapping(_prefs.getSharedPrefs(),
                        force_iconset.isChecked());
     ...
     * 
     * @param prefs the shared preferences to use to get the default mapping.
