...
public class HeatMapOverlay extends AbstractHierarchyListItem implements Layer,
    ...
    /**
     * Obtains the desired elevation model for this heat map overlay
     * @return either ElevationData.MODEL_TERRAIN or ELevationData.MODEL_SURFACE
     */
    ...
    /**
     * Mechanism for changing the elevation model for the heat map overlay.
     * @param elevationModel
     */
    public void setElevationModel(int elevationModel) {
