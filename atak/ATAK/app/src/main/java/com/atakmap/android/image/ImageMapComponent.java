...
import com.atakmap.android.image.ipp.ImportImageResolver;
import com.atakmap.android.image.ipp.ImportImageSort;
...
public class ImageMapComponent extends DropDownMapComponent {
    ...
    private ImportImageResolver importResolver;
    ...
    public void onCreate(Context context, Intent intent, MapView view) {
        ...
        viewImagesFilter.addAction(ImageDropDownReceiver.IMAGE_DISPLAY,
                ...
                new DocumentedExtra[] {
                        ...
                        new DocumentedExtra("noFunctionality",
                                ...
                                true, Boolean.class),
                        new DocumentedExtra("selectedImageURI",
                                "Used with the 'uid' extra to specify which attachment should be the first to be shown.",
                                true, String.class),
                });
        ...
        //TODO updates docs
        imageGalleryFilter.addAction(ImageGalleryReceiver.UPDATE_ITEM,
                "Reload a MapItems image attachment",
                new DocumentedExtra[] {
                        new DocumentedExtra("oldUri", "The old file path of the MapItems attachment taht was changed",
                                false, String[].class),
                        new DocumentedExtra("newUri",
                                "The new file path of the MapItems attachment",
                                false, String[].class),
                        new DocumentedExtra("uid",
                                "The MapItem's uid",
                                false, String[].class)
        ...
        ImportExportMapComponent.getInstance()
                .addImporterClass(importResolver = new ImportImageResolver(view));
    ...
    protected void onDestroyImpl(Context context, MapView view) {
        ...
        ImportExportMapComponent.getInstance().removeImporterClass(importResolver);
