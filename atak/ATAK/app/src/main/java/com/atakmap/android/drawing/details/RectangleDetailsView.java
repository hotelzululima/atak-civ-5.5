...
public class RectangleDetailsView extends GenericDetailsView implements
    ...
    private void _init() {
        _unitPrefs = new UnitPreferences(_mapView.getContext());
        ...
        findViewById(R.id.drawingRectEditButton)
                .setEnabled(_rect.getMetaBoolean("editable", true));
                    ...
                    new DialogCallback() {
                        ...
                        public void onEntered(double size) {
                            try {
                                ...
                                // ATAK-18002 Playstore Crash: Rectangle SetWidth
                                Log.e(TAG,
                                        "error setting the length to: " + size,
                                        ise);
                            }
                        }
                    });
                    ...
                    new DialogCallback() {
                        ...
                        public void onEntered(double size) {
                            ...
                            try {
                                ...
                                // ATAK-18002 Playstore Crash: Rectangle SetWidth
                                Log.e(TAG,
                                        "error setting the width to: " + size,
                                        ise);
                            }
                        }
                    });
    ...
    private void _onCenterSelected() {
        ...
        CoordinateEntryCapability.getInstance(getContext()).showDialog(
                getContext().getString(R.string.center_location),
                _rect.getCenter(),
                _rect.getMovable(), _mapView.getPoint(), _cFormat, false,
                new CoordinateEntryCapability.ResultCallback() {
                    ...
                    public void onResultCallback(String pane,
                        ...
                        if (cf.getDisplayName().equals(pane)
                            ...
                            _cFormat = cf;
                        _rect.setCenterPoint(point);
                        _rect.persist(_mapView.getMapEventDispatcher(),
                                null, getClass());
                        GenericPointDetailsView.setAddress(point,
                                _rect.getAnchorItem(), _nameEdit);
                        refresh();
    ...
    public void refresh() {
        ...
        CoTInfoView.refreshAuthorLayout(_mapView, _rect, _authorText,
                _productionTimeText, cotAuthorLayout, cotAuthorIconButton,
                cotAuthorPanButton);

        attachmentManager.refresh();
        _rect.persist(MapView.getMapView().getMapEventDispatcher(), null,
                this.getClass());
