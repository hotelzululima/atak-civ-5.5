    ...
    public void onReceive(Context context, Intent intent) {
        if ("com.atakmap.android.maps.PLACE".equals(intent.getAction())) {
            ...
            if (intent.hasExtra("show_cot_details")) {
                ...
                if (details != null && details.equals("false")) {
                    markerCreator.showCotDetails(false);
                }
            }

            String ninelineExtra = intent.getStringExtra("nine_line");
            if (ninelineExtra != null &&
                    ninelineExtra.equals("true")) {
                markerCreator.setShowNineLine(true);
            }
            String fivelineExtra = intent.getStringExtra("five_line");
            if (fivelineExtra != null &&
                    fivelineExtra.equals("true")) {
            ...
            String showRadialExtra = intent.getStringExtra("show_new_radial");
            if (showRadialExtra != null &&
                    showRadialExtra.equals("true")) {
