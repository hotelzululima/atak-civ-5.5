 ...
 * Imports Shapefiles
 *
 * @deprecated use {@link ImportSHPResolver}
 */
@Deprecated
@DeprecatedApi(since = "5.5", forRemoval = true, removeAt = "5.8")
public class ImportSHPSort extends ImportResolver {
    ...
    public ImportSHPSort(Context context, boolean validateExt,
        ...
        super(".shp", FileSystemUtils.OVERLAYS_DIRECTORY,
                context.getString(R.string.shapefile),
