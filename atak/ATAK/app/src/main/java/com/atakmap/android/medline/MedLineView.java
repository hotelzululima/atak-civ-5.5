...
public class MedLineView implements PointMapItem.OnPointChangedListener {
    ...
    public boolean setMarker(final PointMapItem pmi) {
        ...
        // load this data after the main casevac is setup
        zMistView.setMarker(marker);

        // hlzView depends on the data being loaded into the medline first
    ...
    private void init() {
        ...
        m_BtnLineTwo_callsign
                .setText(_prefs.get(PREF_MEDLINE_CALLSIGN, "Med9Line"));
                                ...
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog,
                                        ...
                                        if (input.getText().length() > 0) {
                                            ...
                                            _prefs.set(PREF_MEDLINE_CALLSIGN,
                                                    medlineCallsign);
                                            saveData();
                                        } else
                                            m_BtnLineTwo_callsign
        ...
        m_BtnLineTwo_freq.setText(_prefs.get(PREF_MEDLINE_FREQ, "0.0"));
        ...
        m_BtnLineThree.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (marker.getMetaString("convenience", null) != null)
                    ((PlusMinusWidget) input
                            .findViewById(R.id.med_convenience_edit))
                                    .setText(marker.getMetaString("convenience",
                                            null));

                if (marker.getMetaString("urgent_surgical", null) != null)
                    ((PlusMinusWidget) input
                            .findViewById(R.id.med_urgent_surgical_edit))
    ...
    private void loadData() {
        ...
        String medlineFreq = _prefs.get(PREF_MEDLINE_FREQ, "0.0");
        String medlineCallsign = _prefs.get(PREF_MEDLINE_CALLSIGN, "Med9Line");
        ...
        try {
            ...
            if (marker.getMetaString("urgent_surgical", null) != null) {
                ...
                sBuilder.append(marker.getMetaString("urgent_surgical", null));
                sBuilder.append("xB");
                first = false;
            }
            ...
            if (marker.getMetaString("convenience", null) != null) {
                ...
                sBuilder.append(marker.getMetaString("convenience", null));
                sBuilder.append("xE");
            }
            sBuilder.trimToSize();
    ...
    public void saveData() {
        ...
        lineThreeMap.put("B", "urgent_surgical");
        lineThreeMap.put("C", "priority");
        lineThreeMap.put("D", "routine");
        lineThreeMap.put("E", "convenience");
        String[] precedence = m_BtnLineThree.getText().split(", ");
        for (String i : precedence) {
            String[] temp = i.split("x");
            if (temp.length == 2) {
                String key = lineThreeMap.get(temp[1].trim());
                if (key != null) {
                    marker.setMetaString(key, temp[0].trim());
                }
            }
        }
    ...
    private void editLocation() {
        ...
        CoordinateEntryCapability.getInstance(getContext()).showDialog(
                ...
                marker.getMovable(), _mapView.getPoint(), _cFormat, false,
                new CoordinateEntryCapability.ResultCallback() {
                    ...
                    public void onResultCallback(String pane,
                        ...
                        GenericPointDetailsView.setAddress(point, marker, null);
                        CameraController.Programmatic.panTo(
