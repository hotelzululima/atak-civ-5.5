    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            ...
            case SHOW_DETAILS: {
                ...
                boolean disableSend = intent.getBooleanExtra("disable_send",
                        false);
                sdv.findViewById(
                        com.atakmap.app.R.id.drawingRectSendEditView_rl)
                        .setVisibility(!disableSend ? View.VISIBLE : View.GONE);
