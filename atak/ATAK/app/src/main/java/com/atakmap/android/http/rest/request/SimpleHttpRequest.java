...
public class SimpleHttpRequest implements Parcelable {
    ...
    /**
     * NetConnectString identifying the server
     */
    ...
    public SimpleHttpRequest(NetConnectString serverConnectString,
            String baseUrl, String path, OpType type,
    ...
    public static SimpleHttpRequest fromJSON(JSONObject json)
        ...
        return new SimpleHttpRequest(
                NetConnectString.fromString(json.getString("ServerConnectString")),
