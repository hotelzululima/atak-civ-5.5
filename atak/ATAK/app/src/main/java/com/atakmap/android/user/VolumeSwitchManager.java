...
public class VolumeSwitchManager implements OnKeyListener {
    ...
    /**
     * Gets the instance of the volume switch manager used to change the volume button behavior
     * @param mapView the map view used during the first time creation process
     * @return the volume switch manager
     */
    ...
    private class LayerCycleVolumeAction implements VolumeSwitchAction {
        ...
        public synchronized void direction(int direction) {
            ...
            // mobile layer adapter is being used.   layer equality during 3.1
