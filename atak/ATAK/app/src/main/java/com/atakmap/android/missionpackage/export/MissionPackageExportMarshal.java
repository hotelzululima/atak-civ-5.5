...
public class MissionPackageExportMarshal extends ExportMarshal {
    ...
    public boolean marshal(Collection<Exportable> exports) throws IOException,
        ...
        return !mapItemUIDs.isEmpty() || !filepaths.isEmpty();
    }
    ...
    public void postMarshal() {
        ...
        if (mapItemUIDs.isEmpty() && filepaths.isEmpty()) {
        ...
        if (newPackage) {
            ...
            //prevent % characters from being entered in mission package name and limit the size
            editName.setFilters(new InputFilter[] {
                    NAME_FILTER, new InputFilter.LengthFilter(64)
            });
