...
public class VideoSyncClient implements RequestManager.RequestListener {
     ...
     */
    public void query(String serverUrl, String connectString) {
        try {
            GetVideoListRequest request = new GetVideoListRequest(serverUrl,
                    curNotificationId++, connectString);
    ...
    public void post(ConnectionEntry ce, NetConnectString serverConnectString,
            String serverUrl,
        ...
        try {
            ...
            PostVideoListRequest request = new PostVideoListRequest(
    ...
    public void post(ConnectionEntry ce, NetConnectString serverConnectString,
            String serverUrl) {
        post(ce, serverConnectString, serverUrl, null);
    }
