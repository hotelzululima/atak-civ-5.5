...
public class KMLUtil {
    ...
    /**
     * Note, we don't currently expect a large number of Styles If this proves to be incorrect in the
    ...
    public static Style getStyle(Kml kml, Placemark placemark) {
        ...
        if (styleMaps != null && !styleMaps.isEmpty()) {
            for (StyleMap styleMap : styleMaps) {
                ...
                if (stylePairs != null && !stylePairs.isEmpty()) {
    ...
    public static int parseKMLColor(String kmlColor) {
        ...
        if (kmlColor == null || kmlColor.isEmpty())
            return Color.WHITE;
    ...
    public static String convertKmlTime(String stringMillis) {
        if (stringMillis == null || stringMillis.isEmpty())
            return null;
    ...
    public static Track convertKmlCoords(List<CrumbPoint> crumbs,
        ...
        for (CrumbPoint crumb : crumbs) {
            ...
            when.add(w);
            // Coordinate stringifies with comma delimiters; `gx:coord`
            // requires space delimiters per
            // https://developers.google.com/kml/documentation/kmlreference#gxcoord
            coords.add(c.toString().replace(',', ' '));
    ...
    public static Folder exportKMLMapGroup(MapGroup group,
        ...
        for (MapGroup childGroup : group.getChildGroups()) {
            ...
            if (groupFolder != null && groupFolder.getFeatureList() != null
                    && !groupFolder.getFeatureList().isEmpty()) {
