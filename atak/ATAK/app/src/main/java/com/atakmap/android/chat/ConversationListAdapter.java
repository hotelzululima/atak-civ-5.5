...
class ConversationListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Check to see if a plugin has been loaded that will supply a custom
        // rendering capability

        final ChatMessageRenderer2 renderer = ChatManagerMapComponent
                .getInstance().getChatMesssageRenderer();
        if (renderer != null) {
            return renderer.getView(position,
                    convertView, parent,
                    chatLines, latestSelfMsg, latestSelfChain);
        }
        ...
        if (convertView == null) {
            ...
            convertView.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    ATAKUtilities.copyClipboard("chat",
                            fholder.message.getText().toString(), true);
                    return true;
                }
            });
            ...
            holder.moreDetails = convertView.findViewById(R.id.more_details);
    ...
    private void updateViewHolder(ViewHolder holder, int position) {
        ...
        if (chat == null) {
            ...
            if (chat.senderUid.equals(MapView.getDeviceUid())) { // Sent from this device...
                ...
                setPosition(Gravity.END, holder.moreDetails);
                ...
                setPosition(Gravity.START, holder.moreDetails);
            ...
            List<String> moreDetails = chat.extras
                ...
                holder.moreDetails
                        .setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                i.putExtra("conversationName",
                                        chat.chatGrpName == null
                                                ? chat.conversationName
                                                : chat.chatGrpName);
                                i.putExtra("extras", chat.extras);
    ...
    private void setPosition(int start, Button moreDetails) {
        LinearLayout ll = (LinearLayout) moreDetails.getParent();
        View startPad = ll.findViewById(R.id.start_pad);
        View endPad = ll.findViewById(R.id.end_pad);
        if (start == Gravity.START) {
            startPad.setVisibility(View.GONE);
            endPad.setVisibility(View.VISIBLE);
        } else {
            startPad.setVisibility(View.VISIBLE);
            endPad.setVisibility(View.GONE);
        }
    }
    ...
    void addChatLine(ChatLine toAdd) {
        ...
        chatLines.add(toAdd);
        Collections.sort(chatLines, TIME_SORT);
    ...
    private final static Comparator<ChatLine> TIME_SORT = new Comparator<ChatLine>() {
        @Override
        public int compare(ChatLine o1, ChatLine o2) {
            return Long.compare(o1.getTimeSentOrReceived(),
                    o2.getTimeSentOrReceived());
        }
    };
}
