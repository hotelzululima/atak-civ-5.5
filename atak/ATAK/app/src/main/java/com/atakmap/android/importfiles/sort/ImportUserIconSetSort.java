 ...
 * @deprecated use {@link ImportUserIconSetResolver}
 */
@Deprecated
@DeprecatedApi(since = "5.5", forRemoval = true, removeAt = "5.8")
public class ImportUserIconSetSort extends ImportResolver {
...
//                } else if (IconsMapAdapter.IconFilenameFilter.accept(null,
                } else if (ImportUserIconSetResolver.IconFilenameFilter.accept(null,
                        ze.getName())) {
                    bHasImage = true;
                }
