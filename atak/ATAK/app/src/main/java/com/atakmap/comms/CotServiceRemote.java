...
public class CotServiceRemote {
    ...
    public interface ConnectionListener {
         ...
         * all of the current TAK servers bundle made up of TAKServer.DESCRIPTION_KEY,
         * TAKServer.ENABLED_KEY, TAKServer.CONNECTED_KEY
    ...
    static public void fireConnect() {
        final Thread t = new Thread("fireConnect") {
            public void run() {
                synchronized (lock) {
     ...
     * @param meta contained in TAKServer is all of the values that can be put in
     *             the bundle.
     */
