...
public class CotModificationManager {
    ...
    static abstract public class ModificationAction {
         ...
         * Please note, this will not be triggered if the bundle "from" is set to "internal" or not
         * set as of 4.8 and lower.   This may change in the future and care should be taken to
         * for implementations to check the "from" field and act accordingly.
