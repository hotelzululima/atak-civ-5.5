...
public class LayerSelection {
    ...
    /** all dataset deescriptors associated with the layer selection */
    final Set<DatasetDescriptor> descriptors = Collections
    ...
    public Set<DatasetDescriptor> getDescriptors() {
