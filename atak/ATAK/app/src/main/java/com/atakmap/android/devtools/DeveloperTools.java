...
public class DeveloperTools extends AbstractMapOverlay2 {
    ...
    static final class DevTools extends DevToolGroup {
        public DevTools(MapView view) {
            ...
            _children
                    .add(new DisplayModeHierarchyListItem(view.getRenderer3()));
            ...
            _children.add(new DebugHitBoxes());
            _children.add(new CoTMarkersRenderToggle(view));
            _children.add(new CoTMarkerOverlayManagerToggle(view));
            _children.add(new MapItemFeatures());
        }
    }
}
