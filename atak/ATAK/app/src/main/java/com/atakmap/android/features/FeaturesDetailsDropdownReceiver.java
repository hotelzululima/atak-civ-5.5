...
public class FeaturesDetailsDropdownReceiver extends DropDownReceiver implements
    ...
    public FeaturesDetailsDropdownReceiver(MapView mapView,
        ...
        this(mapView, Adapters.adapt(spatialDb));
    }
                ...
                new Runnable() {
                    public void run() {
                        ...
                        try {
                            ...
                            Log.d(TAG, "constructed webview in: "
                        ...
                        if (htmlViewer != null) {
                            ...
                            htmlViewer.setLayerType(WebView.LAYER_TYPE_SOFTWARE,
                                    null);
                            final WebSettings webSettings = htmlViewer
                                    .getSettings();
                                    ...
                                    if (url.startsWith(
                                        ...
                                        if (fName != null) {
                                            ...
                                            url = url.replaceAll(
                                                    "file:///android_asset/",
                                                    "");
                                            Log.d(TAG, "zipFile: " + fName
                                                    + " file: " + url);

                                            try {
                                                ZipVirtualFile vf = new ZipVirtualFile(
                                                        fName,
                                                        url);
