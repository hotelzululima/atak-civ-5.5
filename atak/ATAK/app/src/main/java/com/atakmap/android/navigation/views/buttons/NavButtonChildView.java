...
public class NavButtonChildView extends LinearLayout {
    ...
    public NavButtonChildView(Context context) {
        ...
        toolIcon = mapView.getContext().getDrawable(R.drawable.ic_close);
    }

    public NavButtonChildView(Context context, Drawable toolbarIcon) {
        this(context);
        toolIcon = toolbarIcon;
    }
    ...
    private void layoutHorizontal(View anchor, ActionBarView actionBarView) {
        ...
        // The linear elements of the layout
        addToolDescriptorLayout();
    ...
    /**
     * Icon of tool with close functionality. This is the first element
     * of the linear layout, when shown.
     */
    private void addToolDescriptorLayout() {
        ToolbarIconLayout toolIcon = new ToolbarIconLayout(getContext(),
                this.toolIcon);

        toolIcon.setOnClickListener(new OnClickListener() {
            @Override
        ...
        _container.addView(toolIcon);
    }

    /**
     * A visual cap at the end of the bar. This is the last element of the layout.
     */
    private void addToolEndCap() {
        ImageView cap = new ImageView(getContext());
        LinearLayout.LayoutParams lp = new LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.MATCH_PARENT);
        lp.setMargins(0, -8, -4, -8);
        cap.setLayoutParams(lp);
        cap.setImageDrawable(
                getContext().getDrawable(R.drawable.toolbar_endcap));
        _container.addView(cap);
    }
