...
public class GLFahArrowWidget extends GLShapeWidget implements
        ...
        public GLMapItem2 create(Pair<MapRenderer, MapItem> object) {
            ...
            return new AbstractGLMapItem2(object.first, object.second,
                ...
                public void draw(GLMapView ortho, int pass) {
                    ...
                    if (surface
                            && !bounds.intersects(ortho.currentPass.northBound,
                                    ortho.currentPass.westBound,
                                    ortho.currentPass.southBound,
                                    ortho.currentPass.eastBound))
                        return;
    ...
    protected RectF getWidgetViewF() {
        ...
        float right = this.orthoView.currentPass.focusx * 2;
    ...
    private boolean drawWidgetSurface() {
        ...
        this.orthoView.currentPass.scene.forward(_target, pos);
        float xPos = pos.x;
        float yPos = pos.y;
        ...
        if (orthoView.currentScene.drawTilt > 0d) {
            if (_touchable
                    || orthoView.currentPass.drawMapResolution < ARROW_MAX_RENDER) {
    ...
    private void drawTextAngle(int index) {
        ...
        orthoView.currentPass.scene.forward(orthoView.scratch.geo,
    ...
    private void drawArrowText() {
        ...
        // drawArrowText is called - see ATAK-17479 GLFahArrowWidget NPE
        if (_hitPoint == null && _hitPointInner == null)
            return;

        orthoView.currentPass.scene.forward(adjustedGeoPoint(
                orthoView,
    ...
    private void _update(final FahArrowWidget arrow, Update u) {
        ...
        switch (u) {
            ...
            case DESIGNATOR_POINT:
                ...
                final GeoPoint adp = arrow.getDesignatorPoint();
                if (adp != null) {
