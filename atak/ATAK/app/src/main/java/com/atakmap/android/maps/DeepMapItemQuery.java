...
public interface DeepMapItemQuery {
    ...
    final class Default {
        ...
        public static SortedSet<MapItem> deepHitTestItems(Object dmiq, int xpos,
                int ypos,
                GeoPoint point, MapView view) {
            if (dmiq instanceof DeepHitTestQuery) {
                ...
                return ((DeepHitTestQuery) dmiq).deepHitTest(view, params);
            }
            return null;
        }

        public static MapItem deepHitTest(Object dmiq, int xpos, int ypos,
                GeoPoint point,
                MapView view) {
            if (dmiq instanceof DeepHitTestQuery) {
                HitTestQueryParameters params = new HitTestQueryParameters(
                ...
                params.limit = 1;
                params.resultFilter = new MapItemResultFilter();
                SortedSet<MapItem> results = ((DeepHitTestQuery) dmiq)
    ...
    default MapItem deepHitTest(int xpos, int ypos, GeoPoint point,
            MapView view) {
        return Default.deepHitTest(this, xpos, ypos, point, view);
    }
    ...
    default SortedSet<MapItem> deepHitTestItems(int xpos, int ypos,
            GeoPoint point, MapView view) {
        return Default.deepHitTestItems(this, xpos, ypos, point, view);
    }
}
