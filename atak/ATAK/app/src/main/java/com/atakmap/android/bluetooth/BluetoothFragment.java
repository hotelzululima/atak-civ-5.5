...
public class BluetoothFragment implements OnSharedPreferenceChangeListener {
    ...
    private AtakPreferences prefs = null;
    ...
    public synchronized void onStart() {
        ...
        if (prefs.get("atakControlBluetooth", false)) {
    ...
    synchronized private void onBluetooth() {
        ...
        if (btScanner == null || !btScanner.isAlive()) {
            ...
            btScanner = new Thread("btscanner") {
                @Override
                public void run() {
                    ...
                    if (!adapter.isEnabled()) {
                        ...
                        try {
                            ...
                            Log.e(TAG, "unable to make the request to enable bluetooth", ex);
                            mapView.post(new Runnable() {
                                @Override
                                public void run() {
     ...
     * @param enable Enable bluetooth rescan notification
     */
                ...
                public void run() {
                    if (!inProgress) {
                        ...
                        if (prefs.get("atakControlBluetooth", false)) {
                            ...
                            prefs.set("atakControlBluetooth", true);
                        }
