...
public abstract class AbstractParentWidget extends MapWidget2
     ...
     * @return a list of sorted map widgets
     */
    ...
    /**
     * @see #removeWidget(IMapWidget)
     * @param widget the map widget to remove
     * @return true if the child widget is removed
     */
    @Deprecated
     ...
     * @return true if the child widget is removed
     */
    public boolean removeWidget(IMapWidget widget) {
        return removeChildWidget(widget);
    }
