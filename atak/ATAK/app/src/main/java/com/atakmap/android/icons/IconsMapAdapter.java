...
public class IconsMapAdapter extends BroadcastReceiver implements Disposable {
    ...
    public void adaptMarkerIcon(final Marker marker) {
        ...
        String preferredCoTMappingUUID = IconManagerView
                .getDefaultCoTMapping(_prefs.getSharedPrefs());
        boolean bForceMapping = IconManagerView
                .getForceCoTMapping(_prefs.getSharedPrefs());
    ...
    public void onReceive(Context context, Intent intent) {
        if (ADD_ICONSET.equals(intent.getAction())) {
            ...
            new AddIconsetTask(filepath,
                    intent.getBooleanExtra("show_progress", true), _context)
                            .execute();
            ...
            new RemoveIconsetTask(iconsetUid, _context, _prefs.getSharedPrefs())
                    .execute();
        }
    }

    /**
     * @deprecated see {@link gov.tak.api.importfiles.ImportUserIconSetResolver#IconFilenameFilter}
     */
    @Deprecated
    ...
    private static UserIconSet addIconset(final File file,
            final Context context, boolean showProgress) {
        UserIconSet iconset;
    ...
    private static class AddIconsetTask extends AsyncTask<Void, Void, String> {
        ...
        private final boolean _show_progress;

        public AddIconsetTask(final String filepath, boolean show_progress,
        ...
        protected void onPostExecute(String uid) {
            ...
            AtakBroadcast.getInstance().sendBroadcast(
                    new Intent(IconsMapAdapter.ICONSET_ADDED)
                            .putExtra("show_progress", _show_progress)
                            .putExtra("uid", uid));
        }
    }
