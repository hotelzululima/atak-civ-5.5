 ...
 * When an aspect of the model is changed, it is important to call
 * NavButtonManager.getInstance().notifyModelChanged not notify all
 * users of the model.
 */
public class NavButtonModel {
    ...
    /**
     * Set the count shown in a red circle in the top-right. When the model is changed, it is
     * important to call NavButtonManager.getInstance().notifyModelChanged not notify all users of
     * the model that there has been a change
     * @param count Count
     */
    ...
    /**
     * Set an image drawable shown in the bottom-right.  When the model is changed, it is
     * important to call NavButtonManager.getInstance().notifyModelChanged not notify all users of
     * the model that there has been a change
