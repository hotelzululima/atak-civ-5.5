...
public class HarrisConfigurator extends PortCommunicator implements Disposable {
    ...
    synchronized private void configure(UsbManager usbManager, UsbDevice dev,
        ...
        if (dev.getVendorId() == 6565) {
            ...
            final ProbeTable probeTable = UsbSerialProber
                    .getDefaultProbeTable();
            probeTable.addProduct(0x19a5, 0x0012, CdcAcmSerialDriver.class);
            probeTable.addProduct(0x19a5, 0x0004, CdcAcmSerialDriver.class);

            final UsbSerialProber prober = new UsbSerialProber(probeTable);
            final UsbSerialDriver driver = prober.probeDevice(dev);
