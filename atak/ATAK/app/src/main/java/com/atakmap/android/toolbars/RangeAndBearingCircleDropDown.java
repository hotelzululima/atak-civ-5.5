...
public class RangeAndBearingCircleDropDown extends DropDownReceiver implements
    ...
    protected void initializeWidgets() {
        ...
        urlUiHandler = new UrlUiHandler(_root);
                    ...
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface d, int w) {
                            try {
                                ...
                                if (radius > 0.0) {
                                    RangeCircle rc = _rabCircle;
                                    if (rc != null)
                                        rc.setRadius(rMeters);
                                } else {
                                    Toast.makeText(_context,
    ...
    protected void refresh() {
        _mapView.post(new Runnable() {
            ...
            public void run() {
                ...
                CoTInfoView.refreshAuthorLayout(_mapView, _rabCircle,
                        _root.findViewById(R.id.dgAuthorLayout));
                ...
                urlUiHandler.update(_rabCircle);
    ...
    private void displayColorSelectDialog() {
        ...
        palette.setColor(_rabCircle.getStrokeColor());
        b.setView(palette);
        ...
        OnColorSelectedListener l = new OnColorSelectedListener() {
            ...
            public void onColorSelected(int color, String label) {
                // could have been deleted while the color selector is open
                // triggering a drop down close and in turn dismissing the
                // drop down receiver.
                if (_rabCircle != null) {
    ...
    protected void displayCoordinateDialog(GeoPointMetaData centerPoint) {
        ...
        CoordinateEntryCapability.getInstance(_context).showDialog(
                ...
                centerPoint,
                _rabCircle.getMovable(), _mapView.getPoint(),
                _prefs.getCoordinateFormat(), false,
                new CoordinateEntryCapability.ResultCallback() {
                    ...
                    public void onResultCallback(String pane,
                        ...
                        //if (cf.getDisplayName().equals(pane) && cf != CoordinateFormat.ADDRESS)
                        //    _cFormat = cf;
                        _rabCircle.setCenterPoint(point);
                        populateLocationWidgets();

                        CameraController.Programmatic.panTo(
                                _mapView.getRenderer3(), point.get(), false);
                    }
                });
    }
