...
public class RoverDropDownReceiver extends DropDownReceiver implements
    ...
    private final AtakPreferences sharedPreferences;
    ...
    public RoverDropDownReceiver(MapView mapView) {
        ...
        sharedPreferences = AtakPreferences.getInstance(context);

        sharedPreferences.registerListener(this);
        ...
        if (nd != null) {
            ...
            if (prefAddress != null) {
                if (prefAddress.equals("192.168.50.200")) {
                    sharedPreferences.set("rover_ip_address", "192.168.50.1");
                } else if (prefAddress.equals("192.168.80.200")) {
                    sharedPreferences.set("rover_ip_address", "192.168.80.1");
                }
            }
        }
        ...
        sideband = sharedPreferences.get("rover_sideband", false);
        ignoreKLV = sharedPreferences.get("rover_ignoreKLV", false);
        disableCOT = sharedPreferences.get("rover_disableCOT", true);
        sideband_port = sharedPreferences.get("rover_sideband_port", 3002);
    ...
    public void onReceiverStatus(final RoverInterface.Receiver r) {
        ...
        if (r.version > 0) {
            roverVersion = r.version + "." + r.build;
        } else {
            roverVersion = "";
        }
    ...
    public void onClick(final View v) {
        if (v.getId() == R.id.fav_btn) {
            ...
            boolean def = !sharedPreferences.get("mode_rover", true);
            sharedPreferences.set("mode_rover", def);
            setRoverMode();
        }
    }
    ...
    void setRoverMode() {
        ...
        if (sharedPreferences.get("mode_rover", true)) {
    ...
    void config() {
        ...
        if (radio.isMonitoring()) {
            String lastVer = sharedPreferences.get("rover.Version", "");
            if (!roverVersion.isEmpty()) {
                if (!roverVersion.equals(lastVer))
                    Toast.makeText(
                            context,
                            R.string.radio_changed_firmware_device_message,
                            Toast.LENGTH_LONG).show();
                sharedPreferences.set("rover.Version", roverVersion);
            }

            roverVersionTV.setText("Device Firmware\n" + roverVersion);
        } else {
        ...
        autoRoverCB.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                    boolean isChecked) {
                sharedPreferences.set("autoRoverAddress", isChecked);
                sharedPreferences.set("autoRoverAddress", isChecked);
        ...
        final String roverIP = sharedPreferences.get("rover_ip_address",
                "192.168.80.1");
        ...
        urlView.findViewById(R.id.rover_common_btn)
                .setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        ...
                        sharedPreferences.set("rover_ip_address",
                                "192.168.80.1");
        ...
        legacy.setChecked(sharedPreferences.get("rover_legacy", false));
        ...
        legacy.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                sharedPreferences.set("rover_legacy", isChecked);
            }
        });
        ...
        legacyswap
                .setChecked(sharedPreferences.get("rover_legacy_swap", false));
        ...
        legacyswap.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                sharedPreferences.set("rover_legacy_swap", isChecked);
            }
        });
        ...
        halfSizeCB.setChecked(
                sharedPreferences.get("roverEncodingHalfSize", false));

        halfSizeCB.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView,
                    boolean isChecked) {
                sharedPreferences.set("roverEncodingHalfSize", isChecked);
            }
        });

        mpeg2CB.setChecked(sharedPreferences.get("roverEncodingMpeg2", false));

        mpeg2CB.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView,
                    boolean isChecked) {
                sharedPreferences.set("roverEncodingMpeg2", isChecked);
            }
        });

        roverWifiCB.setChecked(sharedPreferences.get("roverWifi", false));

        roverWifiCB.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView,
                    boolean isChecked) {
                sharedPreferences.set("roverWifi", isChecked);
                if (isChecked) {
                    Toast.makeText(
                            context,
        ...
        web.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                try {
                    ...
                    Toast.makeText(
                            context,
                            R.string.no_web_browser_application_found,
                            Toast.LENGTH_SHORT).show();
                }
        ...
        rec.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                File file = new File(f, "raw_"
                        ...
                        + ".ts");
                String address = sharedPreferences.get("rover_ip_analog",
                        "239.255.0.1");
                int port = sharedPreferences.get("rover_port_analog", 1841);
                if (wfc != null
                        && wfc.equalsIgnoreCase(RoverInterface.ANALOG)) {
                    if (roverVersion != null && roverVersion.startsWith("2.")) {
                        address = sharedPreferences.get("rover_ip_digital",
                                "239.255.0.1");
                        port = sharedPreferences.get("rover_port_digital",
                                11841);
                    }
                } else if (nft != null
                    ...
                    address = sharedPreferences.get("rover_ip_digital",
                            "239.255.0.1");
                    port = sharedPreferences.get("rover_port_digital", 11841);
                }
        ...
        final String ipA = sharedPreferences.get(PREF_KEY_ANALOG_IP,
                "239.255.0.1");
        final int portA = sharedPreferences.get(PREF_KEY_ANALOG_PORT, 1841);

        final String ipD = sharedPreferences.get(PREF_KEY_DIG_IP,
                "239.255.0.1");
        final int portD = sharedPreferences.get(PREF_KEY_DIG_PORT, 11841);
        ...
        roverBitRateET.setText(sharedPreferences.get("roverBitRate", 1500)
                + "");
        ...
        ad.setPositiveButton(R.string.ok,
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog,
                        ...
                        sharedPreferences.set("rover_ip_address", roverIP);

                        if (roverIP.startsWith("192.168.50")) {
                            sharedPreferences.set("network_static_ip_address",
                                    "192.168.50.200");
                            sharedPreferences.set("network_static_gateway", "");
                        ...
                        sharedPreferences.set("rover_sideband", sideband);

                        sharedPreferences.set("roverBitRate",
                        ...
                        sharedPreferences.set("rover_sideband_port",
                                sideband_port);

                        String url = createURL(ip_analog, port_analog);

                        if (url != null) {
                            sharedPreferences.set(PREF_KEY_ANALOG_IP,
                                    ip_analog);

                            sharedPreferences.set(PREF_KEY_ANALOG_PORT,
                        ...
                        if (url != null) {
                            sharedPreferences.set(PREF_KEY_DIG_IP, ip_digital);

                            sharedPreferences.set(PREF_KEY_DIG_PORT,
    ...
    public void watchVideo(boolean external) {
        ...
        ConnectionEntry ce;
        boolean swap = sharedPreferences.get("rover_legacy_swap", false);
        ...
        if (wfc != null && wfc.equalsIgnoreCase(RoverInterface.ANALOG)) {
                ...
                public void run() {
                    ...
                    radio.setEncodingParam(
                            Math.min(4000,
                                    Math.max(500,
                                            sharedPreferences
                                                    .get("roverBitRate", 1500)))
                                    * 1000,
                            sharedPreferences.get("roverEncodingHalfSize",
                                    false),
                            sharedPreferences.get("roverEncodingMpeg2", false));
                }
            }, TAG + "-WatchVideo");
            ...
            if (roverVersion != null && roverVersion.startsWith("2.")) {
                Log.d(TAG, "connecting to[" + wfc + "]: " + urlDigital);
    ...
    private void start() {
        ...
        if (!radio.requiresNetworkConfiguration() ||
                sharedPreferences.get("roverWifi", false)) {
    ...
    private boolean configureNetwork() {
        ...
        boolean attemptConfigure = sharedPreferences.get("network_config",
                true);
        ...
        if (!attemptConfigure) {
            ...
            try {
                boolean isDhcp = sharedPreferences.get("network_dhcp", false);
                if (isDhcp) {
                    setStatusText(
                            Color.GREEN,
                            context.getString(
                    ...
                    // ip address
                    String ipAddress = sharedPreferences
                            .get("network_static_ip_address", "192.168.80.200");
                    ...
                    // subnet mask
                    String subnetMask = sharedPreferences
                            .get("network_static_subnet_mask", "255.255.255.0");
    ...
    private void automaticDiscoveryAttempt() {
        if (sharedPreferences.get("autoRoverAddress", true)) {
            ...
            try {
                ...
                if (address != null) {
                    String pastAddress = sharedPreferences
                            .get("rover_ip_address", "192.168.80.1");
                    ...
                    if (!pastAddress.equalsIgnoreCase(addrString)) {
                        Log.d(TAG, "address change from: " + pastAddress
                                + " to: " + addrString);
                        sharedPreferences.set("rover_ip_address", addrString);
                    ...
                    Toast.makeText(context,
                            R.string.failed_to_automatically_discover_the_rover,
                            Toast.LENGTH_SHORT).show();
                }
            } catch (Exception ioe) {
    ...
    private void updateURLAnalog() {
        final String ip_analog = sharedPreferences.get(PREF_KEY_ANALOG_IP,
                "239.255.0.1");
        final int port_analog = sharedPreferences.get(PREF_KEY_ANALOG_PORT,
                1841);
        urlAnalog = createURL(ip_analog, String.valueOf(port_analog));
    }

    private void updateURLDigital() {
        final String ip_digital = sharedPreferences.get(PREF_KEY_DIG_IP,
                "239.255.0.1");
        final int port_digital = sharedPreferences.get(PREF_KEY_DIG_PORT,
                11841);
