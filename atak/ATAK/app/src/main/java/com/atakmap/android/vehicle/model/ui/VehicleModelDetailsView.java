...
public class VehicleModelDetailsView extends GenericDetailsView implements
    ...
    private void promptCenterEntry() {
        ...
        CoordinateEntryCapability.getInstance(getContext()).showDialog(
                ...
                _vehicle.getCenter(),
                _vehicle.getMovable(), _mapView.getPoint(), _cFormat, false,
                new CoordinateEntryCapability.ResultCallback() {
                    ...
                    public void onResultCallback(String pane,
                        ...
                        _vehicle.move(_vehicle.getCenter(), point, true);
                        //_centerButton.setText(coordView.getFormattedString());

                        com.atakmap.android.drawing.details.GenericPointDetailsView
                                .setAddress(point, _vehicle.getCenterMarker(), _nameEdit);

                        _vehicle.persist(_mapView.getMapEventDispatcher(), null, this.getClass());
    ...
    public void refresh() {
        ...
        CoTInfoView.refreshAuthorLayout(_mapView, _vehicle, _authorText,
                _productionTimeText, cotAuthorLayout, cotAuthorIconButton,
                cotAuthorPanButton);

        com.atakmap.android.drawing.details.GenericPointDetailsView
                .controlAddressUI(_vehicle.getCenterMarker(), _addressText, _addressInfoText,
                        _addressLayout);
    }
