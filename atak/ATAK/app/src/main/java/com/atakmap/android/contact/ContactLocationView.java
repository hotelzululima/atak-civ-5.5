...
public class ContactLocationView extends ContactDetailView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        _addressLayout = v.findViewById(R.id.dgAddressLayout);
        _addressText = v.findViewById(R.id.dgInfoAddress);
        _addressInfoText = v.findViewById(R.id.dgInfoAddressInfo);
        ...
        _coordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CoordinateEntryCapability.getInstance(getContext()).showDialog(
                        _mapView.getContext()
                                .getString(R.string.rb_coord_title_readonly),
                        m.getGeoPointMetaData(), m.getMovable(),
