...
public class DrawingCircle extends Shape implements
    ...
    static {
        ...
        MENU_METADATA.add(DetailConstants.EXTRUDE_MODE);
    }
    ...
    public void refresh() {
        ...
        synchronized (this) {
            ...
            for (int i = 0; i < _rings.size(); i++) {
                ...
                c.showLabel(getMetaBoolean("labels_on", false));
                ...
                c.setEditing(getEditing());
                setChildMetadata(c);
                c.setMovable(false);        // mirror the ellipse per the bug
                if (i < _rings.size() - 1) {
    ...
    private void setChildMetadata(MapItem mi) {
        ...
        mi.setMetaString("extrudeMode", getMetaString("extrudeMode", null));
    }
    ...
    public void setMetaString(String key, String value) {
        ...
        if (MENU_METADATA.contains(key))
            refresh();
        if (key.equals(DetailConstants.EXTRUDE_MODE))
            persist();
    }
    ...
    public void setCenterMarker(Marker marker) {
        ...
        if (_centerMarker != null) {
            ...
            _centerMarker.removeOnMetadataChangedListener("editing", this);
        }
        if (marker == null) {
        ...
        marker.addOnMetadataChangedListener("editing", this);
        setTitle(getTitle());
    }
    ...
    public void setRadiusMarker(Marker marker) {
        ...
        if (_radiusMarker != null) {
            ...
            _radiusMarker.removeOnMetadataChangedListener("editing", this);
        }
    ...
    public void onMetadataChanged(MapItem item, String field) {
        if (field.equals("editing")) {
            boolean editing = (_centerMarker != null
                    && _centerMarker.getEditing()) ||
                    (_radiusMarker != null && _radiusMarker.getEditing());
