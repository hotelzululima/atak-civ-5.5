...
public class HierarchyListReceiver extends BroadcastReceiver implements
    ...
    protected final AtakPreferences prefs;
    ...
    public HierarchyListReceiver(final MapView mapView, final Context context) {
        ...
        this.prefs = AtakPreferences.getInstance(
                mapView.getContext());
    ...
    private List<Intent> getIntents(Intent intent) {
    ...
    private void handleClearHierarchy() {
        if (adapter != null)
    ...
    private void handleManageHierarchy(Intent intent) {
    ...
    private void multiselectPrompt() {
    ...
    private void determineDropDownSizeBasedOnDeviceState() {
        ...
        if (ATAKUtilities.isTablet()) {
            String size = this.prefs.get("overlay_manager_width_height",
                    "33");
            if (size.equals("33")) {
    ...
    void refreshDropDownSize() {
        ...
        if (!overlayManagerDropDown.isPortrait())
            ...
            if (isModeInStack(HIERARCHY_MODE.SEARCH)) {
                boolean isTablet = ATAKUtilities.isTablet();
    ...
    public void setViewToMode() {
        ...
        IToolbarExtension2 toolbar = null;
        ...
        boolean showAll = !prefs.get(FOVFilter.PREF, false);
        ...
        switch (mode) {
            ...
            case ITEM_SELECTED:
                ...
                if (curList != null) {
                    ...
                    if (curList instanceof IToolbarExtension2)
                        toolbar = (IToolbarExtension2) curList;
                }
    ...
    private class HierarchyListDropDown extends DropDownReceiver
            implements OnStateListener, IToolbarExtension2 {
        ...
        public void setToolbar(IToolbarExtension2 toolbar) {
            if (!isVisible())
                return;
        ...
        public Drawable getToolbarIcon() {
            return _mapView.getContext().getDrawable(R.drawable.ic_close);
        }
