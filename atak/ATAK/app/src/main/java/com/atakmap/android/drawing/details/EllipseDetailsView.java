...
public class EllipseDetailsView extends GenericDetailsView implements
    ...
    private void _init() {
        ...
        findViewById(R.id.editButton)
                .setEnabled(_ellipse.getMetaBoolean("editable", true));
    ...
    public void refresh() {
        ...
        CoTInfoView.refreshAuthorLayout(_mapView, _ellipse, _authorText,
                _productionTimeText, cotAuthorLayout, cotAuthorIconButton,
                cotAuthorPanButton);

        _ellipse.refresh();
        _ellipse.persist(MapView.getMapView().getMapEventDispatcher(), null,
                this.getClass());
    }
    ...
    private void onCenterSelected() {
        ...
        CoordinateEntryCapability.getInstance(getContext()).showDialog(
                ...
                _ellipse.getCenter(),
                _ellipse.getMovable(), _mapView.getPoint(), _cFormat, false,
                new CoordinateEntryCapability.ResultCallback() {
                    ...
                    public void onResultCallback(String pane,
                        ...
                        if (cf.getDisplayName().equals(pane)
                            ...
                            _cFormat = cf;
                        _ellipse.setCenterPoint(point);
                        _ellipse.persist(_mapView.getMapEventDispatcher(),
                                null, getClass());
                        GenericPointDetailsView.setAddress(point,
                                _ellipse.getAnchorItem(), _nameEdit);
                        refresh();
