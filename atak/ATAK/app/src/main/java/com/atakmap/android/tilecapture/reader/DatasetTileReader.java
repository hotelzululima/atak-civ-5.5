...
public abstract class DatasetTileReader implements BitmapReader {
    ...
    protected DatasetTileReader(ImageDatasetDescriptor d) {
        this(Parsers.parseInt(d.getExtraData("levelOffset"), 0),
                Parsers.parseInt(d.getExtraData("_levelCount"), 1),
                Parsers.parseInt(d.getExtraData("_tilePixelWidth"), 256),
                Parsers.parseInt(d.getExtraData("_tilePixelHeight"), 256));
    }
