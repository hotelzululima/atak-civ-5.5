 ...
 */
public class FtpUploader implements RequestListener, Disposable {
     ...
     * @param skipDialog the dialog display for before the upload starts that gets additional details.
    ...
    public void upload(final File file, final boolean binaryMode,
        ...
        b.setTitle(R.string.enter_ftp_details);
        b.setView(layout);
        b.setPositiveButton(R.string.send, new DialogInterface.OnClickListener() {

            @Override
            public void onClick(DialogInterface dialog, int which) {
                if (FileSystemUtils.isEmpty(host.getText().toString())) {
                    Log.w(TAG, "FTP Host not set");
                    Toast.makeText(_context, R.string.must_enter_ftp_host,
    ...
    public void upload(int notificationId, File file, String proto,
        ...
        if (!FileSystemUtils.isFile(file)) {
            ...
            NotificationUtil.getInstance().postNotification(notificationId,
                    ...
                    _context.getString(R.string.failed_to_ftp_upload),
        ...
        if (request
            ...
            if (resultData == null) {
                ...
                NotificationUtil.getInstance().postNotification(
                        R.drawable.ic_network_error_notification_icon,
                        NotificationUtil.RED,
                        _context.getString(R.string.ftp_upload_failed),
                        _context.getString(R.string.ftp_server_not_available),
                        _context.getString(R.string.ftp_server_not_available));
                return;
            }
            ...
            if (initialRequest == null || !initialRequest.isValid()) {
                ...
                NotificationUtil.getInstance().postNotification(
                        ...
                        NotificationUtil.RED,
                        _context.getString(R.string.ftp_upload_failed),
                        _context.getString(R.string.unable_to_parse_request),
                        _context.getString(R.string.unable_to_parse_request));
                return;
            }
            ...
            if (resultData.getBoolean(
                ...
                b.setTitle(R.string.confirm_ftp_overwrite);
            ...
            if (errString != null) {
                NotificationUtil.getInstance().postNotification(
                        ...
                        String.format(LocaleUtil.getCurrent(), 
                                _context.getString(R.string.ftp_upload_failed_s), 
                                file.getName()),
                        errString, errString);
    ...
    public void onRequestConnectionError(Request request,
        ...
        NotificationUtil.getInstance().postNotification(
                ...
                R.drawable.ic_network_error_notification_icon,
                NotificationUtil.RED,
                _context.getString(R.string.ftp_upload_failing),
