...
public class DrawingPreferences extends AtakPreferences {
    ...
    /**
     * Sets the default center point visibility
     * @param vis the new center point visibility default state
     */
    public void setCenterPointVisible(boolean vis) {
        set("drawing.centerpointvisible.laststate", vis);
    }

    /**
     * Gets the default center point visibility
     * @return the default center point visibility
     */
    public boolean getCenterPointVisible() {
        return get("drawing.centerpointvisible.laststate", true);
    }
