...
public abstract class MissionPackageBaseTask extends
    ...
    /**
     * Sets a progress dialog on a MissionPackageTask
     * @param progressDialog the progress dialog to use.  It should never be the case that one is
     *                       already being displayed, but if so - dismiss it.
     */
    ...
    /**
     * Return the manifest for the Mission Package Task
     * @return the MissionPackageManifest
     */
    ...
    protected void onPreExecute() {
        ...
        final MapView mapView = _receiver == null ? null
                : _receiver.getMapView();
                ...
                public void run() {
                    synchronized (lock) {
                        if (_progressDialog != null) {
                            ...
                            _progressDialog
                                    .setMessage(getProgressDialogMessage());
                        }
                    }
                }
            });
