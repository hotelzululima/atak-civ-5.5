...
public class SendDialog {
    ...
    public void show() {
        if (!MissionPackageMapComponent.getInstance()
            ...
            if (_manifest != null) {
                ...
                builder.setMessage(
                        R.string.would_you_like_to_export_mission_pkg);
    ...
    private void show(String name, final String uri) {
        ...
        if (_manifest != null)
            d.addButton(_context.getDrawable(R.drawable.export_menu_default),
                    _context.getString(R.string.export));
                    ...
                    public void onMissionPackageTaskComplete(
                        ...
                        final DialogInterface.OnClickListener docl = new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                try {
                                    FileSystemUtils.copyFile(f, newFile);
                                    Toast.makeText(_context,
                                            "exported: " + FileSystemUtils
                                                    .prettyPrint(newFile),
                        ...
                        if (newFile.exists()) {
                            ...
                            ad.setMessage("Overwrite existing file: "
                                    + FileSystemUtils.prettyPrint(newFile));
    ...
    private boolean send(String uri, URIContentSender s) {
        ...
        if (_manifest != null && s instanceof MissionPackageSender) {
            ...
            try {
                ...
                Log.e(TAG, "error occurred sending: " + uri + "with " + s, e);
                return false;
            }
        }
    }
    ...
    public static class Builder {
        ...
        private void addFile(MissionPackageManifest mpm, ResourceFile rf,
            ...
            if (shp && !MissionPackageShapefileHandler2.add(
