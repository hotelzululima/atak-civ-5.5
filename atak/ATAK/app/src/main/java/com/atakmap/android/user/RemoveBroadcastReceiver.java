...
public class RemoveBroadcastReceiver extends BroadcastReceiver {
    ...
    private static final String TAG = "RemoveBroadcastReceiver";
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (item == null) {
            Log.w(TAG, "onReceive item not found: " + uid);
            return;
        }
        ...
        MetricsUtils.record(MetricsUtils.CATEGORY_MAPITEM,
                MetricsUtils.EVENT_MAPITEM_REMOVED, "RemoveBroadcastReceiver",
                item, MetricsUtils.EVENT_STATUS_STARTED);
        ...
        b.setPositiveButton(R.string.yes, new OnClickListener() {
            ...
            public void onClick(DialogInterface d, int w) {
                ...
                MetricsUtils.record(MetricsUtils.CATEGORY_MAPITEM,
                        ...
                        item, MetricsUtils.EVENT_STATUS_SUCCESS);
        ...
        b.setNegativeButton(R.string.cancel, new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                MetricsUtils.record(MetricsUtils.CATEGORY_MAPITEM,
                        MetricsUtils.EVENT_MAPITEM_REMOVED,
                        "RemoveBroadcastReceiver",
                        item, MetricsUtils.EVENT_STATUS_CANCELLED);
