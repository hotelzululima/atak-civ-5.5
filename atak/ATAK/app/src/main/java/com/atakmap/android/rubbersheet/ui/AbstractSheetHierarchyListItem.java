...
abstract class AbstractSheetHierarchyListItem extends AbstractHierarchyListItem2
    ...
    AbstractSheetHierarchyListItem(MapView mapView, AbstractSheet item) {
        ...
        _coordFmt = CoordinateFormat.find(prefs.get("coord_display_pref",
    ...
    public void onExportFinished(AbstractSheet item, final File file) {
        ...
        b.setView(v);
        b.setPositiveButton(_context.getString(R.string.locally_import),
                new DialogInterface.OnClickListener() {
                    @Override
        ...
        b.setNeutralButton(_context.getString(R.string.send),
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface,
                            int i) {
                        SendDialog.Builder b = new SendDialog.Builder(_mapView);
                        b.addFile(file, GRGMapComponent.IMPORTER_CONTENT_TYPE);
                        b.show();
                    }
                });
        b.setNegativeButton(_context.getString(R.string.done), null);
        b.show();
    }
}
