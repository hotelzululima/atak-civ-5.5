...
public class DangerCloseMapComponent extends AbstractMapComponent {
    ...
    public void onCreate(Context context, Intent intent, MapView view) {
        ...
        mdp = new MunitionDatasetProvider(context);
        DatasetProviderManager.getInstance().registerDatasetProvider(mdp);
    ...
    public void onDestroyImpl(Context context, MapView view) {
        if (mdp != null)
            DatasetProviderManager.getInstance().unregisterDatasetProvider(mdp);
    }
