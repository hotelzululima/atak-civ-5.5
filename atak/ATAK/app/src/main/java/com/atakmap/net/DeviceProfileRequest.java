...
public class DeviceProfileRequest implements Parcelable {
     ...
     * Required
     */
    private final String serverConnectString;
    ...
    public DeviceProfileRequest(String server, String serverConnectString,
    ...
    public DeviceProfileRequest(String server, String serverConnectString,
        ...
        this(server, serverConnectString, username, password, tool,
                (String) null, null,
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        if (isValid()) {
            ...
            dest.writeString(serverConnectString);
    ...
    protected DeviceProfileRequest(Parcel in) {
        ...
        serverConnectString = in.readString();
