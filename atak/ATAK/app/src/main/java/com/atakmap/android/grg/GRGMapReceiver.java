...
public class GRGMapReceiver extends BroadcastReceiver implements
    ...
    public GRGMapReceiver(MapView mapView, FeatureDataStore2 outlinesDB,
    ...
    public void setValue(int value) {
        if (_selectedInfo != null) {
            if (_sliderMode == SLIDER_TRANSPARENCY) {
                ...
                _rasterLayer.setVisible(_selectedInfo.getName(), _layerVisible);
    ...
    private int getColor(DatasetDescriptor info) {
        return Parsers.parseInt(info.getExtraData("color"), Color.WHITE);
    }
