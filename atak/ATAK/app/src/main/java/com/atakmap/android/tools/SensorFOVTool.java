...
public class SensorFOVTool extends ButtonTool
    ...
    public void onMapEvent(MapEvent event) {
        ...
        int rlsc = _marker.getMetaInteger(
                SensorDetailHandler.RANGE_LINES_STROKE_COLOR,
                Color.LTGRAY);
        double rlsw = _marker.getMetaDouble(
        ...
        sens.setRangeLineStrokeWeight(rlsw);
        sens.setRangeLineStrokeColor(rlsc);
