...
public class GLRootMapGroupLayer implements GLLayer3 {
    ...
    public GLRootMapGroupLayer(MapRenderer surface, RootMapGroupLayer subject) {
        ...
        this.features = new GLMapItemFeatures(surface);
    }
    ...
    public void start() {
        ...
        renderContext.registerControl(this.subject, this.features);
    }

    @Override
    public void stop() {
        renderContext.unregisterControl(this.subject, this.renderer);
        renderContext.unregisterControl(this.subject, this.features);
    }
}
