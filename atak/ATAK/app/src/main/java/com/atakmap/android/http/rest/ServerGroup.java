...
public class ServerGroup {
    ...
    public ServerGroup(String name, String distinguishedName, String direction, long created,
    ...
    public ServerGroup(String name, String direction, long created,
                       String type, int bitpos, boolean active, String description) {
        this(name, null,
                direction, created, type, bitpos, active, description);
    }

    public ServerGroup(ServerGroup serverGroup) {
        this(serverGroup.name, serverGroup.distinguishedName, serverGroup.direction,
                serverGroup.created, serverGroup.type, serverGroup.bitpos, serverGroup.active,
    ...
    public JSONObject toJSON() {
        ...
        try {
            ...
            o.put("distinguishedName", this.distinguishedName);
    ...
    public static ServerGroup fromJSON(JSONObject obj) throws JSONException {
        ...
        try {
            if (obj.has("distinguishedName"))
                distinguishedName = obj.getString("distinguishedName");
        } catch (JSONException e) {
            Log.v(TAG, "JSONException parsing distinguishedName!", e);
        }
