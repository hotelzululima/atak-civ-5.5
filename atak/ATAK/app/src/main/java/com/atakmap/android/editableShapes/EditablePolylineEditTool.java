...
public class EditablePolylineEditTool extends ButtonTool
    ...
    public boolean onToolBegin(Bundle extras) {
        ...
        final GeoBounds bounds = _poly.getBounds(null);
        ...
        } else if (!bounds.intersects(_mapView.getBounds()))
            ATAKUtilities.scaleToFit(_poly);
                ...
                new MapEventDispatcher.MapEventDispatchListener() {
                    ...
                    public void onMapEvent(MapEvent event) {
                        ...
                        if (!_poly.getEditable())
                            return;
                        if (!_poly.isClosed())
                            _poly.addPoint(_mapView.inverseWithElevation(
