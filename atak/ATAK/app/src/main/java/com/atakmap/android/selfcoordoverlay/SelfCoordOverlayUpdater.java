...
public class SelfCoordOverlayUpdater extends CotStreamListener implements
    ...
    public SelfCoordOverlayUpdater(MapView mapView) {
        ...
        _noGpsMessage.setMargins(0.f, 0.f, 10.0f, 5.0f);
        ...
        _text.setMargins(0.f, 0.f, 10.0f, 5.0f);
        ...
        _coordMode = CoordinateFormat.find(_prefs.get(
                "coord_display_pref",
                _mapView.getContext().getString(
                        R.string.coord_display_pref_default)));
        _northReference = Integer
                .parseInt(_prefs.get("rab_north_ref_pref",
                        String.valueOf(NorthReference.MAGNETIC.getValue())));
        _toggle = _prefs.get("self_coord_action", "panto");
        _enlarge = _prefs.get("selfcoord_legacy_enlarge", false);
        ...
        // already on the map, and I have missed the item added so just call out to
        // updateTextVisibility
    ...
    public String getDisplayType() {
        return _prefs.get(PREF_DISPLAY, DISPLAY_BOTTOM_RIGHT);
    }
    ...
    protected class Updater implements Runnable, Disposable {
        ...
        protected void updateText(Marker item) {
                ...
                if (cachedAltString != null
                    ...
                    if (item.getPoint().isAltitudeValid())
                        altString = AltitudeUtilities.format(
                                item.getPoint(), _prefs.getSharedPrefs());
            ...
            if (_bAtLeastOneConnection
                    && _prefs.get("displayServerConnectionWidget", false)) {
    ...
    protected final OnLongPressListener _textLongPressListener = new OnLongPressListener() {
        ...
        public void onMapWidgetLongPress(MapWidget widget) {
            ...
            _prefs.set("coord_legacy_enlarge", _format.getFontSize());
        }
    };
    ...
    private void toggleCoorDisplay() {
        ...
        _prefs.set("coord_display_pref", _coordMode.getDisplayName());
    }
