 ...
 */
public class ImportSQLiteResolver extends gov.tak.api.importfiles.ImportResolver {
    ...
    public ImportSQLiteResolver(Context context) {
        super(".sqlite", null,
                "SQLite Database",
                ResUtils.getDrawable(context, R.drawable.ic_database));
