    ...
    public void onMapEvent(MapEvent event) {
        switch (event.getType()) {
            case MapEvent.ITEM_SHARED:
                ...
                final Bundle bundle = event.getExtras();
                if (bundle != null && bundle.getBoolean("dontSend", false)) {
                    // sending is no longer a function of a MapEvent because they can get dropped
                    // in favor of newer map events.  
                    return;
                }
