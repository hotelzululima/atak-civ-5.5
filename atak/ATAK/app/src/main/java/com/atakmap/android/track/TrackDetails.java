...
public class TrackDetails
    ...
    public TrackDetails(MapView mapView, TrackPolyline track) {
        ...
        _trackPolyline.setCrumbSize(
                Integer.parseInt(_prefs.get("track_crumb_size", "10")));
    }
    ...
    public void onSharedPreferenceChanged(
        ...
        if (key.equals("track_crumb_size")) {
            _trackPolyline.setCrumbSize(Integer.parseInt(
                    _prefs.get("track_crumb_size", "10")));
        }
    }
    ...
    public String getGainString() {
        final int altFmt = Integer.parseInt(
                _prefs.get("alt_unit_pref", String.valueOf(Span.ENGLISH)));
