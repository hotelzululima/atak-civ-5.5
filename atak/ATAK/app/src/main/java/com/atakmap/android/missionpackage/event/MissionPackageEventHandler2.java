...
import gov.tak.api.importfiles.ImportResolver.SortFlags;

/**
 * Base handler for Mission Packages being processed
 */
public class MissionPackageEventHandler2 implements IMissionPackageEventHandler2 {

    private static final String TAG = "MissionPackageEventHandler2";

    protected final Context _context;

    public MissionPackageEventHandler2(Context context) {
        _context = context;
    }
    ...
    public boolean extract(MissionPackageManifest manifest,
        ...
        Log.d(TAG, "Extracting file: " + content);
        ...
        String filePath = importFile(toUnzip, contentType, EnumSet.copyOf(flags), sorters);
    ...
    private String importFile(final File file, final String contentType,
                              final EnumSet<SortFlags> flags, final List<ImportResolver> sorters) {
