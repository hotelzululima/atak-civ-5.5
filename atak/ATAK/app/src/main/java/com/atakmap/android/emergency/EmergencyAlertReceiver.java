...
public class EmergencyAlertReceiver extends BroadcastReceiver {
    ...
    private static EmergencyAlertReceiver _instance = null;
    ...
    private final ConcurrentLinkedQueue<OnAlertChangedListener> _listeners;
    ...
    /**
     * Retrieve the emergency alert receiver which can be used to get a list of active
     * emergency alerts by a plugin
     * @return the emergency alert receiver
     */
    public static EmergencyAlertReceiver getInstance() {
        if (_instance == null) {
            throw new IllegalStateException(
                    "EmergencyAlertReceiver not initialized yet");
        }
        return _instance;
    }
    ...
    private EmergencyAlert fromCot(CotEvent event, boolean requireLink) {
        ...
        if (requireLink) {
            ...
            if (alert.item == null) {
                ...
                if (mg == null) {
                    Log.d(TAG, "bad event occurring during shutdown, ignoring");
                    return null;
                }
