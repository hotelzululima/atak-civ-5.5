...
public abstract class AbstractMapItemSelectionTool extends Tool implements
    ...
    private final DeconflictionListener deconflictionListener = new DeconflictionListener() {
    ...
    /**
     * Must call dispose when the tool is no longer being used.    After this object is disposed,
     * it will no longer respond to intents.
     */
    @Override
    public void dispose() {
    ...
    public boolean onToolBegin(Bundle extras) {
        ...
        _mapView.getMapTouchController()
                .addDeconflictionListener(deconflictionListener);
        return true;
    }
    ...
    public void onToolEnd() {
        ...
        _mapView.getMapTouchController()
                .removeDeconflictionListener(deconflictionListener);
