...
public class RangeAndBearingDropDown extends DropDownReceiver implements
    ...
    public RangeAndBearingDropDown(MapView mapView) {
        ...
        _prefs = AtakPreferences.getInstance(mapView
                .getContext());
        _prefs.registerListener(prefsChangedListener);

        _coordinateFormat = CoordinateFormat.find(_prefs
                .get("coord_display_pref", getMapView().getContext().getString(
                        R.string.coord_display_pref_default)));

        // eta & speed
        _speedUnits = Integer
                .parseInt(_prefs.get("speed_unit_pref", "3"));
        _showEta = _prefs.get("rab_preference_show_eta", false);
    ...
    public void disposeImpl() {
        _prefs.unregisterListener(prefsChangedListener);
        ...
        public void onSharedPreferenceChanged(SharedPreferences prefs,
            ...
            switch (key) {
                case "coord_display_pref":
                    _coordinateFormat = CoordinateFormat.find(_prefs.get(
                            "coord_display_pref",
    ...
    protected void initializeWidgets() {
        ...
        _nameEditText.addTextChangedListener(new AfterTextChangedWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                RangeAndBearingMapItem rabItem = _rabItem;
                if (rabItem != null) {
                    final String _prevName = rabItem.getTitle();
                    rabItem.setTitle(s.toString());
                    ...
                    if (MetricsApi.shouldRecordMetric()) {
                        ...
                        MetricsUtils.record(MetricsUtils.CATEGORY_MAPITEM,
                                ...
                                "RangeAndBearingDropDown", rabItem, b);
                    }
                }
            }
        });

        urlUiHandler = new UrlUiHandler(_dropDownView);
        ...
        _markingField = _dropDownView.findViewById(R.id.markingField);

        _authorText = _dropDownView.findViewById(R.id.dgInfoAuthor);
        _productionTimeText = _dropDownView
                .findViewById(R.id.dgInfoProductionTime);
        cotAuthorLayout = _dropDownView.findViewById(R.id.cotAuthorLayout);
        cotAuthorIconButton = _dropDownView
                .findViewById(R.id.dgAuthorIconButton);
        cotAuthorPanButton = _dropDownView
    ...
    protected void populateWidgets() {
        ...
        GenericDetailsView.setClassification(_rabItem, _markingField);

        CoTInfoView.refreshAuthorLayout(getMapView(), _rabItem, _authorText,
    ...
    private void displayColorSelectDialog() {
        ...
        palette.setColor(_rabItem.getStrokeColor());
    ...
    protected void displayCoordinateDialog(GeoPointMetaData point,
        ...
        final Context _context = getMapView().getContext();

        final boolean movable;
        if (pointNum == 0 && _rabPoint1 != null)
            movable = _rabPoint1.getMovable();
        else if (pointNum == 1 && _rabPoint2 != null)
            movable = _rabPoint1.getMovable();
        else
            movable = true;
        ...
        CoordinateEntryCapability.getInstance(_context).showDialog(
                ...
                point,
                movable, getMapView().getPoint(),
                _coordinateFormat, false,
                new CoordinateEntryCapability.ResultCallback() {
                    ...
                    public void onResultCallback(String pane,
                        ...
                        if (cf.getDisplayName().equals(pane)
                            ...
                            _coordinateFormat = cf;
                        if (pointNum == 1) {
                            _rabItem.setPoint1(point);
                        } else if (pointNum == 2) {
                            _rabItem.setPoint2(point);
                        }
