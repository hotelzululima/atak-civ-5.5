...
public class ExportTrackHistoryTask extends AsyncTask<Void, String, String> {
    ...
    public ExportTrackHistoryTask(MapView view, ExportTrackParams params) {
        ...
        this.prefs = AtakPreferences.getInstance(
                this.context);
        this.exportKMLTimestampsPref = prefs.get("track_kml_export_timestamps",
                false);
    }
    ...
    private String exportTrackKMLnoTimestamps(String name, String exportPath,
        ...
        final boolean clampToGround = prefs.get("kmlExportGroundClamp", false);
        final String kmlExportCheckpointMode = prefs
                .get("kmlExportCheckpointMode", "Both");
    ...
    private String exportTrackKMLwithTimestamps(String name, String exportPath,
        ...
        checkpoints.setFeatureList(new ArrayList<>());
        Folder tracks = new Folder();
        tracks.setFeatureList(new ArrayList<>());
        ...
        if (checkpoints.getFeatureList().isEmpty()
                && tracks.getFeatureList().isEmpty()) {
    ...
    private Route exportTrackRoute(String name, int[] track_dbids,
        ...
        String prefix = prefs.get("waypointPrefix", "CP");
        Route route = null;
        if (routeGroup != null) {
        ...
        int color = Integer.parseInt(prefs.get("defaultRouteColor",
    ...
    private String exportTrackCSV(String uid, String name, String exportPath,
        ...
        final boolean bExportHeaders = prefs.get("track_csv_export_headers",
                true);
