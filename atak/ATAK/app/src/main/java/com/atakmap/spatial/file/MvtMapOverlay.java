...
public final class MvtMapOverlay extends FeatureDataStoreMapOverlay {
    ...
    /** @deprecated use {@link #MvtMapOverlay(Context, FeatureDataStore2, FeatureDataStoreDeepMapItemQuery} */
    @Deprecated
    ...
    public MvtMapOverlay(Context context, FeatureDataStore2 spatialDb,
            FeatureDataStoreDeepMapItemQuery query) {
        super(context,
                spatialDb,
                MvtSpatialDb.MVT_TYPE,
