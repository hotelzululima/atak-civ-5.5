...
class GeocoderNominatim {
    ...
    private static final String MAPQUEST_SERVICE_URL = "https://open.mapquestapi.com/nominatim/v1/";
    ...
    protected Address buildAndroidAddress(JSONObject jResult)
        ...
        if (jAddress.has("county")) { //France: department
    ...
    public List<Address> getFromLocation(double latitude, double longitude,
            ...
            throws IOException {
        String keyPart = "";
        if (mServiceKey != null && !mServiceKey.isEmpty())
