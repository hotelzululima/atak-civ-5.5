 ...
 */
public class GridToolbar implements
        OnClickListener, IToolbarExtension2 {
    ...
    private void openEditDialog() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (units.equals(Span.FOOT.getPlural()))
                    spacing = SpanUtilities.convert(spacing, Span.FOOT,
                            Span.METER);
                _prefs.set(CustomGrid.SPACING_PREF, (float) spacing);
                _prefs.set(CustomGrid.COLOR_PREF, _gridColor);
                _prefs.set(CustomGrid.LABELS_PREF, labelsCb.isChecked());
        ...
        String units = _prefs.get(CustomGrid.UNITS_PREF,
        ...
        spacingUnits.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                _prefs.set(CustomGrid.UNITS_PREF, units);
    ...
    private void openColorPrompt(final ImageButton btn, final SeekBar sb) {
        ...
        palette.setColor(_grid.getColor());
        adb.setView(palette);
