...
public class AddEditResource {
                ...
                .setOnClickListener(new android.view.View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        List<String> history = MRUStringCache.GetHistory(
                                _prefs.getSharedPrefs(), IMPORT_URL_KEY);
    ...
    private void createResource(final RemoteResource resource,
        ...
        if (_prefs != null) {
            ...
            if (!FileSystemUtils.isEmpty(url)
                ...
                MRUStringCache.UpdateHistory(_prefs.getSharedPrefs(),
                        IMPORT_URL_KEY,
                        newrr.getUrl());
        }
    }
    ...
    private void promptImportLink() {
        ImportFileBrowserDialog d = new ImportFileBrowserDialog(
                _mapView.getContext());
    ...
    private void importFile(File f) {
        ...
        for (ImportResolver sorter : sorters) {
            if (sorter instanceof RemoteResourceResolver)
                importer = sorter;
        }
        ...
        importer.beginImport(f, EnumSet.noneOf(ImportResolver.SortFlags.class));
        if (this.dialog != null)
            this.dialog.dismiss();
    }
}
