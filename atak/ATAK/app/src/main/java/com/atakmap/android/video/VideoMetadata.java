...
public class VideoMetadata implements Disposable {
    ...
    public void update(
                ...
                try {
                    switch (e.getKey()) {
                        ...
                        case METADATA_ITEMID_PLATFORM_DESIGNATION: {
                            // also known as the device designation
                            platformDesignator = (String) e.getValue()
                                    .getValue();
                            break;
                        }
                        case METADATA_ITEMID_MISSION_ID: {
                            missionId = (String) e.getValue()
                                    .getValue();
                            break;
                        }
                    ...
                    try {
                        ...
                        Log.e(TAG, "error decoding: " + e.getKey(), ex2);
                    }
                }
        ...
        if (Double.compare(prevFrameLatitude, frameLatitude) != 0 ||
            ...
            if (useKlvElevation && !Double.isNaN(frameElevation)) {
                ...
                double alt = ATAKUtilities.getElevation(frameLatitude,
                        frameLongitude, frameDTED);
            }
