...
public class ContactDetailDropdown extends DropDownReceiver implements
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (action.equals(CoTInfoBroadcastReceiver.COTINFO_DETAILS)
                ||
    ...
    private void getDetailView() {
        if (this._detailView == null) {
            ...
            _profileView.init(getMapView(), _prefs.getSharedPrefs(), this);

            _locationView = new ContactLocationView();
            _locationView.init(getMapView(), _prefs.getSharedPrefs(), this);

            _connectorsView = new ContactConnectorsView();
            _connectorsView.init(getMapView(), _prefs.getSharedPrefs(), this);
            ...
            _contactInfo_detailSelfEdit
                    .setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            //TODO refresh when settings screen is closed? maybe check dropDown.onVisible()
