...
public class Marker extends PointMapItem implements Exportable, Capturable {
    ...
    protected static final EventSet markerEventSet;

    @Override
    protected EventSet.Listeners createEventListeners() {
        return markerEventSet.createListeners();
    }

    private static final EventSet.Parameters1<OnIconChangedListener, Marker> onIconChanged;
    private static final EventSet.Parameters1<OnTitleChangedListener, Marker> onTitleChanged;
    private static final EventSet.Parameters1<OnSummaryChangedListener, Marker> onSummaryChanged;
    private static final EventSet.Parameters1<OnStateChangedListener, Marker> onStateChanged;
    private static final EventSet.Parameters1<OnMarkerHitBoundsChangedListener, Marker> onMarkerHitBoundsChanged;
    private static final EventSet.Parameters1<OnTrackChangedListener, Marker> onTrackChanged;
    private static final EventSet.Parameters1<OnStyleChangedListener, Marker> onStyleChanged;
    private static final EventSet.Parameters1<OnLabelTextSizeChangedListener, Marker> onLabelTextSizeChanged;
    private static final EventSet.Parameters1<OnLabelPriorityChangedListener, Marker> onLabelPriorityChanged;

    static {
        EventSet.Builder builder = new EventSet.Builder(pointMapItemEventSet,
                "Marker");
        onIconChanged = builder.addEvent(
                new EventSet.Invoker1<OnIconChangedListener, Marker>() {
                    @Override
                    public void invoke(OnIconChangedListener l, Marker marker) {
                        l.onIconChanged(marker);
                    }
                });
        onTitleChanged = builder.addEvent(
                new EventSet.Invoker1<OnTitleChangedListener, Marker>() {
                    @Override
                    public void invoke(OnTitleChangedListener l,
                            Marker marker) {
                        l.onTitleChanged(marker);
                    }
                });
        onSummaryChanged = builder.addEvent(
                new EventSet.Invoker1<OnSummaryChangedListener, Marker>() {
                    @Override
                    public void invoke(OnSummaryChangedListener l,
                            Marker marker) {
                        l.onSummaryChanged(marker);
                    }
                });
        onStateChanged = builder.addEvent(
                new EventSet.Invoker1<OnStateChangedListener, Marker>() {
                    @Override
                    public void invoke(OnStateChangedListener l,
                            Marker marker) {
                        l.onStateChanged(marker);
                    }
                });
        onMarkerHitBoundsChanged = builder.addEvent(
                new EventSet.Invoker1<OnMarkerHitBoundsChangedListener, Marker>() {
                    @Override
                    public void invoke(OnMarkerHitBoundsChangedListener l,
                            Marker marker) {
                        l.onMarkerHitBoundsChanged(marker);
                    }
                });
        onTrackChanged = builder.addEvent(
                new EventSet.Invoker1<OnTrackChangedListener, Marker>() {
                    @Override
                    public void invoke(OnTrackChangedListener l,
                            Marker marker) {
                        l.onTrackChanged(marker);
                    }
                });
        onStyleChanged = builder.addEvent(
                new EventSet.Invoker1<OnStyleChangedListener, Marker>() {
                    @Override
                    public void invoke(OnStyleChangedListener l,
                            Marker marker) {
                        l.onStyleChanged(marker);
                    }
                });
        onLabelTextSizeChanged = builder.addEvent(
                new EventSet.Invoker1<OnLabelTextSizeChangedListener, Marker>() {
                    @Override
                    public void invoke(OnLabelTextSizeChangedListener l,
                            Marker marker) {
                        l.onLabelSizeChanged(marker);
                    }
                });
        onLabelPriorityChanged = builder.addEvent(
                new EventSet.Invoker1<OnLabelPriorityChangedListener, Marker>() {
                    @Override
                    public void invoke(OnLabelPriorityChangedListener l,
                            Marker marker) {
                        l.onLabelPriorityChanged(marker);
                    }
                });
        markerEventSet = builder.build();
    }
    ...
    public static final int STATE_MODIFIER_MASK = 0xFFFF0000;

    public static final int ICON_STATE_MASK = 0x0000FFFF;

    /**
     * The marker should appear and behave as selected
     */
    public static final int STATE_SELECTED_MASK = 1 << 16;

    /**
     * The marker should appear and behave as focused
     */
    public static final int STATE_FOCUSED_MASK = 1 << 17;

    /**
     * The marker should appear and behave as pressed
     */
    public static final int STATE_PRESSED_MASK = 1 << 18;

    /**
     * The marker should appear and behave as canceled
     */
    public static final int STATE_CANCELED_MASK = 1 << 19;

    /**
     * The marker should appear and behave as disabled
     */
    public static final int STATE_DISABLED_MASK = 1 << 20;
    ...
    private Marker(final long serialId,
        ...
        AccessUtils.setAccessDefault(this);
    }
     ...
     * 
     * @param state any of the STATE_*_MASK flags or'd together
     */
    ...
    /**
     * Updates either the marker or icon component of the marker's state while leaving the other
     * component unchanged.
     *
     * @param stateMask State mask (currently should be either STATE_MODIFIER_MASK or ICON_STATE_MASK)
     * @param state Any of the STATE_*MASK flags or'd together or an icon state value
     */
    public void setState(int stateMask, int state) {
        state = (_state & ~stateMask) | state;
        setState(state);
    }
    ...
    public void addOnStyleChangedListener(OnStyleChangedListener l) {
        eventListeners.addListener(onStyleChanged, l);
    }

    public void removeOnStyleChangedListener(OnStyleChangedListener l) {
        eventListeners.removeListener(onStyleChanged, l);
    }
    ...
    public void addOnIconChangedListener(OnIconChangedListener listener) {
        eventListeners.addListener(onIconChanged, listener);
    }
    ...
    public void removeOnIconChangedListener(OnIconChangedListener listener) {
        eventListeners.removeListener(onIconChanged, listener);
    }
    ...
    public void addOnTitleChangedListener(OnTitleChangedListener listener) {
        eventListeners.addListener(onTitleChanged, listener);
    }

    public void addOnLabelSizeChangedListener(
            OnLabelTextSizeChangedListener listener) {
        eventListeners.addListener(onLabelTextSizeChanged, listener);

    }

    public void removeOnLabelSizeChangedListner(
            OnLabelTextSizeChangedListener listener) {
        eventListeners.removeListener(onLabelTextSizeChanged, listener);
    }
    ...
    public void removeOnTitleChangedListener(OnTitleChangedListener listener) {
        eventListeners.removeListener(onTitleChanged, listener);
    }
    ...
    public void addOnSummaryChangedListener(OnSummaryChangedListener listener) {
        eventListeners.addListener(onSummaryChanged, listener);
    }
    ...
    public void removeOnSummaryChangedListener(
        ...
        eventListeners.removeListener(onSummaryChanged, listener);
    }
    ...
    public void addOnLabelPriorityChangedListener(
        ...
        eventListeners.addListener(onLabelPriorityChanged, listener);
    }
    ...
    public void removeOnLabelPriorityChangedListener(
            OnLabelPriorityChangedListener listener) {
        eventListeners.removeListener(onLabelPriorityChanged, listener);
    }
    ...
    public void addOnStateChangedListener(OnStateChangedListener listener) {
        eventListeners.addListener(onStateChanged, listener);
    }
    ...
    public void removeOnStateChangedListener(OnStateChangedListener listener) {
        eventListeners.removeListener(onStateChanged, listener);
    }
    ...
    public void addOnMarkerHitBoundsChangedListener(
        ...
        eventListeners.addListener(onMarkerHitBoundsChanged, listener);
    ...
    public void removeOnMarkerHitBoundsChangedListener(
            OnMarkerHitBoundsChangedListener listener) {
        eventListeners.removeListener(onMarkerHitBoundsChanged, listener);
    }

    public void addOnTrackChangedListener(OnTrackChangedListener listener) {
        if (listener != null)
            eventListeners.addListener(onTrackChanged, listener);
    }

    public void removeOnTrackChangedListener(OnTrackChangedListener listener) {
        eventListeners.removeListener(onTrackChanged, listener);
    }
    ...
    public void setTrack(double heading, double speed) {
        if (Double.compare(_heading, heading) != 0
            ...
            _speed = Double.isNaN(speed) ? 0.0 : speed;
            onTrackChanged();
        }
    }
    ...
    protected void onMarkerHitBoundsChanged() {
        onMarkerHitBoundsChanged.invoke(eventListeners, this);
    }
    ...
    protected void onIconChanged() {
        onIconChanged.invoke(eventListeners, this);
    }
    ...
    protected void onTitleChanged() {
        onTitleChanged.invoke(eventListeners, this);
    }

    protected void onLabelTextSizeChanged() {
        onLabelTextSizeChanged.invoke(eventListeners, this);
    }

    protected void onLabelPriorityChanged() {
        onLabelPriorityChanged.invoke(eventListeners, this);
    }
    ...
    protected void onSummaryChanged() {
        onSummaryChanged.invoke(eventListeners, this);
    }
    ...
    protected void onStateChanged() {
        onStateChanged.invoke(eventListeners, this);
    }

    protected void onTrackChanged() {
        onTrackChanged.invoke(eventListeners, this);
    }

    protected void onStyleChanged() {
        onStyleChanged.invoke(eventListeners, this);
    }
    ...
    public static int getAffiliationColor(Marker t) {
        ...
        int typeColor = getAffiliationColor(t.getType());
        if (Color.WHITE != typeColor)
            return typeColor;
    ...
    /**
     * Uses the type to determine the affiliation color:
     * red = hostile, blue = friendly, pink/magenta for CIV for example.
     */
    public static int getAffiliationColor(String type) {
        ...
        if (type.startsWith("a-f")) {
            if (type.startsWith("a-f-A-C") || type.startsWith("a-f-G-E-V-C"))
                return Color.argb(255, 255, 161, 255);
            else
    ...
    protected Folder toKml() {
        try {
            ...
            if (_icon != null && (getIconVisibility() == ICON_VISIBLE)) {
                final IconStyle istyle = new IconStyle();
            ...
            if (_icon != null && getIconVisibility() == ICON_VISIBLE) {
                ...
                if (!FileSystemUtils.isEmpty(imageUri)) {
                    ...
                    if (imageUri.startsWith("sqlite")) {
                        ...
                        kmzIconPath = "icons" + File.separatorChar +
                                HashingUtils.md5sum(imageUri) + ".png";
                    } else {
    ...
    private void generateLabelOnly(final Style style) {
        if (!FileSystemUtils.isEmpty(_title)) {

            final IconStyle istyle = new IconStyle();
            // this is the correct way, but it makes it so that the placemark label is
            // not touchable in google earth
            if (true)
                istyle.setIcon(new com.ekito.simpleKML.model.Icon());
            else {
                // depending on what people want to have happen this would allow for google
                // earth to have a trnaparent pushpin that can be touched, but it offsets the
                // label in both ATAK and Google Earth.
                com.ekito.simpleKML.model.Icon icon = new com.ekito.simpleKML.model.Icon();
                String whtpushpin = MapView.getMapView().getContext()
                        .getString(R.string.whtpushpin);
                icon.setHref(whtpushpin);
                // cheat google eearth so that the label is clickable
                int color = 0x01FFFFFF & getTextColor();
                istyle.setScale(0.5f);
                //HotSpot hotSpot = new HotSpot();
                //istyle.setHotSpot(hotSpot);
                istyle.setColor(KMLUtil.convertKmlColor(color));
                istyle.setIcon(icon);
            }
            style.setIconStyle(istyle);
            ...
            labelStyle.setColor(KMLUtil.convertKmlColor(color));
     ...
     * 
     * @param marker the marker to get the description from for the thumbnail
     * @param attachments the list of attachments
     * @return the completed html that will show up in the marker description
     */
    ...
    /**
     * Sets the color of the marker.   The rendering of a Marker's Icon modulates (aka multiplies)
     * the color of the original icon bitmap with the client specified color on the Icon object.
     * <p>
     * Note:   Setting the color of colored icons will yield coloring congruent with
     * multiplying a colored icon asset with a multiplication of the provided color.
     * In order to achieve the desired result where the color provided is the color shown,
     * you will need to create a local copy of the icon (either on disk or in memory)
     * and convert it to grayscale. Once in grayscale, modulation with the color specified on
     * the Icon will produce the result you are looking for.
     * <p>
     * For the in-memory case, you want to
     * <p>
     * 1) convert to Bitmap to grayscale
     * 2) output Bitmap to a PNG byte array
     * 3) convert byte array to base64
     * 4) specify new icon URI as "base64://<the-base64-string-from-#3>"
     *
    ...
    public void drawCanvas(CapturePP cap, Bundle data) {
        ...
        if (getTextRenderFlag() == TEXT_STATE_NEVER_SHOW) {
            ...
            cap.drawLabel(title, new PointF(point.x, point.y),
                    TextRect.ALIGN_Y_CENTER, getTextColor(), true);
        }
    }
}
