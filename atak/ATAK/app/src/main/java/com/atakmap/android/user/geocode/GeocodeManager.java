...
public class GeocodeManager {
    ...
    public static class GeocoderException extends Exception {
        ...
        /**
         * If there is an exception when geocoding is being performed
         * @param msg the message in human readable form that describes what when wrong.
         * @param e the exception that caused the geocoding error
         */
        public GeocoderException(String msg, Exception e) {
            initCause(e);
            this.msg = msg;
        }
    ...
    public interface Geocoder2 extends Geocoder {
        /**
         * Returns true if the Geocoder is available and can be used.
         */
        boolean isAvailable();
    }
    ...
    public interface Geocoder {
         ...
         * @throws GeocoderException if there is an error when geocoding
         */
    ...
    /**
     * The interface for listening when the default geocoder is changed in the system.
     */
    ...
    private GeocodeManager(Context c) {
        _prefs = AtakPreferences.getInstance(c);
        context = c;
    ...
    synchronized public Geocoder getSelectedGeocoder() {
        final String selected_uid = _prefs.get("selected_geocoder_uid",
                "");
    ...
    synchronized public void setDefaultGeocoder(String uid) {
        _prefs.set("selected_geocoder_uid", uid);
    ...
    private final Geocoder AndroidGeocoder = new Geocoder2() {
    ...
    private class NominatimGeocoder implements Geocoder2 {
