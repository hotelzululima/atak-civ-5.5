...
public class DrawingRectangleCreationTool extends Tool implements
    ...
    public boolean onToolBegin(Bundle extras) {
        ...
        _b.setEditHandlesVisible(false);
    ...
    public void onMapEvent(MapEvent event) {
        ...
        if (mode == FIRST_POINT) {
            ...
            r.setCenterPointVisible(_prefs.getCenterPointVisible());

            ATAKUtilities.setAuthorInformation(r);
    ...
    /***
     * Performs button initialization, setting up onclick listeners etc. Override if the default
