...
final class DisplayModeHierarchyListItem extends DevToolGroup {
    private final MapRenderer2 _renderer;

    public DisplayModeHierarchyListItem(MapRenderer2 renderer) {
        super("Display Mode", "MapRenderer2.DisplayMode");

        _renderer = renderer;
        _children.add(new DisplayModeHierarchyListItem.DisplayModelToggleImpl(
