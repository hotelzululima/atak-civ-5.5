...
class DozeManagement {
    ...
    static void checkDoze(final Context context) {
        ...
        final AtakPreferences pref = AtakPreferences.getInstance(context);
        boolean automatedTesting = pref.get(
                "automatedTesting_disableRequestBatteryOptimization", false);
        pref.remove("automatedTesting_disableRequestBatteryOptimization");
        if (automatedTesting)
            return;
                                ...
                                public void postHint() {
                                    try {
                                        ...
                                        Toast.makeText(context,
                                                R.string.could_not_disable_battery_optimization,
                                                Toast.LENGTH_SHORT).show();
                                        HintDialogHelper.enableHint(context,
                                                "batoptimization.issue", false);
                                    }
                                }
                            }, false);
        }
