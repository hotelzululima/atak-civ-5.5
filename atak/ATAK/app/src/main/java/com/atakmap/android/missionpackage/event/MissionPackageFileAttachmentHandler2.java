 ...
 */
public class MissionPackageFileAttachmentHandler2 implements
        IMissionPackageEventHandler2 {

    private static final String TAG = "MissionPackageAddFileAttachment2";

    private final MapGroup _rootGroup;
    private final Context _context;

    public MissionPackageFileAttachmentHandler2(Context context,
                                               MapGroup rootGroup) {
        _context = context;
