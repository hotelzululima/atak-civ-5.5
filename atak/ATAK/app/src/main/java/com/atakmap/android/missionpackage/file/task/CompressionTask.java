...
public class CompressionTask extends MissionPackageBaseTask {
    ...
    private String compressMissionPackage() {
        try {
            ...
            // A number of exceptions can occur at this point such as file space exhaustion
            // shutting down, etc - so return null as that is the appropriate failure condition
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (!isCancelled()) {
            if (!FileSystemUtils.isFile(_manifest.getPath())) {
                ...
                if (_followUpTask != null) {
                    ...
                    _followUpTask.setProgressDialog(getProgressDialog());
        ...
        if (_followUpTask == null && getProgressDialog() != null) {
