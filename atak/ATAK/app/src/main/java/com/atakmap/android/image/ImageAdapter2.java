...
public class ImageAdapter2 extends BaseAdapter implements Disposable {
        ...
        try {
            ...
            if (exif.getLatLong(latLng)) {
                    ...
                    public void run() {
                        ...
                        locText.setText(CoordinateFormatUtilities
                                .formatToString(
                                        gp.get(), _cFormat)
                                + "\n" +
                                AltitudeUtilities.format(gp.get(),
                ...
                try {
                     ...
                     */
                    TiffImageMetadata metadata = ExifHelper
                            .getExifMetadata(bmpFile);
                    if (metadata != null) {
                        TiffField x = metadata
                                .findField(
