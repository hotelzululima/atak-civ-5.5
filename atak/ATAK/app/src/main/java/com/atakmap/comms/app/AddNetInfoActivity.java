...
public class AddNetInfoActivity extends MetricActivity {
    ...
    private String getProto() {
        ...
        RadioButton quicRadio = findViewById(R.id.quic_radio);
        // determine protocol
        ...
        } else if (quicRadio.isChecked()) {
            proto = CotServiceRemote.Proto.quic.toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (type.compareTo("input") == 0 || type.compareTo("inputs") == 0) {
            ...
            quicRadio.setEnabled(false);
            quicRadio.setVisibility(View.GONE);
        ...
        if (protocol != null) {
            if (CotServiceRemote.Proto.tcp.toString().equals(protocol)) {
                ...
                sslRadio.setChecked(true);
            } else if (CotServiceRemote.Proto.quic.toString()
                    .equals(protocol)) {
                quicRadio.setChecked(true);
            }
        }
        ...
        if (useAuthFlag) {
            ...
            if (cacheCreds != null) {
                ...
                if (cacheCreds
                        .equals(this.getString(R.string.cache_creds_both)))
                    cacheCreds = ResourceUtil.getString(this,
                            R.string.cache_creds_both, Locale.US);
                else if (cacheCreds
                        .equals(this.getString(R.string.cache_creds_username)))
                    cacheCreds = ResourceUtil.getString(this,
                            R.string.cache_creds_username, Locale.US);

                if (cacheCreds.equalsIgnoreCase(ResourceUtil.getString(this,
                        R.string.cache_creds_both, Locale.US)))
                    spinnerCacheCreds.setSelection(0);
                else if (cacheCreds
                        .equalsIgnoreCase(ResourceUtil.getString(this,
                                R.string.cache_creds_username, Locale.US)))
        ...
        boolean doEnrollment = extras.getBoolean(
        ...
        boolean showExportKeystoreButton = AtakPreferences.getInstance(this)
                .get("certEnrollmentExport", false);

        exportKeystoreButton
                .setVisibility(showExportKeystoreButton ? View.VISIBLE
                        : View.GONE);
        exportKeystoreButton.setEnabled(doEnrollment);
        ...
        if (sslRadio.isChecked() || quicRadio.isChecked()) {
        ...
        OnClickListener sslBasedClickListener = new OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                String p = portEditText.getText().toString();
                if (v.equals(sslRadio))
                    portEditText.setText("8089");
                else if (v.equals(quicRadio))
                    portEditText.setText("8090");

            }
        };
        sslRadio.setOnClickListener(sslBasedClickListener);
        quicRadio.setOnClickListener(sslBasedClickListener);
        ...
        tcpRadio.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                portEditText.setText("8088");
            }
        });

        final CheckBox enrollKeystoreBox = findViewById(
                R.id.enroll_keystore_cb);
        final CheckBox enrollUseTrustBox = findViewById(
                R.id.enroll_usetrust_cb);
        final TextView enrollUseTrustText = findViewById(
                R.id.enroll_usetrust_detail_tv);
        enrollKeystoreBox.setChecked(doEnrollment);
        enrollUseTrustBox.setEnabled(doEnrollment);
        enrollUseTrustText.setEnabled(doEnrollment);
        enrollUseTrustBox.setChecked(enrollWithTrust);
        enrollKeystoreBox
                .setOnCheckedChangeListener(new OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton cb,
                        ...
                        enrollUseTrustBox.setEnabled(checked);
                        enrollUseTrustText.setEnabled(checked);
                    }
                });
                    ...
                    public void run() {
                        ...
                        if (useAuthBox.isChecked()) {
                            ...
                            data.putString("password", password
                                    .getEditableText().toString().trim());
                            switch (spinnerCacheCreds
                                    .getSelectedItemPosition()) {
                                case 0:
                                    data.putString("cacheCreds",
        ...
        exportKeystoreButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "clicked export keystore button");
     ...
     * @param atakSubdir
     * @param extensionType
     * @param c the callback to call when the file is successfully selected.
     */
