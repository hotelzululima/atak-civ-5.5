                ...
                b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (standText.getText().length() > 0) {
                            ...
                            String s = standText.getText()
                                    .toString();
                            standingValue = Parsers.parseInt(s, -1);
                        ...
                        if (proneText.getText().length() > 0) {
                            ...
                            String s = proneText.getText()
                                    .toString();
                            proneValue = Parsers.parseInt(s, -1);
                        ...
                        if (proneProtText.getText().length() > 0) {
                            ...
                            String s = proneProtText
                                    .getText().toString();
                            proneProtValue = Parsers.parseInt(s, -1);
                        ...
                        if (n != null) {
                            String s = n.getAttributes()
                                    .getNamedItem("ID").getNodeValue();
                            id = Parsers.parseInt(s, -1);
                            if (id < 0)
                                return;
        ...
        alert.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                if (n != null) {
                    ...
                    Node ricochetFan_distance = attrs.getNamedItem("ricochetfan_distance");
                    Node ricochetFan_angle = attrs.getNamedItem("ricochetfan_angle");
                    Node ricochetFan = attrs.getNamedItem("ricochetfan");
                    EditText ricoDegField = v
                            .findViewById(R.id.custom_rico_fan_angle);
                    EditText ricoMetersField = v
                            .findViewById(R.id.custom_rico_fan_distance);

                    if (ricochetFan != null) {
                        //set ricochet fan field
                        String fan = ricochetFan.getNodeValue();
                        String degrees = "";
                        String meters = "";

                        if (fan != null) {
                            String[] args = fan.split("/");
                            if (args.length > 1) {
                                degrees = args[0].replace("°", "").trim();
                                meters = args[1].replace("m", "").trim();
                            }
                        }
                        ricoDegField.setText(degrees);
                        ricoMetersField.setText(meters);
                    } else if (ricochetFan_distance != null && ricochetFan_angle != null) {
                        String degrees = ricochetFan_angle.getNodeValue();
                        String meters = ricochetFan_distance.getNodeValue();
                        ricoDegField.setText(degrees);
                        ricoMetersField.setText(meters);
                    }
                }
                ...
                b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (distText.getText().length() > 0) {
                            ...
                            String s = distText.getText()
                                    .toString();
                            distanceValue = Parsers.parseInt(s, -1);
                        ...
                        if (ricoDegText.getText().length() > 0
                            ...
                            String s1 = ricoDegText
                                    .getText().toString();
                            ricoDegValue = Parsers.parseInt(s1, -1);
                            ...
                            String s = ricoMetersText
                                    .getText().toString();
                            ricoMetersValue = Parsers.parseInt(s, -1);
