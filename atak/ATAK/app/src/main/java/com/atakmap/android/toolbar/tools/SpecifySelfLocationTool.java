...
import com.atakmap.android.location.ManualPlacedLocationProvider;
...
public class SpecifySelfLocationTool extends Tool {
    ...
    private final MapEventDispatcher.MapEventDispatchListener selfLocationPressListener = new MapEventDispatcher.MapEventDispatchListener() {
        ...
        public void onMapEvent(MapEvent event) {
            ...
            ManualPlacedLocationProvider locationProvider = new ManualPlacedLocationProvider();
            locationProvider.setLocation(gpm);
            LocationManager.getInstance().registerProvider(locationProvider,
