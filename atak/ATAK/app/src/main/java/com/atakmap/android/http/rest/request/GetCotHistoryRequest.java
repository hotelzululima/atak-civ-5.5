...
public class GetCotHistoryRequest implements Parcelable {
    ...
    public GetCotHistoryRequest(String baseUrl, String serverConnectString,
            String uid, long start,
            long end, String matcher, String tag,
            int notificationId, boolean parse) {
        mBaseUrl = baseUrl;
    ...
    public GetCotHistoryRequest(String baseUrl, String serverConnectString,
        ...
        this(baseUrl, serverConnectString, uid, start, end, matcher, tag,
                notificationId, true);
    }
