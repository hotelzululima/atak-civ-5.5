...
public class RecentlyAddedDropDownReceiver extends DropDownReceiver
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(START)) {
            String coordValue = _prefs.get("coord_display_pref",
    ...
    public void addToRecentList(MapItem item) {
        ...
        final RecentlyAdded recent = new RecentlyAdded(item, anchor,
                currPoint.get());
    ...
    private void refreshLayout(final Runnable r) {
    ...
    private static class RecentlyAdded {
