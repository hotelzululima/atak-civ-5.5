...
public class FeatureHierarchyListItem extends
    ...
    /** @deprecated use {@link #FeatureHierarchyListItem(FeatureDataStore2, Feature)} */
    @Deprecated
    ...
    public boolean goTo(boolean select) {
        ...
        if (!MapTouchController.goTo(MapView.getMapView().getMapItem(uid),
                select, true)) {
