...
public class FeatureSetHierarchyListItem extends AbstractHierarchyListItem2
    ...
    /** @deprecated use {@link #FeatureSetHierarchyListItem(Context, FeatureDataStore2,  FeatureSet, Sort, BaseAdapter, String, String, String)} */
    @Deprecated
    ...
    /** @deprecated use {@link #FeatureSetHierarchyListItem(Context, FeatureDataStore2,  FeatureSet, String, Sort, BaseAdapter, String, String, String)} */
    @Deprecated
    @DeprecatedApi(since = "5.3", forRemoval = true, removeAt = "5.6")
    public FeatureSetHierarchyListItem(Context context,
            FeatureDataStore spatialDb, FeatureSet group,
    ...
    /** @deprecated use {@link #FeatureSetHierarchyListItem(Context, FeatureDataStore2,  FeatureSet, String, HierarchyListFilter, BaseAdapter, String, String, String)} */
    @Deprecated
    @DeprecatedApi(since = "5.3", forRemoval = true, removeAt = "5.6")
    public FeatureSetHierarchyListItem(Context context,
            FeatureDataStore spatialDb, FeatureSet group,
    ...
    private void prepareQueryParams(
        ...
        if (this.entry.fsid != FeatureDataStore.FEATURESET_ID_NONE
            ...
            params.names = new HashSet<>(2);
            params.names.add(this.path);
            params.names.add(this.path + "/%");
            params.ids = this.entry.childFsids;
            if (this.entry.fsid != FeatureDataStore2.FEATURESET_ID_NONE) {
    ...
    private void prepareQueryParams(
        ...
        if (this.entry.fsid != FeatureDataStore2.FEATURESET_ID_NONE
            ...
            params.featureSetFilter.names.add(this.path + "/%");
            params.featureSetFilter.ids = this.entry.childFsids;
            if (this.entry.fsid != FeatureDataStore2.FEATURESET_ID_NONE) {
                params.featureSetFilter.ids = new HashSet<>(
                        params.featureSetFilter.ids);
                params.featureSetFilter.ids.add(this.entry.fsid);
            }
        }
    }
    ...
    public int getDescendantCount() {
        if (this.descendantCount == -1) {
            FeatureDataStore2.FeatureQueryParameters params = new FeatureDataStore2.FeatureQueryParameters();
            params.featureSetFilter = new FeatureDataStore2.FeatureSetQueryParameters();
            params.featureSetFilter.names = Collections
                    .singleton(this.path + "/%");
            params.featureSetFilter.ids = this.entry.childFsids;
    ...
    private void fillWindow(CursorWindow resultsWindow, int off, int num) {
        ...
        try {
            ...
            if ((this.order instanceof SortDistanceFrom)
                ...
                params.order = Collections.singleton(
                        new FeatureDataStore2.FeatureQueryParameters.Order.Name());
            }
