...
public class ColorPalette extends LinearLayout {
    ...
    protected static final String[] colorLabelArray = new String[] {
            ...
            "Turquoise", "Green", "Forest", "Gray", "Black"
    };
    ...
    private void setLayout(@LayoutRes int layoutId) {
                    ...
                    public void onCheckedChanged(RadioGroup group,
                        ...
                        if (checkedId == R.id.fill_color
                            ...
                            if (checkedId == R.id.both_colors)
                                selectColor(_strokeColor, false);
                        } else {
            ...
            public View getView(int position, View row,
                ...
                btn.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        selectColor(((ColorButton) v).getColor(), true);
                    }
                });
                return btn;
            }
        ...
        _preview.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (_listener != null) {
                    _listener.onColorSelected(_fillColor, "");
                }
            }
        });
     ...
     */
    private void selectColor(@ColorInt int color, boolean notifyListener) {
        if (!_showFill) {
            _strokeColor = color;
            if (_listener != null && notifyListener)
        ...
        if (!settingFill()) {
            if (_alphaBar.getVisibility() == VISIBLE)
                _strokeColor = (color & 0xFFFFFF)
                        + (_alphaBar.getProgress() << 24);
            else
     ...
     * @return True if setting fill color
     */
    ...
    private void showCustomColorDialog() {
        ...
        b.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface d, int w) {
                selectColor(picker.getColor(), false);
            }
        });
