...
public class PluginLayoutInflater {
    ...
    @FortifyFinding(finding = "Access Specifier Manipulation ", rational = "Required as part of clearing out the layout view map associated with previous plugin loads.")
    private static void setAccessible(Field f, boolean state) {
        if (f != null)
