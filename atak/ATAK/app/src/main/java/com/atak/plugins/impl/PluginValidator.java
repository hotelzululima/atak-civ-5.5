...
class PluginValidator {
     ...
     * @throws CertificateException a certificate exception if there is a problem with the certificate
     * @throws NoSuchAlgorithmException if the device does not support the algorithm used for the key
     * @throws InvalidKeyException if the key is invalid
     * @throws SignatureException if the signature for the key is bad
     */
