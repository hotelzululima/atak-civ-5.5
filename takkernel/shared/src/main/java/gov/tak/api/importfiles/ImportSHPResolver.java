 ...
 * Imports Shapefiles
 */
public class ImportSHPResolver extends ImportResolver {

    private static final String TAG = "ImportSHPSort";

    private static final int MAGIC_NUMBER = 9994;

    public ImportSHPResolver(String displayName, File destinationDir, Drawable icon) {
        super(".shp", destinationDir, displayName, icon);
