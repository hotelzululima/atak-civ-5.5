...
{
    static {
        MarshalManager.registerMarshal(AttributeSetMarshals.IN_MAP,
                Map.class, AttributeSet.class);
        MarshalManager.registerMarshal(AttributeSetMarshals.IN_GEOPOINTMETADATA,
                GeoPointMetaData.class, AttributeSet.class);
        MarshalManager.registerMarshal(AttributeSetMarshals.OUT_GEOPOINTMETADATA,
                AttributeSet.class, GeoPointMetaData.class);
    }
    ...
    AttributeSetBase(Map<String, AttributeSetBase.AttributeValue> attributeMap)
    {
     ...
     */
    @NonNull
    public String getStringAttribute(@NonNull String name, String defaultValue)
    {
     ...
     */
    @NonNull
    public byte[] getBinaryAttribute(@NonNull String name, byte[] defaultValue)
    {
     ...
     */
    @NonNull
    public int[] getIntArrayAttribute(@NonNull String name, int[] defaultValue)
    {
     ...
     */
    @NonNull
    public long[] getLongArrayAttribute(@NonNull String name, long[] defaultValue)
    {
     ...
     */
    @NonNull
    public double[] getDoubleArrayAttribute(@NonNull String name, double[] defaultValue)
    {
     ...
     */
    @NonNull
    public String[] getStringArrayAttribute(@NonNull String name, String[] defaultValue)
    {
     ...
     */
    @NonNull
    public byte[][] getBinaryArrayAttribute(@NonNull String name, byte[][] defaultValue)
    {
    ...
    final void setAttribute(@NonNull String name, @NonNull AttributeValue newAttributeValue)
    {
        ...
        try
        {
            oldAttributeValue = attributeMap.put(name, newAttributeValue);
        }
        finally
        {
            rwLock.releaseWrite();
    ...
    public void removeAttribute(@NonNull String name)
    {
        ...
        try
        {
            oldAttributeValue = attributeMap.remove(name);
        }
        finally
        {
            rwLock.releaseWrite();
     ...
     */
    @NonNull
    private <T> T typedGet(String key, @NonNull AttributeType type, T defValue)
    {
