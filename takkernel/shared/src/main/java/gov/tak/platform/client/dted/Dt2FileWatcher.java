 ...
 */
public class Dt2FileWatcher extends Thread implements Disposable
{
    ...
    public Dt2FileWatcher(List<File> rootDirs)
    {
        super(TAG);
    ...
    public static String getRelativePath(File file)
    {
        ...
        int dtedIdx = path.toUpperCase().indexOf(File.separator + "DTED");
        if (dtedIdx == -1)
        {
            return file.getName();
        }
