...
public class TextWidget extends MapWidget implements ITextWidget
{
    ...
    @Override
    public void addOnHasBackgroundChangedListener(OnHasBackgroundChangedListener l)
    {
        _onHasBackgroundChanged.add(l);
    }

    @Override
    public void removeOnHasBackgroundChangedListener(OnHasBackgroundChangedListener l)
    {
    ...
    {
        this(text, textFormat, hasBackground ? TRANSLUCENT_BLACK : TRANSLUCENT);
    }

    /**
     * The Text widget created with some text, formatting and the background set to a specific color.
     *
