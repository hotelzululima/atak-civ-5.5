 ...
 * <p>
 * <a href="http://cot.mitre.org">cot.mitre.org</a>
 */
public class CotEvent implements Parcelable {
    ...
    public CotEvent(final CotEvent event) {
        ...
        this._caveat = event._caveat;
        this._releasableTo = event._releasableTo;
    }
    ...
    /**
     * the xml representation as part of an appendable.
     */
    ...
    private void buildXmlImpl(Appendable b) throws IOException {
        ...
        // as of MIL-STD-6090 access is now required
        b.append(" access='");
        if (FileSystemUtils.isEmpty(_access))
            b.append("Undefined");
        else {
            b.append(_access);
        }
        ...
        // as of MIL-STD-6090 caveat is new but optional
        if (_caveat != null) {
            b.append(" caveat='");
            b.append(_caveat);
            b.append("'");
        ...
        // as of MIL-STD-6090 relesableTo is new but optional
        if (_releasableTo != null) {
            b.append(" releasableTo='");
            b.append(_releasableTo);
            b.append("'");
        }
    ...
    /**
     * Set the 'access' attribute of the event. Note: As of MIL-STD-6090 this is required.
     * 
     * @param access the access for the cot event { Unclassified, NATO Unclassified,
     *               NATO Restricted, Confidential, NATO Confidential, Secret, NATO Secret, ]
     *               Undefined }
     */
     ...
     *
     * @param caveat the caveat for the cot event { CUI, NOFORN, REL TO }
     */
     ...
     *
     * @param releasableTo the caveat for the cot event.  Is a comma delineated list of tricodes.
     */
