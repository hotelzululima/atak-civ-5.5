...
abstract class MilStd2525dSymbologyTableTestBase extends KernelTest {

    abstract ISymbologyProvider newInstance();
    abstract String getForwardLineOfTroopsId();
    abstract String getAirCivilianFixedWingId();
    
    @Test
    public void getSymbol_valid_code() {
        final String forwardLineOfTroopsId = getForwardLineOfTroopsId();
    ...
    public void getPreviewDrawable_unit() {
        final String airCivilianFixedWingId = getAirCivilianFixedWingId();
        ISymbologyProvider milsym = newInstance();
