...
public class GLBatchTileTextureDrawer
{
     ...
     *
     * @param view The GLMapView that contains the scene model forward matrix to use
     */
    public void populateForwardMatrix(GLMapView view)
    {
        forwardMatrix = view.currentPass.sceneModelForwardMatrix;
    }
     ...
     *
     * @param forwardMatrix The new forward matrix state of the batch
     */
     ...
     *
     * @param texId              The identifier for the texture
     * @param mode               The triangle drawing mode
     * @param numCoords          The number of indices
     * @param textureCoordinates The buffer to the texture coordinates
     * @param vertexCoordinates  The buffer to the vertex coordinates
     * @param indices            The indices that define how the vertices should be drawn
     */
