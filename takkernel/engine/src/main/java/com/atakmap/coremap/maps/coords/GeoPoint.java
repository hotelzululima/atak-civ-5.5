...
public final class GeoPoint implements Parcelable
{
    ...
    public static final double MIN_ACCEPTABLE_ALTITUDE = -14000;
    ...
    {
        this(iGeoPoint.getLatitude(), iGeoPoint.getLongitude(), iGeoPoint.getAltitude(),
                MarshalManager.marshal(iGeoPoint.getAltitudeReference(),
