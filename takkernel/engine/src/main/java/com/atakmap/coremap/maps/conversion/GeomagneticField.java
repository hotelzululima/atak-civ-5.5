...
public final class GeomagneticField
{
     ...
     *
     * @param latitude  Latitude in WGS84 geodetic coordinates -- positive is east.
     * @param longitude Longitude in WGS84 geodetic coordinates -- positive is north.
     * @param hae       Altitude in WGS84 geodetic coordinates, in meters (HAE).
     * @param millis    Time at which to evaluate the declination, in milliseconds
