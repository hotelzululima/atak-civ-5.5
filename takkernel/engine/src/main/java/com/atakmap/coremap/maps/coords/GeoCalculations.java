...
public final class GeoCalculations
{
    static
    {
        // XXX - hacky initialization of marshaler
        final gov.tak.api.engine.map.coords.GeoPoint gp = new gov.tak.api.engine.map.coords.GeoPoint(0d, 0d);
        gp.getAltitude();
    }
     ...
     * @deprecated {@link gov.tak.api.engine.map.coords.GeoCalculations#bearing(IGeoPoint, IGeoPoint)}
     */
    @Deprecated
    @DeprecatedApi(since = "4.7", removeAt = "5.0")
    public static double bearingTo(final GeoPoint source,
                                   final GeoPoint destination)
    {

        return gov.tak.api.engine.map.coords.GeoCalculations.bearing(
                MarshalManager.marshal(source, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class),
                MarshalManager.marshal(destination, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class));
    ...
    {
        return MarshalManager.marshal(
                gov.tak.api.engine.map.coords.GeoCalculations.computeAverage(MarshalManager.marshal(points, GeoPoint.class, IGeoPoint.class), offset, count, wrap180),
     ...
     * @deprecated {@link gov.tak.api.engine.map.coords.GeoCalculations#midpoint(IGeoPoint, IGeoPoint)}
     */
    @Deprecated
    @DeprecatedApi(since = "4.7", removeAt = "5.0")
    public static GeoPoint midPointWGS84(GeoPoint a, GeoPoint b)
    {
        return MarshalManager.marshal(gov.tak.api.engine.map.coords.GeoCalculations.midpoint(
                        MarshalManager.marshal(a, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class),
                        MarshalManager.marshal(b, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class)),
                IGeoPoint.class, GeoPoint.class);
    }
     ...
     * @deprecated {@link gov.tak.api.engine.map.coords.GeoCalculations#distance(IGeoPoint, IGeoPoint)}
     */
    @Deprecated
    @DeprecatedApi(since = "4.7", removeAt = "5.0")
    public static double distanceTo(final GeoPoint start,
                                    final GeoPoint destination)
    {
        return gov.tak.api.engine.map.coords.GeoCalculations.distance(
                MarshalManager.marshal(start, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class),
                MarshalManager.marshal(destination, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class));
    }
     ...
     * @deprecated {@link gov.tak.api.engine.map.coords.GeoCalculations#slantDistance(IGeoPoint, IGeoPoint)}
     */
    @Deprecated
    @DeprecatedApi(since = "4.7", removeAt = "5.0")
    public static double slantDistanceTo(final GeoPoint start,
                                         final GeoPoint destination)
    {
        return gov.tak.api.engine.map.coords.GeoCalculations.slantDistance(
                MarshalManager.marshal(start, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class),
                MarshalManager.marshal(destination, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class));
    }
     ...
     * @deprecated {@link gov.tak.api.engine.map.coords.GeoCalculations#pointAtDistance(IGeoPoint, IGeoPoint, double)}
     */
    @Deprecated
    @DeprecatedApi(since = "4.7", removeAt = "5.0")
    public static GeoPoint pointAtDistance(GeoPoint src, double azimuth,
                                           double distance)
    {
        return MarshalManager.marshal(gov.tak.api.engine.map.coords.GeoCalculations.pointAtDistance(
                MarshalManager.marshal(src, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class),
                azimuth, distance), IGeoPoint.class, GeoPoint.class);
    }
                                           ...
                                           double distance, double inclination)
    {
        ...
        return MarshalManager.marshal(gov.tak.api.engine.map.coords.GeoCalculations.pointAtDistance(
                MarshalManager.marshal(src, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class),
                azimuth, distance, inclination), IGeoPoint.class, GeoPoint.class);
     ...
     *
     * @param src Starting point of the calculation.
     * @param dst Destination point of the calculation.
     * @return Destination point, if the point is antipodal from the starting point then the
     * calculation could be off. Attempts to calculate the altitude from inclination.
     * @deprecated {@link gov.tak.api.engine.map.coords.GeoCalculations#pointAtDistance(IGeoPoint, IGeoPoint, double)}
     */
                                           ...
                                           double weight)
    {
        ...
        final GeoPoint surface = pointAtDistance(
                src,
                bearingTo(src, dst),
                distanceTo(new GeoPoint(srcLat, srcLng), new GeoPoint(dstLat, dstLng)) * weight,
                0);
     ...
     * @deprecated {@link gov.tak.api.engine.map.coords.GeoCalculations#slantAngle(IGeoPoint, IGeoPoint)}
     */
    @Deprecated
    @DeprecatedApi(since = "4.7", removeAt = "5.0")
    public static double inclinationTo(final GeoPoint start,
                                       final GeoPoint destination)
    {
        return gov.tak.api.engine.map.coords.GeoCalculations.slantAngle(
                MarshalManager.marshal(start, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class),
                MarshalManager.marshal(destination, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class));
    }
     ...
     * @deprecated {@link gov.tak.api.engine.map.coords.GeoCalculations#approximateMetersPerDegreeLongitude(double)}
     */
    @Deprecated
    @DeprecatedApi(since = "4.7", removeAt = "5.0")
     ...
     * @deprecated {@link gov.tak.api.engine.map.coords.GeoCalculations#approximateMetersPerDegreeLatitude(double)}
     */
    @Deprecated
    @DeprecatedApi(since = "4.7", removeAt = "5.0")
     ...
     * no intersection
     * @deprecated {@link gov.tak.api.engine.map.coords.GeoCalculations#lineOfBearingIntersect(IGeoPoint, double, IGeoPoint, double)}
     */
    @Deprecated
    @DeprecatedApi(since = "4.7", removeAt = "5.0")
    ...
    {
        return MarshalManager.marshal(gov.tak.api.engine.map.coords.GeoCalculations.lineOfBearingIntersect(
                        MarshalManager.marshal(aStart, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class), aBearing,
                        MarshalManager.marshal(bStart, GeoPoint.class, gov.tak.api.engine.map.coords.GeoPoint.class), bBearing),
                IGeoPoint.class, GeoPoint.class);
    }
}
