 ...
 * and string exporting are properly formatted.
 */
public class CoordinatedTime implements Parcelable
{
    ...
    {
        return new CoordinatedTime(timestamp + (long) seconds * 1000);
    }
     ...
     * 
     * @deprecated to be removed without replacement, use {@link Integer#parseInt(String)}
     */
    @Deprecated
