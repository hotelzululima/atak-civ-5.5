...
public final class DistanceCalculations
{
                                                    ...
                                                    GeoPoint second, GeoPoint third)
    {
        ...
        lengths[0] = GeoCalculations.distanceTo(first, third);
        lengths[1] = GeoCalculations.distanceTo(first, second);
        lengths[2] = GeoCalculations.distanceTo(third, second);
        return lengths;
    }
                                             ...
                                             GeoPoint endPoint)
    {
        ...
        return GeoCalculations.slantDistanceTo(startPoint, endPoint);
    }
                                   ...
                                   final double lat2deg, final double lon2deg)
    {
        ...
        return gov.tak.api.engine.map.coords.GeoCalculations.haversine(
                new gov.tak.api.engine.map.coords.GeoPoint(lat1deg, lon1deg),
                new gov.tak.api.engine.map.coords.GeoPoint(lat2deg, lon2deg));
    }
    ...
    public static double[] computeDirection(GeoPoint a, GeoPoint b)
    {
        ...
        retval[0] = gov.tak.api.engine.map.coords.GeoCalculations.distance(
                new gov.tak.api.engine.map.coords.GeoPoint(a.getLatitude(), a.getLongitude()),
                new gov.tak.api.engine.map.coords.GeoPoint(b.getLatitude(), b.getLongitude()));
        retval[1] = gov.tak.api.engine.map.coords.GeoCalculations.bearing(
                new gov.tak.api.engine.map.coords.GeoPoint(a.getLatitude(), a.getLongitude()),
                new gov.tak.api.engine.map.coords.GeoPoint(b.getLatitude(), b.getLongitude()));
        return retval;
    }
