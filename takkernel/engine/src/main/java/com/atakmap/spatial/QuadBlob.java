...
public final class QuadBlob
{
    ...
    public byte[] getBlob(IGeoPoint a, IGeoPoint b, IGeoPoint c, IGeoPoint d)
    {
        return getBlob(
            a.getLatitude(),
            a.getLongitude(),
    ...
    public byte[] getBlob(double alat, double alng, double blat, double blng, double clat, double clng, double dlat, double dlng)
    {
        if (this.quad == null)
        {
