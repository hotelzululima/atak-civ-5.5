...
public class AtakAuthenticationHandlerHTTP
{
    ...
    private static HttpURLConnection duplicate(HttpURLConnection conn) throws IOException
    {
        ...
        if (retval instanceof javax.net.ssl.HttpsURLConnection) {
            if(conn instanceof javax.net.ssl.HttpsURLConnection) {
                ((HttpsURLConnection) retval).setSSLSocketFactory(((HttpsURLConnection) conn).getSSLSocketFactory());
            } else {
    ...
    {
        final SSLSocketFactory connSocketFactory = connection.getSSLSocketFactory();
        if(connSocketFactory == null || connSocketFactory == HttpsURLConnection.getDefaultSSLSocketFactory()) {
