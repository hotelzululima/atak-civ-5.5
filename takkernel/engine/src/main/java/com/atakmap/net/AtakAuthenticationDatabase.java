...
public class AtakAuthenticationDatabase
{
            ...
            boolean expires)
    {
        ...
        synchronized (getAdapter().lock)
        {
            ...
            getAdapter().saveCredentialsForType(type, site, username, password,
                    expires ?
                            AtakAuthenticationDatabaseAdapter.EXPIRATION_INTERVAL :
                            AtakAuthenticationDatabaseAdapter.PERPETUAL);
        }
    }
