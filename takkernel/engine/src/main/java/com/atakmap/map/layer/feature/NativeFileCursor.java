...
// XXX - will be come final/package private on deprecation execution
/** @deprecated to be removed without replacement */
@Deprecated
@DeprecatedApi(since = "5.3", forRemoval = true, removeAt = "5.6")
@DontObfuscate
public class NativeFileCursor implements DataSourceFeatureDataStore.FileCursor, DataSourceDataStoreControl.FileCursor
{
