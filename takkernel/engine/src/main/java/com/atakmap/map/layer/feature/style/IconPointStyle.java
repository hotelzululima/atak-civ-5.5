...
public final class IconPointStyle extends Style
{
     ...
     * @param iconHeight       The icon render height. Use <code>0f</code> to
     *                         render at original height.
     * @param offsetX          The x-axis pixel offset of the icon from the reference point
     * @param offsetY          The y-axis pixel offset of the icon from the reference point
     * @param alignX           The horizontal alignment of the icon. Less than
     *                         <code>0</code> for to the left, <code>0</code>
     *                         for horizontal centered, greater than
     *                         <code>0</code> for to the right
     ...
     *                         rotation is relative to screen "up".
     */
    public IconPointStyle(int color, String iconUri, float iconWidth, float iconHeight, float offsetX, float offsetY, int alignX, int alignY, float rotation, boolean rotationAbsolute)
    {
        this(IconPointStyle_create(color,
                iconUri,
                iconWidth,
     ...
     * the rotation value.
     *
     * @return The rotation of the icon, in degrees counter-clockwise.
    ...
    /**
     * Returns the vertical offset to be applied to the icon when rendering.
     *
     * @return The vertical offset for the icon with respect to the point in pixels
     */
    ...
    /**
     * Returns the horizontal offset to be applied to the icon when rendering.
     *
     * @return The horizontal offset for the icon with respect to the point in pixels
     */
