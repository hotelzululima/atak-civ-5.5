...
public interface DataSourceDataStoreControl
{
    /**
     * @param file A file
     ...
     */
    boolean add(File file) throws IOException;
     ...
     *                                  layers for the specified file.
     */
    boolean add(File file, String hint) throws IOException;
     ...
     * @throws IOException
     */
    boolean update(File file) throws IOException;
     ...
     * @throws IOException
     */
    boolean update(FeatureSet featureSet) throws IOException;
     ...
     */
    FileCursor queryFiles();

    /***
     * Sets the field that determines the default read-only state of future feature sets
     *
     * @param readOnly Boolean value indicating whether feature set is read-only
     */
