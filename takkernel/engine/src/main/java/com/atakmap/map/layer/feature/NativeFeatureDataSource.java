...
public class NativeFeatureDataSource implements FeatureDataSource, Disposable
{
    ...
    public final static class NativeContent implements FeatureDataSource.Content
    {
        ...
        public FeatureDefinition get()
        {
            ...
            try
            {
                ...
                retval.altitudeMode = Feature.AltitudeMode.from(NativeFeatureDefinition3.getAltitudeMode(cretval));
                retval.extrude = NativeFeatureDefinition3.getExtrude(cretval);
    ...
    final static int GeometryEncoding_GeomWkt = getFeatureDefinition_GeometryEncoding_GeomWkt();

    final static int GeometryEncoding_GeomWkb = getFeatureDefinition_GeometryEncoding_GeomWkb();

    final static int GeometryEncoding_GeomBlob = getFeatureDefinition_GeometryEncoding_GeomBlob();

    final static int GeometryEncoding_GeomGeom = getFeatureDefinition_GeometryEncoding_GeomGeom();

    final static int StyleEncoding_StyleOgr = getFeatureDefinition_StyleEncoding_StyleOgr();

    final static int StyleEncoding_StyleStyle = getFeatureDefinition_StyleEncoding_StyleStyle();
}
