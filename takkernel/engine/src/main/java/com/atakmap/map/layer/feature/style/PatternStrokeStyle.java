...
public class PatternStrokeStyle extends Style
{
    ...
    {
        this(factor, pattern, r, g, b, a, strokeWidth, BasicStrokeStyle.EXTRUDE_VERTEX);
    }

    public PatternStrokeStyle(int factor, short pattern, float r, float g, float b, float a, float strokeWidth, int extrudeMode)
    {
