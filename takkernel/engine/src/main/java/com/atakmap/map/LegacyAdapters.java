...
public final class LegacyAdapters
{
    ...
    final static class MapRendererContext implements RenderContext
    {
        ...
        {
            return this.impl.isRenderThread();
        }

        @Override
        public void queueEvent(Runnable r)
        {
            this.impl.queueEvent(r);
        }

        @Override
        public void requestRefresh()
        {
            this.impl.requestRefresh();
        }

        @Override
        public void setFrameRate(float rate)
        {
            this.impl.setFrameRate(rate);
        }
        ...
        {
            this.impl.setContinuousRenderEnabled(enabled);
        }

        @Override
        public boolean isContinuousRenderEnabled()
        {
            return this.impl.isContinuousRenderEnabled();
        }
    ...
    static class MapRenderer2Adapter implements gov.tak.api.engine.map.MapRenderer<RenderContext>
    {
        ...
        final Map<gov.tak.api.engine.map.MapRenderer.OnCameraChangedListener, MapRenderer2.OnCameraChangedListener2> _onCameraChangedForwarders = new IdentityHashMap<>();
        ...
        @Override final public boolean isAnimating()
        {
            return _impl.isAnimating();
        }

        @Override final public gov.tak.api.engine.map.MapSceneModel getMapSceneModel(boolean instant, DisplayOrigin origin)
        {
        ...
        @Override final public DisplayMode getDisplayMode()
        {
            return _impl.getDisplayMode();
        }

        @Override final public void setDisplayMode(DisplayMode mode)
        {
            _impl.setDisplayMode(mode);
        }

        @Override final public void setFocusPointOffset(float x, float y)
        {
            _impl.setFocusPointOffset(x, y);
        }

        @Override final public float getFocusPointOffsetX()
        {
            return _impl.getFocusPointOffsetX();
        }

        @Override final public float getFocusPointOffsetY()
        {
            return _impl.getFocusPointOffsetY();
        }

        @Override final public DisplayOrigin getDisplayOrigin()
        {
            return _impl.getDisplayOrigin();
        }

        @Override final public void addOnCameraChangedListener(gov.tak.api.engine.map.MapRenderer.OnCameraChangedListener l)
        {
            final MapRenderer2.OnCameraChangedListener2 forwarder;
            synchronized (_onCameraChangedForwarders)
            {
                if (_onCameraChangedForwarders.containsKey(l))
                    return;
        ...
        @Override final public void removeOnCameraChangedListener(gov.tak.api.engine.map.MapRenderer.OnCameraChangedListener l)
        {
            final MapRenderer2.OnCameraChangedListener2 forwarder;
            synchronized (_onCameraChangedForwarders)
            {
        ...
        @Override final public boolean forward(gov.tak.api.engine.map.coords.GeoPoint lla, gov.tak.api.engine.math.PointD xyz, DisplayOrigin origin)
        {
        ...
        @Override final public InverseResult inverse(gov.tak.api.engine.math.PointD xyz, gov.tak.api.engine.map.coords.GeoPoint lla, InverseMode mode, int modeHints, DisplayOrigin origin)
        {
        ...
        @Override final public void setElevationExaggerationFactor(double factor)
        {
            _impl.setElevationExaggerationFactor(factor);
        }

        @Override final public double getElevationExaggerationFactor()
        {
            return _impl.getElevationExaggerationFactor();
        }

        @Override final public void registerControl(gov.tak.api.engine.map.ILayer layer, Object ctrl)
        {
        ...
        @Override final public void unregisterControl(gov.tak.api.engine.map.ILayer layer, Object ctrl)
        {
            if (ctrl instanceof MapControl)
            {
                final com.atakmap.map.layer.Layer adapted = com.atakmap.map.layer.LegacyAdapters.adapt(layer);
        ...
        @Override final public <T> boolean visitControl(gov.tak.api.engine.map.ILayer layer, final gov.tak.api.util.Visitor<T> visitor, final Class<T> ctrlClazz)
        {
        ...
        @Override final public boolean visitControls(gov.tak.api.engine.map.ILayer layer, final gov.tak.api.util.Visitor<Iterator<Object>> visitor)
        {
            final com.atakmap.map.layer.Layer adapted = com.atakmap.map.layer.LegacyAdapters.adapt(layer);
            if (!(adapted instanceof com.atakmap.map.layer.Layer2))
                return false;
        ...
        @Override final public void visitControls(final gov.tak.api.util.Visitor<Iterator<Map.Entry<gov.tak.api.engine.map.ILayer, Collection<Object>>>> visitor)
        {
        ...
        @Override final public void addOnControlsChangedListener(gov.tak.api.engine.map.MapRenderer.OnControlsChangedListener l)
        {
            final MapRendererBase.OnControlsChangedListener forwarder;
            synchronized (_onControlsChangedForwarders)
            {
                if (_onControlsChangedForwarders.containsKey(l))
                    return;
        ...
        @Override final public void removeOnControlsChangedListener(gov.tak.api.engine.map.MapRenderer.OnControlsChangedListener l)
        {
            final MapRendererBase.OnControlsChangedListener forwarder;
            synchronized (_onControlsChangedForwarders)
            {
        ...
        @Override final public RenderContext getRenderContext()
        {
    ...
    final static class CameraChangedEventForwarder implements MapRenderer2.OnCameraChangedListener2
    {
    ...
    final static class ControlsChangedEventForwarder implements MapRendererBase.OnControlsChangedListener
    {
        ...
        public void onControlRegistered(com.atakmap.map.layer.Layer2 layer, MapControl ctrl)
        {
            final gov.tak.api.engine.map.MapRenderer target = _target.get();
            if (target != null)
                _cb.onControlRegistered(com.atakmap.map.layer.LegacyAdapters.adapt2(layer), ctrl);
        }
        ...
        public void onControlUnregistered(com.atakmap.map.layer.Layer2 layer, MapControl ctrl)
        {
            final gov.tak.api.engine.map.MapRenderer target = _target.get();
            if (target != null)
                _cb.onControlUnregistered(com.atakmap.map.layer.LegacyAdapters.adapt2(layer), ctrl);
        }
    }
}
