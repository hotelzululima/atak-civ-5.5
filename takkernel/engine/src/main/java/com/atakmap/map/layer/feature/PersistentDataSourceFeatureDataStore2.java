...
/** @deprecated use {@link PersistentDataSourceFeatureDataStore3} */
@Deprecated
...
public final class PersistentDataSourceFeatureDataStore2 implements DataSourceFeatureDataStore
{
    ...
    public PersistentDataSourceFeatureDataStore2(File database, boolean readOnly)
    {
        this.pointer = create(database != null ? database.getAbsolutePath() : null, readOnly);

        this.impl = new NativeFeatureDataStore2(asBase(this.pointer.raw), null);
    ...
    {
        setReadOnly(this.pointer.raw, readOnly);
    }
    ...
    static native Pointer create(String path, boolean readOnly);
    ...
    static native void setReadOnly(long pointer, boolean value);
}
