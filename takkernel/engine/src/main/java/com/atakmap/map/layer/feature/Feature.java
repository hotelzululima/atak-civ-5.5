...
public final class Feature implements Disposable
{
    ...
    public enum LineMode
    {
        ...
        /**
         * Given a line mode value as expressed by an integer, return the appropriate enum.
         *
         * @param value a value of either 0, 1, 2
         * @return returns the corresponding line mode, if the value passed in is invalid
         * it will return {@link #Rhumb}.
         */
        public static LineMode from(int value)
        {
            switch (value)
            {
                case 1:
    ...
    public static class Traits
    {
        ...
        public LineMode lineMode = LineMode.Rhumb;
        ...
        public boolean equals(Object o)
        {
            ...
            return Double.compare(extrude, traits.extrude) == 0 && altitudeMode == traits.altitudeMode && lineMode == traits.lineMode;
        }

        @Override
        public int hashCode()
        {
            return Objects.hash(altitudeMode, extrude, lineMode);
        }
    }
     ...
     * @deprecated use {@link #Feature(long, long, String, Geometry, Style, AttributeSet, Traits, long, long)}
     */
    @Deprecated
    ...
    {
        this(fsid, fid, name, geom, style, attributes, createTraits(AltitudeMode.ClampToGround, 0.0), timestamp, version);
    }
    ...
    {
        this(fsid, fid, name, geom, style, attributes, createTraits(altitudeMode, extrude), timestamp, version);
    }

    public Feature(long fsid, long fid, String name, Geometry geom, Style style, AttributeSet attributes, Traits traits, long timestamp, long version)
    {
        this(create(fsid, fid, name, (geom != null) ? Interop.getPointer(geom).raw : 0L, (style != null) ? Interop.getPointer(style).raw : 0L, (attributes != null) ? attributes.pointer.raw : 0L, traits, timestamp, version));
    }
    ...
    {
        return getGeometry(def.getGeomCoding(), def.getRawGeometry());
    }

    static Geometry getGeometry(int geomCoding, Object rawGeom)
    {
        Geometry geom = null;
        switch (geomCoding)
        {
    ...
    {
        return getStyle(def.getStyleCoding(), def.getRawStyle());
    }

    static Style getStyle(int styleCoding, Object rawStyle)
    {
        Style style = null;
        switch (styleCoding)
        {
    ...
    private static Traits createTraits(AltitudeMode altitudeMode, double extrude)
    {
    ...
    static native Pointer create(long fsid, long fid, String name, long geom, long style, long attributes, Traits traits, long timestamp, long version);
    ...
    static native Traits getTraits(long ptr);
} // Feature
