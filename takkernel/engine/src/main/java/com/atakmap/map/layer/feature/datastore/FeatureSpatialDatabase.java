...
public class FeatureSpatialDatabase extends CatalogDatabase
{
    ...
    /** @deprecated use {@link com.atakmap.spatial.SpatiaLiteDB#getMajorVersion(DatabaseIface)} */
    @Deprecated
    @DeprecatedApi(since = "5.3", forRemoval = true, removeAt = "5.6")
    @DontObfuscate
    ...
    /** @deprecated use {@link com.atakmap.spatial.SpatiaLiteDB#getMinorVersion(DatabaseIface)} */
    @Deprecated
    @DeprecatedApi(since = "5.3", forRemoval = true, removeAt = "5.6")
    @DontObfuscate
