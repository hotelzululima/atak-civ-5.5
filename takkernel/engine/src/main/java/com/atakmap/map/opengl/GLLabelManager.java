...
public class GLLabelManager
{
    ...
    private final static int HORIZONTAL_ALIGNMENT_LEFT = 0;
    private final static int HORIZONTAL_ALIGNMENT_CENTER = 1;
    private final static int HORIZONTAL_ALIGNMENT_RIGHT = 2;
    ...
    private final static int PRIORITY_ALWAYS = 0;
    private final static int PRIORITY_HIGH = 1;
    private final static int PRIORITY_STANDARD = 2;
    private final static int PRIORITY_LOW = 3;
    ...
    public final static int HINT_SURFACE = getHintSurface();
    ...
    /**
     * Sets the horizontal alignment for a label.
     *
     * @param id        the id of the label.
     * @param alignment the horizontal alignment for the label.
     */
    public void setHorizontalAlignment(int id, HorizontalAlignment alignment)
    {
        int align;
        switch (alignment)
        {
        ...
        setHorizontalAlignment(pointer, id, align);
    }
     ...
     *
     * @param id        the id of the label.
     * @param alignment the vertical alignment for the label.
     */
    ...
    /**
     * Set the minimum priority level of labels which may be displayed
     */
    public void setPriorityLevel(Priority priority)
    {
        ...
        setPriorityLevel(pointer, pri);
    }

    public Priority getPriorityLevel()
    {
        final int cpriority = getPriorityLevel(pointer);
        switch (cpriority)
        {
    ...
    /**
     * Sets the _float_ weight for a label. This value is a hint to indicate the relative distance
     * along a linestring anchor where a label should be displayed. A value of {@code 0.0f} weights
     * at the start of the linestring, a value of {@code 0.5f} weights at the center of the
     * linestring and a value of {@code 1.0f} weights at the end of the linestring.
     *
     * <P>A label will have a default _float_ weight of {@code 0.5f}.
     *
     * @param id        the id of the label.
     * @param weight    the weight
     */
    public void setFloatWeight(int id, float weight)
    {
        setFloatWeight(pointer, id, weight);
    }
    ...
    /**
     * Sets _level-of-detail_ thresholds for the specified label. The label will be rendered if
     * the current level-of-detail is greater-than-or-equal to the specified minimum and less
     ...
     */
    public void setLevelOfDetail(int id, int minLod, int maxLod) {
        setLevelOfDetail(pointer, id, minLod, maxLod);
    }

    public void setHitTestable(int id, boolean value)
    {
        setHitTestable(pointer, id, value);
    }

    /**
     * Sets the height in meters of the label. This only applies if the {@link GLLabelManager#HINT_SURFACE} hint is set.
     *
     * @param id the label ID
     * @param heightInMeters the height of the label in meters
     */
    public void setHeightInMeters(int id, double heightInMeters)
    {
        setHeightInMeters(pointer, id, heightInMeters);
    }

    public void hitTest(float viewportX, float viewportY, float radius, int limit, @NonNull Collection<Integer> ids)
    {
        hitTest(viewportX, viewportY, radius, null, limit, ids);
    }

    public void hitTest(float viewportX, float viewportY, float radius, @Nullable GeoPoint geoPoint, int limit, @NonNull Collection<Integer> ids)
    {
        Objects.requireNonNull(ids);
        hitTest(pointer, viewportX, viewportY, radius, geoPoint, limit, ids);
    }
    ...
    static native void setHorizontalAlignment(long pointer, int id, int alignment);
    ...
    static native void setPriorityLevel(long pointer, int priority);
    static native int getPriorityLevel(long pointer);

    static native void setHints(long pointer, int id, int hints);
    static native void setFloatWeight(long pointer, int id, float weight);

    static native void setLevelOfDetail(long pointer, int id, int minLod, int maxLod);

    static native void setHitTestable(long pointer, int id, boolean value);

    static native void hitTest(long pointer, float viewportX, float viewportY, float radius, GeoPoint geoPoint, int limit, Collection<Integer> ids);

    static native int getHints(long pointer, int id);

    static native void setHeightInMeters(long pointer, int id, double heightInMeters);
