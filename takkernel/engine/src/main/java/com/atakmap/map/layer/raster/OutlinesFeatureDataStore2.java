...
public class OutlinesFeatureDataStore2 implements FeatureDataStore2, RasterDataStore.OnDataStoreContentChangedListener, Runnable
{
    ...
    {
        dataStore.deleteFeatureSet(fsid);
    }
    ...
    {
        return dataStore.hasTimeReference();
    }

    @Override
    public long getMinimumTimestamp()
    {
        return dataStore.getMinimumTimestamp();
    }

    @Override
    public long getMaximumTimestamp()
    {
        return dataStore.getMaximumTimestamp();
    }
    ...
    {
        return dataStore.getUri();
    }

    @Override
    public boolean hasCache()
    {
        return dataStore.hasCache();
    }
    ...
    {
        return dataStore.supportsExplicitIDs();
    }
    ...
    protected void refreshImpl()
    {
        ...
        params.featureSetFilter.ids = Collections.singleton(this.outlinesFSID);
