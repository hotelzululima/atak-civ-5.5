...
{
    interface OnCameraChangedListener2
    {
    ...
    void addOnCameraChangedListener(OnCameraChangedListener2 l);

    void removeOnCameraChangedListener(OnCameraChangedListener2 l);
