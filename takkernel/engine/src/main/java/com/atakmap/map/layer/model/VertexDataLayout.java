...
public final class VertexDataLayout
{
    ...
    public VertexDataLayout(VertexDataLayout other) {
        attributes = other.attributes;
        interleaved = other.interleaved;
        Array[] from = new Array[] {other.position, other.texCoord0, other.texCoord1, other.texCoord2, other.texCoord3, other.texCoord4, other.texCoord5, other.texCoord5, other.texCoord6, other.texCoord7, other.color, other.normal};
        Array[] to = new Array[] {position, texCoord0, texCoord1, texCoord2, texCoord3, texCoord4, texCoord5, texCoord5, texCoord6, texCoord7, color, normal};
        for(int i = 0; i < from.length; i++) {
            to[i].dataType = from[i].dataType;
    ...
    public static int texCoordAttribute(final int i)
    {
        ...
        {
            case 0:
                return Mesh.VERTEX_ATTR_TEXCOORD_0;
            default:
                return Mesh.VERTEX_ATTR_TEXCOORD_1 << i;
        }
    }
}
