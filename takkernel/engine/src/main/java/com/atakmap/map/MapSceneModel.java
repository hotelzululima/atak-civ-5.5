...
public final class MapSceneModel implements Disposable
{
    ...
    void init()
    {
        ...
        this.camera.up = new PointD(0d, 0d, 0d);
        getCameraUp(this.pointer.raw, this.camera.up);
        ...
        if (this.inverse == null || this.forward == null)
            return;
    ...
    //public PointD up;
    static native void getCameraUp(long pointer, PointD value);
