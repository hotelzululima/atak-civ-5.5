...
public interface GLTerrain
{
     ...
     * values
     *
     * @param vertex The vertex to update the altitude for
     */
     ...
     * value
     *
     * @param vertices The array of the vertices to update the altitudes for
     * @param amount   The amount of the vertices to update
