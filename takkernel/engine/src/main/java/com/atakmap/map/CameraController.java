...
public final class CameraController
{
    ...
    {
        /**
         * Pan the map a given number of pixels. Screen position is interpreted as upper-left origin.
         *
        ...
        {
            CameraController.panBy(MapRenderer_interop.getPointer(renderer), tx, ty, false, marshalCollide(collide), true, animate);
        }
        ...
        {
            CameraController.panBy(MapRenderer_interop.getPointer(renderer), tx, ty, false, marshalCollide(collide), poleSmoothScroll, animate);
        }
         ...
         * @param tx      Horizontal pixels to pan
         * @param ty      Vertical pixels to pan
         * @param origin  The screen origin location
         * @param animate Pan smoothly if true; immediately if false
         */
        public static void panBy(MapRenderer3 renderer, float tx, float ty, IMapRendererEnums.DisplayOrigin origin, MapRenderer3.CameraCollision collide, boolean poleSmoothScroll, boolean animate)
        {
            CameraController.panBy(MapRenderer_interop.getPointer(renderer), tx, ty, (origin == IMapRendererEnums.DisplayOrigin.LowerLeft), marshalCollide(collide), poleSmoothScroll, animate);
        }
        ...
        {
            CameraController.panTo(MapRenderer_interop.getPointer(renderer), focus.getLatitude(), focus.getLongitude(), focus.getAltitude(), x, y, false, marshalCollide(collide), true, animate);
        }
        ...
        {
            CameraController.panTo(MapRenderer_interop.getPointer(renderer), focus.getLatitude(), focus.getLongitude(), focus.getAltitude(), x, y, false, marshalCollide(collide), poleSmoothScroll, animate);
        }
         ...
         * @param animate
         */
        public static void panTo(MapRenderer3 renderer, GeoPoint focus, float x, float y, IMapRendererEnums.DisplayOrigin origin, MapRenderer3.CameraCollision collide, boolean poleSmoothScroll, boolean animate)
        {
            CameraController.panTo(MapRenderer_interop.getPointer(renderer), focus.getLatitude(), focus.getLongitude(), focus.getAltitude(), x, y, (origin == IMapRendererEnums.DisplayOrigin.LowerLeft), marshalCollide(collide), poleSmoothScroll, animate);
        }
    ...
    // Interactive
    static native void panBy(long rendererPtr, float tx, float ty, boolean llOrigin, int collide, boolean panSmoothScroll, boolean animate);

    static native void panTo(long rendererPtr, double focusLat, double focusLng, double focusAlt, float x, float y, boolean llOrigin, int collide, boolean panSmoothScroll, boolean animate);
