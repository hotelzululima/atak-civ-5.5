...
public final class DefaultGeoPackageSchemaHandler3 implements GeoPackageSchemaHandler2
{
    ...
    public DefaultGeoPackageSchemaHandler3(GeoPackage gpkg)
    {
        this.gpkg = gpkg;
    ...
    @Override
    public GeoPackageFeatureCursor queryFeatures(String layerName, FeatureDataStore2.FeatureQueryParameters params)
    {
    ...
    @Override
    public int queryFeaturesCount(String layerName, FeatureDataStore2.FeatureQueryParameters params)
    {
        final Layer layer = this.layers.get(layerName);
        if (layer == null)
            throw new IllegalArgumentException();
    ...
    public static int queryFeaturesCount(GeoPackage gpkg, String tableName, String nameColumn, String geometryColumn, int geometrySrid, String rtreeTableName, FeatureDataStore2.FeatureQueryParameters params)
    {
        if (params == null)
