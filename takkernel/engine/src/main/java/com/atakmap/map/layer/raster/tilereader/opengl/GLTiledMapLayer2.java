...
public class GLTiledMapLayer2 implements GLMapLayer3, GLResolvableMapRenderable, GLMapRenderable2
{
    ...
    protected void init()
    {
        try
        {
            ...
            try {
                String clearCacheOptString = ConfigOptions.getOption("caching-service.debug-start-fresh-enabled", "0");
                if (!clearCacheOptString.equals("0") && readerOpts.cacheUri != null) {
                    FileSystemUtils.delete(new File(readerOpts.cacheUri));
                }
            } catch (Exception ex) {
                Log.d(TAG, "failed to delete cache");
                // ignore debug feature
            }
                                      ...
                                      DatasetProjection2 proj, GeoPoint ulG_R, GeoPoint urG_R, GeoPoint lrG_R, GeoPoint llG_R)
    {
        ...
        return getRasterROI2Impl(retval,
                view,
                view.currentPass.northBound, view.currentPass.westBound,
                view.currentPass.southBound, view.currentPass.eastBound,
                                    ...
                                    DatasetProjection2 proj, GeoPoint ulG_R, GeoPoint urG_R, GeoPoint lrG_R, GeoPoint llG_R, double unwrap, double padding)
    {
        ...
        if (view.currentPass.crossesIDL)
        {
            ...
            if (getRasterROI2Impl(rois[retval],
                    view,
                    view.currentPass.northBound + padding, view.currentPass.westBound - padding,
                    view.currentPass.southBound - padding, 180d,
                    rasterWidth, rasterHeight,
                    proj,
            ...
            if (getRasterROI2Impl(rois[retval],
                    view,
                    view.currentPass.northBound + padding, -180d,
                    view.currentPass.southBound - padding, view.currentPass.eastBound + padding,
                    rasterWidth, rasterHeight,
                    proj,
                    ulG_R, urG_R, lrG_R, llG_R, unwrap))
            {
