...
@DontObfuscate final class NativeLayer implements Layer, Disposable
{
    ...
    @DontObfuscate final static class NativeOnLayerVisibilityChangedListener implements Layer.OnLayerVisibleChangedListener
    {
        final static NativePeerManager.Cleaner CLEANER = new NativePeerManager.Cleaner()
        {
            @Override
