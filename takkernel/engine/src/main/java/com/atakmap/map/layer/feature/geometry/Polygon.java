...
public final class Polygon extends Geometry
{
    ...
    private class InteriorRings implements Collection<LineString>
    {
        ...
        {
            object = Geometry.castGeom(object);
            if (object == null)
                return false;
        ...
        public boolean remove(Object object)
        {
            ...
            // need to remove from cache here. Outside calling code may hold dangling reference
            // causing false positives on calls to "contains". See API Polygon unit tests.
            cache.remove(ring.pointer);
