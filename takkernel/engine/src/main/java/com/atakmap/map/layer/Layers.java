...
import com.atakmap.map.formats.quantizedmesh.QMEChunkSpi;
import com.atakmap.map.layer.feature.opengl.GLBatchGeometryFeatureDataStoreRenderer;
import com.atakmap.map.layer.feature.vectortiles.GLVectorTiles;
...
import com.atakmap.map.layer.raster.mbtiles.MBTilesContainer;
...
import com.atakmap.map.layer.raster.mobileimagery.GLMobileImageryRasterLayer3;
import com.atakmap.map.layer.raster.nativeimagery.GLNativeImageryRasterLayer2;
import com.atakmap.map.layer.raster.opengl.GLDatasetRasterLayer3;
...
public final class Layers
{
    ...
    public synchronized static void registerAll()
    {
        ...
        GLLayerFactory.register(GLDatasetRasterLayer3.SPI);
        GLLayerFactory.register(GLNativeImageryRasterLayer2.SPI);
        GLLayerFactory.register(GLMobileImageryRasterLayer3.SPI);
        ...
        GLMapLayerFactory.registerSpi(GLVectorTiles.SPI);
        ...
        TileContainerFactory.registerSpi(MBTilesContainer.SPI);

        ElevationChunk.Factory.regsiterSpi(new TerrainRGBChunkSpi(), 1);
        ElevationChunk.Factory.regsiterSpi(new QMEChunkSpi(), 1);
        DatasetDescriptorFactory2.register(StreamingContentDatasetDescriptorSpi.INSTANCE);
