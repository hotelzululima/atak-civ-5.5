...
public final class GLBaseMap implements GLMapRenderable, GLMapRenderable2
{
    ...
    {
        if (this.impl == null || this.implSrid != view.currentPass.drawSrid)
        {
            if (!this.srcInit)
            {
            ...
            {
                this.impl = createRenderer(view.getRenderContext(), view.currentPass.scene.mapProjection);
                this.implSrid = view.currentPass.scene.mapProjection.getSpatialReferenceID();
            }
        }
