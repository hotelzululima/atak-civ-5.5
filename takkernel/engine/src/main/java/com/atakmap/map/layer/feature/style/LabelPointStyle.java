...
public final class LabelPointStyle extends Style
{
    ...
    /**
     * Creates a new label style with the specified properties.
     *
     * @param text             The label text
     * @param textColor        The text color
     * @param bgColor          The background color for the text (0 for no background)
    ...
    {
        this(text, textColor, bgColor, mode, textSize, 0, 0, alignX, alignY, rotation, rotationAbsolute, minRenderResolution, scale);
    }
     ...
     *                            textSize is not honored and it will always be the default
     *                            value.
     * @param offsetX             The horizontal offset for the label in pixels
     * @param offsetY             The vertical offset for the label in pixels
     * @param alignX              The horizontal alignment of the label. Less than
     *                            <code>0</code> for to the left, <code>0</code>
     *                            for horizontally centered, greater than
     *                            <code>0</code> for to the right
     ...
     * @param scale               The scale to be applied to the label. 1.0f is unscaled
     */
    public LabelPointStyle(String text, int textColor, int bgColor, ScrollMode mode, float textSize, float offsetX, float offsetY, int alignX, int alignY, float rotation, boolean rotationAbsolute, double minRenderResolution, float scale)
    {
        this(text, textColor, bgColor, mode, null, textSize, EnumSet.noneOf(Style.class), offsetX, offsetY, alignX, alignY, rotation, rotationAbsolute, minRenderResolution, scale);
    }
     ...
     * @param bgColor             The background color for the text (0 for no background)
     * @param mode                The auto-scrolling mode to use for the label
     * @param fontFace            The font face name, or null for the default font.
     * @param textSize            The text size (in points). A value of 0.0f indicates that
     *                            the default system setting should be used.   At this time
     *                            textSize is not honored and it will always be the default
     *                            value.
     ...
     * @param scale               The scale to be applied to the label. 1.0f is unscaled
     */
    public LabelPointStyle(String text, int textColor, int bgColor, ScrollMode mode, String fontFace, float textSize, EnumSet<Style> fontStyle, float offsetX, float offsetY, int alignX, int alignY, float rotation, boolean rotationAbsolute, double minRenderResolution, float scale)
    {
     ...
     * label is multiplied by the returned color; a value of
     * <code>0xFFFFFFFF</code> should be used to render the label using its
     * original color.
     *
     ...
     * the rotation value.
     *
     * @return The rotation of the label, in radians counter-clockwise.
    ...
    /**
     * Returns the vertical offset to be applied to the rendering of the label.
     *
     * @return The vertical offset for the label with respect to the point in pixels
     */
    ...
    /**
     * Returns the horizontal offset to be applied to the rendering of the label.
     *
     * @return The horizontal offset for the label with respect to the point in pixels
     */
    ...
    /**
     * Returns the font face name for the label.
     *
    ...
    /**
     * Returns the set of style flags for the label.
     *
