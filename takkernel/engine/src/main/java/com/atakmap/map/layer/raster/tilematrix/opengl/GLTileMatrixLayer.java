...
public class GLTileMatrixLayer implements GLMapLayer3
{
    ...
    private void init(GLMapView view)
    {
        ...
        this.core.scaleControl = view.getControl(ImageryRelativeScaleControl.class);
    }
...
*/
        ...
        final double fudge = 1.667d * 2d;
        final double relativeScaling = (this.core.scaleControl != null) ?
                this.core.scaleControl.getRelativeScale() :
                1d;
        final double selectRes = view.currentPass.drawMapResolution * fudge * relativeScaling;
