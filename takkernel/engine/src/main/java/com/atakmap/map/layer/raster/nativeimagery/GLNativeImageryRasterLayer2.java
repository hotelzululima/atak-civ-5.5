...
/** @deprecated class implementation will be removed; continue to use {@link #SPI} */
@Deprecated
@DeprecatedApi(since = "5.3", forRemoval = true, removeAt = "5.6")
@ModifierApi(since = "5.3", modifiers = {"final"}, target = "5.6")
    ...
    public final static GLLayerSpi2 SPI = new GLLayerSpi2()
    {
        ...
        public GLLayer2 create(Pair<MapRenderer, Layer> object)
        {
            if (!(object.second instanceof NativeImageryRasterLayer2))
                return null;
            return new GLNativeImageryRasterLayer3(object.first, (NativeImageryRasterLayer2) object.second);
        }
