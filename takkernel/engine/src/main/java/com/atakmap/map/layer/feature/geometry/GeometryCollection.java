...
public final class GeometryCollection extends Geometry
{
    ...
    private class Children implements Collection<Geometry>
    {
        ...
        {
            final Geometry g = Geometry.castGeom(object);
            if (g == null)
                return false;
        ...
        public boolean remove(Object object)
        {
            ...
            // Need to remove from cache here because dangling pointer refs are possible with
            // outside calling code. This causes false positives on contains. See API GC unit tests.
            cache.remove(g.pointer);
