...
/** @deprecated use {@link GeoPackageFeatureDataStore2 */
@Deprecated
        ...
        extends AbstractFeatureDataStore2
{
    ...
    public GeoPackageFeatureDataStore(File dbFile)
    {
    ...
    public final GeoPackageSchemaHandler
    getSchemaHandler()
    {
    ...
    // no restrictions.
    //
    private FeatureQueryParameters
