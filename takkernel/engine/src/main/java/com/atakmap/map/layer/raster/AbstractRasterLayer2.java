...
public abstract class AbstractRasterLayer2 extends AbstractLayer implements RasterLayer2
{
    ...
    private LayerAttributesImpl layerAttributesImpl;
    ...
    protected AbstractRasterLayer2(String name)
    {
        ...
        this.layerAttributesImpl = new LayerAttributesImpl();

        this.registerExtension(this.selectionOptionsImpl);
        this.registerExtension(this.layerAttributesImpl);
    }
    ...
    final class LayerAttributesImpl implements LayerAttributeExtension
    {
        final Map<String, Object> _attributes = new ConcurrentHashMap<>();
