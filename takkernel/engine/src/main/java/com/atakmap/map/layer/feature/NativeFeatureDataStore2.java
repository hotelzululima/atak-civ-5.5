...
public class NativeFeatureDataStore2 implements FeatureDataStore2
{
    ...
    NativeFeatureDataStore2(Pointer pointer, Object owner)
    {
    ...
    {
        // XXX - shouldn't need this level of convolution
        if((managed instanceof Adapters.FeatureDataStoreAdapter) && (((Adapters.FeatureDataStoreAdapter)managed).impl instanceof PersistentDataSourceFeatureDataStore2))
            managed = ((PersistentDataSourceFeatureDataStore2)((Adapters.FeatureDataStoreAdapter)managed).impl).impl;
    ...
    {
        return new NativeFeatureDataStore2(pointer, ownerRef);
    }

    static native Pointer wrap(FeatureDataStore2 object);
    static boolean hasPointer(FeatureDataStore2 object) {
        return (object instanceof NativeFeatureDataStore2);
    }
