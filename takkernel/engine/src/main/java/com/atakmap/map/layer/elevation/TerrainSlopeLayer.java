...
public final class TerrainSlopeLayer implements Layer2
{
    ...
    static
    {
        ...
        NativeControlFactory.registerSpi(GradientControl.class, new NativeControlFactory.Spi<GradientControl>() {
            @Override
            public GradientControl createNativeControl(Pointer pointer, Object owner) {
    ...
    {
        if (clazz.equals(LayerImplExtension.class))
            return (T) new LayerImplExtension(impl);
        return null;
    }
