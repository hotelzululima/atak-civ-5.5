...
public class GLTilePatch implements GLMapRenderable2, GLMapBatchable2
{
    ...
    public void batch(GLMapView view, GLRenderBatch2 batch, int renderPass)
    {
        ...
        final double isectMinLat = Math.max(patchMinLat, view.currentPass.southBound);
        final double isectMinLng = Math.max(patchMinLng, view.currentPass.westBound);
        final double isectMaxLat = Math.min(patchMinLat, view.currentPass.northBound);
        final double isectMaxLng = Math.min(patchMinLng, view.currentPass.eastBound);
    ...
    public void draw(GLMapView view, int renderPass)
    {
        ...
        final double isectMinLat = Math.max(patchMinLat, view.currentPass.southBound);
        final double isectMinLng = Math.max(patchMinLng, view.currentPass.westBound);
        final double isectMaxLat = Math.min(patchMaxLat, view.currentPass.northBound);
        final double isectMaxLng = Math.min(patchMaxLng, view.currentPass.eastBound);
