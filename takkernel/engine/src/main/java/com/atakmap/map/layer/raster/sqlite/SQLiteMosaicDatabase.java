...
public abstract class SQLiteMosaicDatabase implements MosaicDatabase2
{
    ...
    protected static class TileTableSpec
    {
         ...
         *
         * <P>NOTE: the table name is double-quote escaped as an implementation
         * detail of the {@code TileTableSpec} constructor
         */
        ...
        /**
         *
         * @param tableName The tile table name (unescaped)
         * @param srid
         * @param origin
         */
