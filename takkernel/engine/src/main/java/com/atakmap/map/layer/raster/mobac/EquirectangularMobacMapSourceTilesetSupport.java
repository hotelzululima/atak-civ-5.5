...
class EquirectangularMobacMapSourceTilesetSupport extends EquirectangularTilesetSupport implements
        OnlineTilesetSupport
{

    private final MobacMapSourceTilesetSupport impl;

    EquirectangularMobacMapSourceTilesetSupport(TilesetInfo tsInfo, GLBitmapLoader bitmapLoader,
