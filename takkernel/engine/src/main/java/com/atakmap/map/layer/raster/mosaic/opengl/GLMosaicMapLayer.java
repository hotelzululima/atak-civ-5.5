...
/** @deprecated use {@link GLMosaicMapLayer2} */
@Deprecated
        ...
        GLAsynchronousMapRenderable<MosaicPendingData> implements GLMapLayer3
{
    ...
    protected boolean updateRenderableReleaseLists(MosaicPendingData pendingData)
    {
        ...
        Map<MosaicDatabase2.Frame, GLResolvableMapRenderable> toRelease = this.visibleFrames;
        final String st = this.selectedType;
        if(st != null) {
            // compare biased on _selected type_, then based on GSD and type
            this.visibleFrames = new ConcurrentSkipListMap<>( new Comparator<MosaicDatabase2.Frame>() {
                public int compare(MosaicDatabase2.Frame a, MosaicDatabase2.Frame b) {
    ...
    final class LockOnTypeControl implements MapControl, RasterLayer2.OnSelectionChangedListener {
        ...
        public void onSelectionChanged(RasterLayer2 layer) {
            GLMosaicMapLayer.this.selectedType = layer.isAutoSelect() ? null : layer.getSelection();
        }
    }
}
