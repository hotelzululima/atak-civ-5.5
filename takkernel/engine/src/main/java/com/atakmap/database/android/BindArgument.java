...
final class BindArgument
{
    ...
    {
        this.setImpl((val != null) ? CursorIface.FIELD_TYPE_STRING
                : CursorIface.FIELD_TYPE_NULL, val);
    }

    public void set(byte[] val)
    {
        this.setImpl((val != null) ? CursorIface.FIELD_TYPE_BLOB
                : CursorIface.FIELD_TYPE_NULL, val);
    }
     ...
     */
    public static CursorIface query(DatabaseIface database, CharSequence sql,
                                    BindArgument[] args)
    {
