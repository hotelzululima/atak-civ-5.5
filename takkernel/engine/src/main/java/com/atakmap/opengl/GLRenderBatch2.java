...
public final class GLRenderBatch2
{
     ...
     *                  <UL>
     *                  <LI>{@link gov.tak.platform.commons.opengl.GLES30#GL_LINES GLES30.GL_LINES}</LI>
     *                  <LI>{@link gov.tak.platform.commons.opengl.GLES30#GL_LINE_STRIP GLES30.GL_LINE_STRIP}</LI>
     *                  <LI>{@link gov.tak.platform.commons.opengl.GLES30#GL_LINE_LOOP GLES30.GL_LINE_LOOP}</LI>
     *                  <LI>{@link gov.tak.platform.commons.opengl.GLES30#GL_TRIANGLES GLES30.GL_TRIANGLES}</LI>
     *                  <LI>{@link gov.tak.platform.commons.opengl.GLES30#GL_TRIANGLE_STRIP GLES30.GL_TRIANGLE_STRIP}</LI>
     *                  <LI>{@link gov.tak.platform.commons.opengl.GLES30#GL_TRIANGLE_FAN GLES30.GL_TRIANGLE_FAN}</LI>
     *                  </UL>
