...
public interface RenderContext<RenderSurfaceImpl extends RenderSurface>
{
     ...
     *
     * @param context the context to set or null
     */
    static void setCurrent(RenderContext<?> context)
    {
        CurrentRenderContext.setCurrent(context);
    }

    /**
     * Get the currently set render context
     *
     * @return RenderContext instance or null
     */
    static RenderContext<?> getCurrent()
    {
        return CurrentRenderContext.getCurrent();
    }
}
