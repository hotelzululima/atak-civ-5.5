...
@DontObfuscate
public final class GeoPoint implements IGeoPoint
{
    ...
    static
    {
        MarshalManager.registerMarshal(new IMarshal()
        {
            ...
            public <T, V> T marshal(V in)
            {
                ...
                {
                    case AGL:
                        return (T) IGeoPoint.AltitudeReference.AGL;
                    case HAE:
                        return (T) IGeoPoint.AltitudeReference.HAE;
                    default:
                        return null;
                }
            }
        }, com.atakmap.coremap.maps.coords.GeoPoint.AltitudeReference.class, IGeoPoint.AltitudeReference.class);
        MarshalManager.registerMarshal(new IMarshal()
        {
            @Override
            public <T, V> T marshal(V in)
            {
                if (in == null)
                    return null;
                switch ((IGeoPoint.AltitudeReference) in)
                {
                    case AGL:
                        return (T) com.atakmap.coremap.maps.coords.GeoPoint.AltitudeReference.AGL;
                    case HAE:
                        return (T) com.atakmap.coremap.maps.coords.GeoPoint.AltitudeReference.HAE;
                    default:
                        return null;
                }
            }
        }, IGeoPoint.AltitudeReference.class, com.atakmap.coremap.maps.coords.GeoPoint.AltitudeReference.class);
        MarshalManager.registerMarshal(new IMarshal()
        {
            @Override
            public <T, V> T marshal(V in)
            {
                ...
                return (T) new gov.tak.api.engine.map.coords.GeoPoint(src);
            }
        ...
        MarshalManager.registerMarshal(new IMarshal()
        {
            ...
            public <T, V> T marshal(V in)
            {
                if (in == null)
                    return null;
                final IGeoPoint src = (IGeoPoint) in;
                return (T) new com.atakmap.coremap.maps.coords.GeoPoint(src);
            }
        ...
        }, com.atakmap.coremap.maps.coords.GeoPoint.class, IGeoPoint.class);
        MarshalManager.registerMarshal(new IMarshal()
        {
            @Override
            public <T, V> T marshal(V in)
        ...
        }, IGeoPoint.class, com.atakmap.coremap.maps.coords.GeoPoint.class);
    }
    ...
    @DeprecatedApi(since = "5.1", forRemoval = true, removeAt = "5.4")
    public static final double MAX_ACCEPTABLE_ALTITUDE = 76000;
    ...
    public GeoPoint(final double latitude,
                    ...
                    final IGeoPoint.AltitudeReference altitudeReference,
                    final double ce90,
                    final double le90,
                    ...
                    final double le90)
    {
        ...
        this(latitude, longitude, altitude, IGeoPoint.AltitudeReference.HAE,
    ...
    {
        this(latitude, longitude, UNKNOWN, IGeoPoint.AltitudeReference.HAE,
    ...
    private GeoPoint()
    {
        ...
        latitude = Double.NaN;
        altitude = UNKNOWN;
        altitudeReference = IGeoPoint.AltitudeReference.HAE;
        ce90 = UNKNOWN;
        le90 = UNKNOWN;
    ...
    /**
     * Copy constructor for a {@link IGeoPoint}
     *
     * @param other the {@link IGeoPoint} to copy.
     * @since 6.0.0
     */
    public GeoPoint(IGeoPoint other)
    {
        this(other.getLatitude(), other.getLongitude(), other.getAltitude(),
                other.getAltitudeReference(), other.getCE(), other.getLE());
    }

    GeoPoint(com.atakmap.coremap.maps.coords.GeoPoint other)
    {
        this(other.getLatitude(), other.getLongitude(), other.getAltitude(),
                MarshalManager.marshal(
                        other.getAltitudeReference(),
                        com.atakmap.coremap.maps.coords.GeoPoint.AltitudeReference.class,
                        IGeoPoint.AltitudeReference.class
                ),
                other.getCE(), other.getLE(),
                other.isMutable() ? Access.READ_WRITE : Access.READ_ONLY);
    }
