...
namespace TAK {
    namespace Engine {
        namespace Renderer {
            ...
            class ENGINE_API BitmapFactory2
            {
            protected :
                virtual ~BitmapFactory2() NOTHROWS = 0;
            public :
                virtual Util::TAKErr decode(BitmapPtr &result, const char *bitmapFilePath, const BitmapDecodeOptions *opts) NOTHROWS = 0;
            };
