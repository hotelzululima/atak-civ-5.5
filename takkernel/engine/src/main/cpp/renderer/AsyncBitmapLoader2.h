    ...
    namespace Engine
    {
        ...
        namespace Renderer
        {
            ...
            public :
                ...
                Util::TAKErr addBitmapFactory(const char *scheme, const std::shared_ptr<BitmapFactory2> &handler, const char *queueHint = nullptr) NOTHROWS;
                Util::TAKErr removeBitmapFactory(const BitmapFactory2 &handler) NOTHROWS;
            public :
            ...
            private :
                ...
                struct {
                    ...
                    std::map<std::string, std::shared_ptr<BitmapFactory2>> value;
                    std::map<std::string, std::string> schemeHints;
                } handlers;
            };
