...
namespace TAK {
    namespace Engine {
        namespace Renderer {
            ...
            public :
                Util::TAKErr subimage(std::unique_ptr<Bitmap2, void(*)(const Bitmap2 *)> &value, const std::size_t x, const std::size_t y, const std::size_t width, const std::size_t h, const bool share = false) const NOTHROWS;
                /**
                ...
                Util::TAKErr setPixel(const std::size_t x, const std::size_t y, const uint32_t argb) NOTHROWS;
            public :
                ...
                Util::TAKErr getPixel(uint32_t *value, const std::size_t x, const std::size_t y) const NOTHROWS;
            public :
