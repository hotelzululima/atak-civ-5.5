        ...
        namespace Renderer {
            ...
            public :
                struct TileIndex
                {
                    ...
                    TileIndex() NOTHROWS;
                    TileIndex(const std::size_t level, const std::size_t column, const std::size_t row) NOTHROWS;
                };
            private :
            ...
            public :
                ...
                /**
                 * Returns the nominal tile size
                 * @return  The tile size
                 */
                std::size_t getTileSize() const NOTHROWS;
                std::size_t getTileSize(const TileIndex &idx) const NOTHROWS;
                Util::TAKErr getTileSize(std::size_t *width, std::size_t *height, const TileIndex &idx) const NOTHROWS;
                ...
                Util::TAKErr bindTile(const TileIndex &tile, const std::size_t width, const std::size_t height) NOTHROWS;
                /**
