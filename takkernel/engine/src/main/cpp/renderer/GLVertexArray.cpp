...
void TAK::Engine::Renderer::glVertexAttribIPointer(GLuint index, const GLVertexArray& layout) NOTHROWS
{
    ::glVertexAttribIPointer(index, layout.size, layout.type, layout.stride, (const void*)((const unsigned char *)nullptr + layout.offset));
}
