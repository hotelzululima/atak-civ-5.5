        ...
        namespace Renderer {
            ...
            public :
                Util::TAKErr batch(const int texId,
                                   ...
                                   const float b,
                                   const float a,
                                   const float outlineR = 0.f,
                                   const float outlineG = 0.f,
                                   const float outlineB = 0.f,
                                   const float outlineA = 0.f) NOTHROWS;
                Util::TAKErr batch(const int texId,
                                   const int mode,
                                   const std::size_t count,
                                   const std::size_t size,
            ...
            private :
                ...
                Util::TAKErr addTrianglesSprite(const std::size_t size, const std::size_t vertexStride, const float *vertexCoords, const std::size_t count,
                    ...
                    const int textureId, const float r, const float g, const float b, const float a,
            ...
            private :
                ...
                Util::TAKErr addLinesImpl(const std::size_t size, const float width, const std::size_t numLines, const std::size_t vStride, const float *lines, const int step, const uint8_t vertexConst[12]) NOTHROWS;
                Util::TAKErr addTrianglesImpl(const std::size_t size, const std::size_t vStride, const float *vertexCoords, const std::size_t count, const std::size_t tcStride, const float *texCoords, int texUnitIdx, const float r, const float g, const float b, const float a,
                  const float outlineR, const float outlineG, const float outlineB, const float outlineA) NOTHROWS;
                Util::TAKErr addIndexedTrianglesImpl(const std::size_t size, const std::size_t vStride, const float *vertexCoords, const std::size_t count, const unsigned short *indices, const std::size_t indexCount, const std::size_t tcStride, const float *texCoords, int texUnitIdx, const float r, const float g, const float b, const float a,
                  const float outlineR, const float outlineG, const float outlineB, const float outlineA) NOTHROWS;
                Util::TAKErr addTriangleStripImpl(const std::size_t size, const std::size_t vStride, const float *vertexCoords, const std::size_t count, const std::size_t tcStride, const float *texCoords, int texUnitIdx, const float r, const float g, const float b, const float a,
                  const float outlineR, const float outlineG, const float outlineB, const float outlineA) NOTHROWS;
                Util::TAKErr addIndexedTriangleStripImpl(const std::size_t size, const std::size_t vStride, const float *vertexCoords, const std::size_t count, const unsigned short *indices, const std::size_t indexCount, const std::size_t tcStride, const float *texCoords, int texUnitIdx, const float r, const float g, const float b, const float a,
                  const float outlineR, const float outlineG, const float outlineB, const float outlineA) NOTHROWS;
                Util::TAKErr addTriangleFanImpl(const std::size_t size, const std::size_t vStride, const float *vertexCoords, const std::size_t count, const std::size_t tcStride, const float *texCoords, int texUnitIdx, const float r, const float g, const float b, const float a,
                  const float outlineR, const float outlineG, const float outlineB, const float outlineA) NOTHROWS;
