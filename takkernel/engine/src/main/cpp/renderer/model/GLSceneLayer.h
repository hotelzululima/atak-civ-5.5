        ...
        namespace Renderer {
            namespace Model {
                ...
                public: // FeatureHitTestControl
                    virtual TAK::Engine::Util::TAKErr hitTest(Port::Collection<int64_t> &fids, float screenX, float screenY, const TAK::Engine::Core::GeoPoint2 &point, double resolution, float radius, int limit) NOTHROWS override;
                public :
                    virtual Util::TAKErr getSceneObjectControl(SceneObjectControl **ctrl, const int64_t sid) NOTHROWS override;
                public:
                    virtual Util::TAKErr getSceneControl(void **ctrl, const char *type, const int64_t sid) NOTHROWS override;
                private:
                ...
                public : // SceneLayer::ContentChangedListener
                    Util::TAKErr contentChanged(const TAK::Engine::Model::SceneLayer &layer) NOTHROWS override;
                public : // GLLayer2
                    TAK::Engine::Core::Layer2 &getSubject() NOTHROWS;
                // GLAsynchronousMapRenderable2
                protected :
                    Util::TAKErr createQueryContext(Core::GLAsynchronousMapRenderable3::QueryContextPtr &value) NOTHROWS override;
                    Util::TAKErr resetQueryContext(Core::GLAsynchronousMapRenderable3::QueryContext &pendingData) NOTHROWS override;
                private:
                    Util::TAKErr getRenderables(Port::Collection<Core::GLMapRenderable2 *>::IteratorPtr &iter) NOTHROWS override;
                protected :
                    Util::TAKErr updateRenderableLists(Core::GLAsynchronousMapRenderable3::QueryContext &pendingData) NOTHROWS override;
                    Util::TAKErr query(Core::GLAsynchronousMapRenderable3::QueryContext &result, const Core::GLMapView2::State &state)  NOTHROWS override;
