    ...
    namespace Engine {
        namespace Renderer {
            ...
            namespace Model {
                ...
                public: // HitTestControl
                    virtual TAK::Engine::Util::TAKErr hitTest(TAK::Engine::Core::GeoPoint2* result, const TAK::Engine::Core::MapSceneModel2& sceneModel, const float screenX, const float screenY) NOTHROWS override;
                public: // GLDepthSamplerDrawable
                    virtual Util::TAKErr gatherDepthSamplerDrawables(std::vector<GLDepthSamplerDrawable*>& result, int levelDepth, const TAK::Engine::Core::MapSceneModel2& sceneModel, float x, float y) NOTHROWS override;
                    virtual void depthSamplerDraw(GLDepthSampler& sampler, const TAK::Engine::Core::MapSceneModel2& sceneModel) NOTHROWS override;
                private:
