            ...
            namespace Core {
                ...
                public :
                    struct ENGINE_API State
                    {
                        ...
                        float relativeSurfaceScale {1.f};
                        ...
                        struct {
                            ...
                            void own() NOTHROWS
                            {
                                ...
                                if (value == state->renderTilesData.data())
                                    return;
                                state->renderTilesData.clear();
                                state->renderTilesData.reserve(count);
                                for (std::size_t i = 0u; i < count; i++)
                                    state->renderTilesData.push_back(value[i]);
                                value = state->renderTilesData.data();
                            }
                        private :
                            State* state{ nullptr };
                            friend struct GLGlobeBase::State;
                        } renderTiles;
                    ...
                    private :
                        ...
                        std::vector<Elevation::GLTerrainTile> renderTilesData;
                ...
                protected :
                    struct TargetView
                    {
                        ...
                        TAK::Engine::Core::MapRenderer3::CameraCollision collide { TAK::Engine::Core::MapRenderer3::Ignore };
                    };
                public:
                    /**
                    ...
                    enum RenderPass
                    {
                        ...
                        Scenes = 0x0008,
                        XRay = 0x0010,
                        SurfacePrefetch = 0x0020,
                        //! @deprecated use SurfacePrefetch
                        Surface2 = SurfacePrefetch,
                    };
                private :
                ...
                public :
                    ...
                    void setStarsLayer(std::unique_ptr<GLMapRenderable2, void(*)(const GLMapRenderable2 *)> &&map) NOTHROWS;
                ...
                public: // camera control
                    virtual Util::TAKErr lookAt(const TAK::Engine::Core::GeoPoint2 &from, const TAK::Engine::Core::GeoPoint2 &at, const TAK::Engine::Core::MapRenderer::CameraCollision collision, const bool animate) NOTHROWS override;
                    ...
                    virtual Util::TAKErr lookFrom(const TAK::Engine::Core::GeoPoint2 &from, const double azimuth, const double elevation, const TAK::Engine::Core::MapRenderer::CameraCollision collision, const bool animate) NOTHROWS override;
                ...
                public :
                    virtual Util::TAKErr setDisplayMode(const TAK::Engine::Core::MapRenderer::DisplayMode mode) NOTHROWS override;
                    ...
                    virtual Util::TAKErr setFocusPoint(const float focusx, const float focusy) NOTHROWS override;
                    /** focus point defined relative to display origin */
                    virtual Util::TAKErr setFocusPointOffset(const float offsetX, const float offsetY) NOTHROWS;
                    /** focus point defined relative to display origin */
                    virtual Util::TAKErr getFocusPoint(float *focusx, float *focusy) const NOTHROWS override;
                    /** focus point defined relative to display origin */
                    virtual Util::TAKErr getFocusPointOffset(float *offsetX, float *offsetY) const NOTHROWS;
                    virtual Util::TAKErr setSurfaceSize(const std::size_t width, const std::size_t height) NOTHROWS override;
                    virtual Util::TAKErr getSurfaceSize(std::size_t *width, std::size_t *height) const NOTHROWS;
                    virtual Util::TAKErr inverse(TAK::Engine::Core::MapRenderer::InverseResult *result, TAK::Engine::Core::GeoPoint2 *value, const TAK::Engine::Core::MapRenderer::InverseMode mode, const unsigned int hints, const Math::Point2<double> &screen, const TAK::Engine::Core::MapRenderer::DisplayOrigin) NOTHROWS override = 0;
                    virtual Util::TAKErr getMapSceneModel(TAK::Engine::Core::MapSceneModel2 *value, const bool instant, const DisplayOrigin origin) const NOTHROWS override;
                ...
                protected :
                    ...
                    std::unique_ptr<GLMapRenderable2, void(*)(const GLMapRenderable2 *)> starsLayer;
                private :
                ...
                private : // controls
                    struct {
                        Thread::Mutex mutex {Thread::TEMT_Recursive};
                    ...
                    std::unique_ptr<Controls::ClampToGroundControl, void(*)(const Controls::ClampToGroundControl*)> clampToGroundControl;
