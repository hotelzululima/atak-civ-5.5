        ...
        namespace Renderer {
            namespace Core {
                ...
                protected :
                    ...
                    virtual void interruptQuery(QueryContext &context, const bool release) NOTHROWS;
                ...
                protected :
                    ...
                    /** If `true` the `GlobeBase::State::renderTiles` passed to `query` will be populated */
                    bool need_render_tiles_;
                    TAK::Engine::Thread::Monitor monitor_;
                    TAK::Engine::Thread::RWMutex renderables_mutex_;
                    bool check_surface_intersect_;
                };
