        ...
        namespace Renderer {
            namespace Core {
                ...
                public: // public interface
                    ...
                    virtual Util::TAKErr registerControl(const Engine::Core::Layer2 &layer, const char *type, void *ctrl) NOTHROWS override;
                    virtual Util::TAKErr unregisterControl(const Engine::Core::Layer2 &layer, const char *type, void *ctrl) NOTHROWS override;
                ...
                private :
                    ...
                    TAK::Engine::Util::TAKErr intersectWithSurfaceMeshImpl(TAK::Engine::Core::GeoPoint2 *value, const TAK::Engine::Core::MapSceneModel2 &map_scene, const float x, const float y) NOTHROWS;
                    Util::TAKErr getTerrainMeshElevation(double *value, const double latitude, const double longitude, const bool visibleOnly) const NOTHROWS;
                    static  Util::TAKErr handleCollision(TAK::Engine::Core::GeoPoint2 *cam, TAK::Engine::Core::GeoPoint2 *focus, double *resolution, double *tilt, const GLGlobe &view, const TAK::Engine::Core::MapSceneModel2 &sm, const double collideRadius, const TAK::Engine::Core::MapRenderer::CameraCollision collision) NOTHROWS;
                ...
                public :
                    ...
                    void setStarsEnabled(const bool enabled) NOTHROWS;
                    bool isStarsEnabled() const NOTHROWS;
                protected :
                ...
                private:
                    struct
                    {
                        GLuint whitePixelTexId = GL_NONE;
                    ...
                    std::unique_ptr<Controls::ElevationSourceControl, void(*)(const Controls::ElevationSourceControl *)> elevationSource;
                    struct {
                        Thread::Mutex mutex {Thread::TEMT_Recursive};
                        std::set<TAK::Engine::Renderer::Model::HitTestControl *> value;
                    } hitTestControls;
                ...
                private :
                    ...
                    friend Util::TAKErr ENGINE_API GLGlobe_lookAt(GLGlobe&, const TAK::Engine::Core::GeoPoint2 &, const double, const double, const double, const double, const TAK::Engine::Core::MapRenderer::CameraCollision, const bool) NOTHROWS;
                    friend Util::TAKErr ENGINE_API GLGlobe_lookFrom(GLGlobe&, const TAK::Engine::Core::GeoPoint2 &, const double, const double, const double, const TAK::Engine::Core::MapRenderer::CameraCollision, const bool) NOTHROWS;
                };
