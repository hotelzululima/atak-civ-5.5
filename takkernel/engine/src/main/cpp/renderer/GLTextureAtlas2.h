    ...
    namespace Engine {
        namespace Renderer {
            ...
            public :
                ...
                Util::TAKErr getImageRect(Math::Rectangle2<float> *value, const int64_t key) const NOTHROWS;
                Util::TAKErr getImageRect(atakmap::math::Rectangle<float> *value, const int64_t key, const bool normalized) const NOTHROWS;
                Util::TAKErr getImageRect(Math::Rectangle2<float> *value, const int64_t key, const bool normalized) const NOTHROWS;
            ...
            private:
                ...
                friend Util::TAKErr GLTextureAtlas_create(std::unique_ptr<GLTextureAtlas2, void(*)(const GLTextureAtlas2 *)> &, const Bitmap2 &, const char **, const TAK::Engine::Math::Rectangle2<float> *, const std::size_t) NOTHROWS;
            };

            Util::TAKErr GLTextureAtlas_create(std::unique_ptr<GLTextureAtlas2, void(*)(const GLTextureAtlas2 *)> &value, const Bitmap2 &spriteSheet, const char **uris, const TAK::Engine::Math::Rectangle2<float> *regions, const std::size_t numEntries) NOTHROWS;
