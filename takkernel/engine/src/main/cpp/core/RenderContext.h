...
namespace TAK {
    namespace Engine {
        namespace Core {
            ...
            /**
             * Set the current RenderContext instance pointer for the current thread
             */
            Util::TAKErr ENGINE_API RenderContext_setCurrent(RenderContext* renderContext) NOTHROWS;

            /**
             * Get the current RenderContext instance pointer for the current thread
             */
            Util::TAKErr ENGINE_API RenderContext_getCurrent(RenderContext** renderContextPtr) NOTHROWS;
        }
    }
}
