...
namespace {
    bool setDefaultConfigOptions() NOTHROWS
    {
        CPLSetConfigOption("LIBKML_RESOLVE_STYLE", "yes");
        CPLSetConfigOption("LIBKML_UNIQUE_LAYER_NAMES", "no");
        return true;
    }
}
...
{
    static bool clinit = setDefaultConfigOptions();
}
