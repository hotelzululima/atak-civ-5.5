        ...
        namespace Formats {
            namespace OGR {
                ...
                public :
                    ...
                    public :
                        Options() NOTHROWS;
                        Options(const Options &other) NOTHROWS;
                    public :
                        Options &operator=(const Options &other) NOTHROWS;
                    public :
                        /** the working dir */
                        TAK::Engine::Port::String workingDir;
                        /** `true` for asynchronous refresh (including on construct) */
                        bool asyncRefresh {true};
                        /** if non-`null`, specifies the driver to open the dataset */
                        TAK::Engine::Port::String driver;
                        /** If value, specifies the SRID that should override any layer SRID */
                        int srid {-1};
                        /** The schema handler */
                        std::shared_ptr<SchemaHandler> schema;
                        TAK::Engine::Port::String extrudeHeightField;
                        TAK::Engine::Port::String extrudeBaseHeightField;
                        /** The open options passed to the driver */
                        struct {
                    ...
                    private :
                        ...
                        friend class OGRFeatureDataStore;
                    };
                private :
                ...
                public :
                    ...
                    OGRFeatureDataStore(const char* uri, const Options &opts) NOTHROWS;
                public :
