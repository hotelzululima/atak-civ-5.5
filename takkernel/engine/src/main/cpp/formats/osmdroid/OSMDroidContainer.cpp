...
namespace
{
    ...
    Envelope2 bounds3395() NOTHROWS {
        static const Envelope2 b3395 = getMatrixBounds(3395);
        return b3395;
    }
    ...
    const std::vector<TileMatrix::ZoomLevel> &osmDroidZoomLevels3395() NOTHROWS {
        static std::vector<TileMatrix::ZoomLevel> z3857 = zoomLevels(3395, 1, 1);
        return z3857;
    }
    ...
    bool isCompatible(const TileMatrix &spec) NOTHROWS
    {
        ...
        switch(spec.getSRID()) {
            ...
            case 3857 :
                ...
                break;
            case 3395:
                zoomLevels = &osmDroidZoomLevels3395();
                bnds = bounds3395();
                break;
            default:
        ...
        db(std::move(database))
    {
        switch(info.srid) {
            ...
            case 3857 :
                ...
                break;
            case 3395:
                this->zoomLevels = osmDroidZoomLevels3395();
                this->bounds = bounds3395();
                break;
