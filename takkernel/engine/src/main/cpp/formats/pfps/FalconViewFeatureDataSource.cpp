...
atakmap::feature::Style *FalconViewDrwFileContent::createStyle(LineStyle line_style, FillStyle fill_style, int stroke_rgb, int fill_rgb,
    ...
    if (closed && fill_style != FillStyle::None) {
        ...
        styles.push_back(std::shared_ptr<atakmap::feature::Style>(new atakmap::feature::BasicFillStyle(fill_rgb_alpha)));
        styles.push_back(std::shared_ptr<atakmap::feature::Style>(createStrokeStyle(line_style, stroke_rgb, stroke_width)));
        if (include_label)
            styles.push_back(std::shared_ptr<atakmap::feature::Style>(new atakmap::feature::LabelPointStyle(feature_name_.c_str(), 0xFFFFFFFF, 0x00000000,
                                                                   atakmap::feature::LabelPointStyle::ScrollMode::DEFAULT)));
        style = new atakmap::feature::CompositeStyle(styles.data(), styles.size());
    } else {
