	...
	namespace Engine {
		namespace Util {
			...
			namespace Tasking {
				...
				template <typename R>
				struct TaskArgs<TAKErr(*)(R &) noexcept> {
					typedef R ResultType;
				};

				template <typename R, typename A0>
				struct TaskArgs<TAKErr(*)(R&, A0) noexcept> {
					typedef R ResultType;
					typedef CaptureOfT<A0> A0Type;
				};

				template <typename R, typename A0, typename A1>
				struct TaskArgs<TAKErr(*)(R&, A0, A1) noexcept> {
					typedef R ResultType;
					typedef CaptureOfT<A0> A0Type;
					typedef CaptureOfT<A1> A1Type;
				};
				...
				template <typename R, typename A0, typename A1, typename A2>
				struct TaskArgs<TAKErr(*)(R&, A0, A1, A2) noexcept> {
					typedef R ResultType;
					typedef CaptureOfT<A0> A0Type;
					typedef CaptureOfT<A1> A1Type;
					typedef CaptureOfT<A2> A2Type;
				...
				template <typename R, typename A0, typename A1, typename A2, typename A3>
				struct TaskArgs<TAKErr(*)(R&, A0, A1, A2, A3) noexcept> {
					typedef R ResultType;
					typedef CaptureOfT<A0> A0Type;
					typedef CaptureOfT<A1> A1Type;
					typedef CaptureOfT<A2> A2Type;
				...
				template <typename R, typename A0, typename A1, typename A2, typename A3,
					typename A4>
				struct TaskArgs<TAKErr(*)(R&, A0, A1, A2, A3, A4) noexcept> {
					typedef R ResultType;
					typedef CaptureOfT<A0> A0Type;
					typedef CaptureOfT<A1> A1Type;
					typedef CaptureOfT<A2> A2Type;
				...
				template <typename R, typename A0, typename A1, typename A2, typename A3,
					typename A4, typename A5>
					struct TaskArgs<TAKErr(*)(R&, A0, A1, A2, A3, A4, A5) noexcept> {
					typedef R ResultType;
					typedef CaptureOfT<A0> A0Type;
					typedef CaptureOfT<A1> A1Type;
					typedef CaptureOfT<A2> A2Type;
				...
				template <typename R, typename A0, typename A1, typename A2, typename A3,
					typename A4, typename A5, typename A6>
					struct TaskArgs<TAKErr(*)(R&, A0, A1, A2, A3, A4, A5, A6) noexcept> {
					typedef R ResultType;
					typedef CaptureOfT<A0> A0Type;
					typedef CaptureOfT<A1> A1Type;
					typedef CaptureOfT<A2> A2Type;
				...
				struct VoidTaskArgs<TAKErr(*)(A0) noexcept> {
					typedef VoidTaskResult ResultType;
					typedef CaptureOfT<A0> A0Type;
				};

				template <typename A0, typename A1>
				struct VoidTaskArgs<TAKErr(*)(A0, A1) noexcept> {
					typedef VoidTaskResult ResultType;
					typedef CaptureOfT<A0> A0Type;
					typedef CaptureOfT<A1> A1Type;
				};
