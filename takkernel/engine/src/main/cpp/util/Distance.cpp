...
struct DistanceConstants {
    ...
    explicit DistanceConstants(const TAK::Engine::Core::Ellipsoid2 &e);
...
computeDirection(const core::GeoPoint &point1,
    ...
    const ::DistanceConstants dconst(TAK::Engine::Core::Ellipsoid2::createWGS84());
...
namespace {
    DistanceConstants::DistanceConstants(const TAK::Engine::Core::Ellipsoid2 &e)
