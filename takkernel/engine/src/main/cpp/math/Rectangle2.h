...
namespace TAK
{
    namespace Engine
    {
        namespace Math
        {
            ...
            template<typename T>
            bool Rectangle2_contains(T aX1, T aY1, T aX2, T aY2, T pX, T pY);
            ...
            template<typename T>
            bool Rectangle2_contains(T aX1, T aY1, T aX2, T aY2, T bX1, T bY1, T bX2, T bY2);
            ...
            {
                contains = Rectangle2_contains(aX1, aY1, aX2, aY2, pX, pY);
                return Util::TE_Ok;
            }
            template<typename T>
            inline bool Rectangle2_contains(T aX1, T aY1, T aX2, T aY2, T pX, T pY)
            {
            ...
            {
                contains = Rectangle2_contains(aX1, aY1, aX2, aY2, bX1, bY1, bX2, bY2);
                return Util::TE_Ok;
            }
            template<typename T>
            inline bool Rectangle2_contains(T aX1, T aY1, T aX2, T aY2, T bX1, T bY1, T bX2, T bY2)
            {
