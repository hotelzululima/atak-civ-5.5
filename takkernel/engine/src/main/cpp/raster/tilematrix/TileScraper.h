        ...
        namespace Raster {
            namespace TileMatrix {
                ...
                private:
                    ...
                    friend ENGINE_API Util::TAKErr TileScraper_enableDebugTint(TileScraper& scraper) NOTHROWS;
                ...
                public:
                    ...
                    int getTotalTiles();
                    void getTilesDownloaded(int& tilesDownloaded, std::size_t& bytesDownloaded);
                ...
                private:
                    ...
                    public:
                        ...
                        std::size_t getBytesDownloaded();
                        int getTotalTiles();

                    private:
                        void downloadComplete(bool success, std::size_t downloadSize);
                        /**
                        ...
                        */
                        void getTiles(int col, int row, int level, int max, const std::vector<Math::Point2<double>>& points, bool closed);
                        Util::TAKErr getTiles(const Feature::Geometry2* geo);
                    ...
                    protected:
                        virtual void onDownloadExit(std::shared_ptr<ScrapeContext> context, int jobStatus) override;

                        virtual bool checkReadyForDownload(std::shared_ptr<ScrapeContext> context) override;
                        virtual void onLevelDownloadComplete(std::shared_ptr<ScrapeContext> context) override;
                        virtual Util::TAKErr downloadTileImpl(std::shared_ptr<ScrapeContext> context, int tileLevel,
                            int tileX, int tileY) override;
                    private:
                ...
                ENGINE_API Util::TAKErr TileScraper_enableDebugTint(TileScraper& scraper) NOTHROWS;
                ENGINE_API Util::TAKErr TileScraper_applyDebugTint(TAK::Engine::Renderer::BitmapPtr& bmp) NOTHROWS;
