    ...
    namespace Engine {
        namespace Raster {
            namespace TileMatrix {
                ...
                ENGINE_API Util::TAKErr TileContainerFactory_visitSpis(Util::TAKErr (*visitor)(void* opaque, TAK::Engine::Port::Collection<std::shared_ptr<TileContainerSpi>>& spis),
                ...
                ENGINE_API Util::TAKErr TileContainerFactory_visitCompatibleSpis(Util::TAKErr (*visitor)(void* opaque, TAK::Engine::Port::Collection<std::shared_ptr<TileContainerSpi>>& spis),
