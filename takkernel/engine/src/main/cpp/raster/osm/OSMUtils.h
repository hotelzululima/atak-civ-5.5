    ...
    namespace raster{
        namespace osm {
            ...
            public:
                ...
                static double mapnikTileXd(int level, double lng);
                static double mapnikTileYd(int level, double lat);
                ...
                static double mapnikTileResolution(double level, double lat);
