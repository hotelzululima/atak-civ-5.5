    ...
    namespace raster {
        namespace gdal {
            ...
            RapidPositioningControlB::RapidPositioningControlB(GDALDataset *dataset)
            {
                ...
                auto lineNumCoeff_md = dataset->GetMetadataItem("LINE_NUM_COEFF", "RPC");
                std::vector<std::string> lineNumCoeffStrs = util::splitString(
                    lineNumCoeff_md, util::whitespaceDelims
                );
                auto lineDenCoeff_md = dataset->GetMetadataItem("LINE_DEN_COEFF", "RPC");
                std::vector<std::string> lineDenCoeffStrs = util::splitString(
                    lineDenCoeff_md, util::whitespaceDelims
                );
            ...
            core::GeoPoint RapidPositioningControlB::inverse(const math::PointD &p) 
            {
            ...
            core::GeoPoint RapidPositioningControlB::inverse(const math::PointD point, const double elevation) 
            {
