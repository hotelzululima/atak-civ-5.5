...
#include "raster/pfps/PfpsMapType.h"
...
namespace {
    ...
    const int EAST_WEST_PIXEL_SPACING_CONSTANT[] = {
        369664, 302592, 245760, 199168, 163328, 137216, 110080, 82432, 400384
    };
    ...
    std::map<std::string, const char *> getPfpsKnownDirs() NOTHROWS
    {
        std::map<std::string, const char *> pfpsDirs;
        pfpsDirs["CA"] = "ccg15";
        pfpsDirs["CB"] = "ccg15500";
        pfpsDirs["CC"] = "ccg16";
        pfpsDirs["CD"] = "ccg16666";
        pfpsDirs["CE"] = "ccg17";
        pfpsDirs["CF"] = "ccg17500";
        pfpsDirs["CG"] = "ccg1M";
        pfpsDirs["CH"] = "ccg18";
        pfpsDirs["CJ"] = "ccg20";
        pfpsDirs["CK"] = "ccg21";
        pfpsDirs["CL"] = "ccg21120";
        //pfpsDirs["CM", 10000.0, PfpsMapType::SCALE_UNIT_SCALE, "cc10", "CADRG", "Combat Chart", "Raster"),
        //pfpsDirs["CM", 25000.0, PfpsMapType::SCALE_UNIT_SCALE, "cc25", "CADRG", "Combat Chart", "Raster"),
        //pfpsDirs["CM", 50000.0, PfpsMapType::SCALE_UNIT_SCALE, "cc50", "CADRG", "Combat Chart", "Raster"),
        //pfpsDirs["CM", 100000.0, PfpsMapType::SCALE_UNIT_SCALE, "cc100", "CADRG", "Combat Chart", "Raster"),
        pfpsDirs["CN"] = "ccg22";
        pfpsDirs["CP"] = "ccg23";
        pfpsDirs["CQ"] = "ccg25";
        pfpsDirs["CR"] = "ccg26";
        ...
        pfpsDirs["CT"] = "ccg36";
        pfpsDirs["C1"] = "ccg10";
        pfpsDirs["C2"] = "ccg10560";
        pfpsDirs["C3"] = "ccg11";
        pfpsDirs["C4"] = "ccg11800";
        pfpsDirs["C5"] = "ccg12";
        pfpsDirs["C6"] = "ccg12500";
        pfpsDirs["C7"] = "ccg12800";
        pfpsDirs["C8"] = "ccg14";
        pfpsDirs["C9"] = "ccg14700";
        pfpsDirs["GN"] = "cgnc";
        pfpsDirs["I1"] = "cib10";
        pfpsDirs["I2"] = "cib5";
        pfpsDirs["I3"] = "cib2";
        ...
        pfpsDirs["LN"] = "clfn";
        pfpsDirs["MI"] = "mim50";
        //pfpsDirs["MM", 50000.0, PfpsMapType::SCALE_UNIT_SCALE, "mm50", "CADRG", "MM", "Raster"),
        //pfpsDirs["MM", 100000.0, PfpsMapType::SCALE_UNIT_SCALE, "mm100", "CADRG", "MM", "Raster"),
        //pfpsDirs["MM", 250000.0, PfpsMapType::SCALE_UNIT_SCALE, "mm250", "CADRG", "MM", "Raster"),
        //pfpsDirs["MM", 25000.0, PfpsMapType::SCALE_UNIT_SCALE, "mm25", "CADRG", "MM", "Raster"),
        //pfpsDirs["MM", 200000.0, PfpsMapType::SCALE_UNIT_SCALE, "mm200", "CADRG", "MM", "Raster"),
        //pfpsDirs["MM", 24000.0, PfpsMapType::SCALE_UNIT_SCALE, "mm24", "CADRG", "MM", "Raster"),
        //pfpsDirs["MM", 145826.0, PfpsMapType::SCALE_UNIT_SCALE, "mm145", "CADRG", "MM", "Raster"),
        //pfpsDirs["MM", 500000.0, PfpsMapType::SCALE_UNIT_SCALE, "mm500", "CADRG", "MM", "Raster"),
        //pfpsDirs["MM", 1000000.0, PfpsMapType::SCALE_UNIT_SCALE, "mm1m", "CADRG", "MM", "Raster"),
        pfpsDirs["OH"] = "cvfr1M";
        pfpsDirs["ON"] = "conc";
        pfpsDirs["OW"] = "chfc1M";
        pfpsDirs["SA"] = "usa-sec";
    ...
    std::map<std::string, const char*> pfpsKnownDirs = getPfpsKnownDirs();

    struct PfpsMapDataType {
        const atakmap::raster::pfps::PfpsMapType mapType;
        const char *code;
        const char *abbr;
        ...
        PfpsMapDataType(const char *code, const char *abbr, const char *scaleOrRes, const char *descripString,
            ...
            PfpsMapDataType(code, abbr, scaleOrRes, descripString, rpfDataType, scaleOrGSD, abbr)
        {}
        ...
        PfpsMapDataType(const char *code, const char *abbr, const char *scaleOrRes, const char *descripString,
            ...
            mapType(code,
                    scaleOrGSD,
                    (rpfDataType == CIB_DATA_TYPE) ?
                        atakmap::raster::pfps::PfpsMapType::SCALE_UNIT_METER :
                        atakmap::raster::pfps::PfpsMapType::SCALE_UNIT_SCALE,
                    (pfpsKnownDirs.find(code) != pfpsKnownDirs.end()) ? pfpsKnownDirs[code] : nullptr,
                    rpfDataType,
                    abbr,
                    "Raster"),
            code(mapType.shortName),
            abbr(mapType.seriesName),
            scaleOrRes(scaleOrRes),
            descripString(descripString),
            rpfDataType(mapType.productName),
            scaleOrGSD(mapType.scale),
            prettyName(prettyName)
        {
            enumConstantDirectoryMap[(code[0]<<8u)|code[1]] = this;
        }


        static std::map<uint16_t, const PfpsMapDataType *> enumConstantDirectoryMap;

        static const std::map<uint16_t, const PfpsMapDataType *> *getEnumConstantDirectory() {
        ...
        static const PfpsMapDataType *getPfpsMapDataType(const char *code) {
            ...
            std::map<uint16_t, const PfpsMapDataType *>::iterator entry;
            entry = enumConstantDirectoryMap.find((toupper(code[0])<<8)|toupper(code[1]));
    ...
    std::map<uint16_t, const PfpsMapDataType *> PfpsMapDataType::enumConstantDirectoryMap;
        ...
        namespace pfps {
                                                        ...
                                                        core::GeoPoint &ur, core::GeoPoint& lr, core::GeoPoint &ll)
            {
                ...
                try {
                    ...
                    const auto ds = PfpsMapDataType::getPfpsMapDataType(pfpsMapDataTypeCode);
                    if (ds == nullptr)
                        return false;

                    const bool isCib = PfpsMapDataType::isCIBDataType(ds->rpfDataType);
            ...
            const PfpsMapType *PfpsMapTypeFrame::getMapType(const char *filename)
            {
                const auto len = strlen(filename);
                if (len != RPF_FILENAME_LENGTH && len != ECRG_FILENAME_LENGTH)
                    return nullptr;

                char pfpsMapDataTypeCode[3];
                pfpsMapDataTypeCode[0] = toupper(filename[len-3]);
                pfpsMapDataTypeCode[1] = toupper(filename[len-2]);
                pfpsMapDataTypeCode[2] = '\0';

                const auto retval = PfpsMapDataType::getPfpsMapDataType(pfpsMapDataTypeCode);
                return retval ? &retval->mapType : nullptr;
            }
