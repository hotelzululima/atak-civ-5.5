...
set(takengine_elevation_COMMON_SRCS
    ...
    ${SRC_DIR}/elevation/CascadingElevationSource.cpp
    ...
    ${SRC_DIR}/elevation/ElevationTileClient.cpp
    ${SRC_DIR}/elevation/GradientControl.cpp
    ${SRC_DIR}/elevation/MultiplexingElevationChunkCursor.cpp
    ${SRC_DIR}/elevation/MultiplexingElevationSource.cpp
    ${SRC_DIR}/elevation/ResolutionConstrainedElevationSource.cpp
    ${SRC_DIR}/elevation/TerrainSlopeAngleLayer.cpp
    ${SRC_DIR}/elevation/TileMatrixElevationSource.cpp
    ${SRC_DIR}/elevation/VirtualCLODElevationSource.cpp
)
...
set(takengine_feature_COMMON_SRCS
    ...
    ${SRC_DIR}/feature/DataDrivenStyleSheet.cpp
    ...
    ${SRC_DIR}/feature/FeatureCursor2Filter.cpp
    ${SRC_DIR}/feature/FeatureCursor3.cpp
    ...
    ${SRC_DIR}/feature/FeatureDataStore3.cpp
    ${SRC_DIR}/feature/FeatureDataStore3Adapter.cpp
    ...
    ${SRC_DIR}/feature/ReadOnlyFeatureDataStore2.cpp
    ...
    ${SRC_DIR}/feature/StyleSheet.cpp
...
set(takengine_formats_cesium3dtiles_COMMON_SRCS
	...
	${SRC_DIR}/formats/c3dt/CesiumNative.cpp
	${SRC_DIR}/formats/c3dt/CesiumUtility.cpp
	${SRC_DIR}/formats/c3dt/GLTFRenderer.cpp
	${SRC_DIR}/formats/c3dt/Model.cpp
	${SRC_DIR}/formats/c3dt/TakPrepareRendererResources.cpp
	${SRC_DIR}/formats/c3dt/TakTaskProcessor.cpp
	${SRC_DIR}/formats/c3dt/Tile.cpp
	${SRC_DIR}/formats/c3dt/TileExternalContent.cpp
	${SRC_DIR}/formats/c3dt/TileRenderContent.cpp
	${SRC_DIR}/formats/c3dt/Tileset.cpp
)
...
set (takengine_formats_mbtiles_COMMON_SRCS
    ${SRC_DIR}/formats/mbtiles/MapBoxGLStyleSheet.cpp
...
set(takengine_model_COMMON_SRCS
    ...
    ${SRC_DIR}/model/MeshSimplification.cpp
...
set(takengine_raster_tilematrix_COMMON_SRCS
    ${SRC_DIR}/raster/tilematrix/LRUTileContainer.cpp
    ${SRC_DIR}/raster/tilematrix/TileClient.cpp
    ${SRC_DIR}/raster/tilematrix/TileClientFactory.cpp
    ${SRC_DIR}/raster/tilematrix/TileContainer.cpp
...
set(takengine_renderer_base_COMMON_SRCS
    ...
    ${SRC_DIR}/renderer/shaders/LinesEmulation.frag
    ${SRC_DIR}/renderer/shaders/LinesEmulation.vert
)
...
set(takengine_renderer_core_COMMON_SRCS
    ...
    ${SRC_DIR}/renderer/core/ContentControl.cpp
    ...
    ${SRC_DIR}/renderer/core/GLGlyphBatch2.cpp
    ...
    ${SRC_DIR}/renderer/core/GLGlyphAtlas2.cpp
)

set(takengine_renderer_core_controls_COMMON_SRCS
    ${SRC_DIR}/renderer/core/controls/SurfaceRendererControl.cpp
    ${SRC_DIR}/renderer/core/controls/ClampToGroundControl.cpp
    ${SRC_DIR}/renderer/core/controls/ElevationSourceControl.cpp
    ${SRC_DIR}/renderer/core/controls/FeaturesLabelControl.cpp
...
set(takengine_renderer_elevation_COMMON_SRCS
    ...
    ${SRC_DIR}/renderer/elevation/TerrainTile.cpp
...
set(takengine_renderer_feature_COMMON_SRCS
    ...
    ${SRC_DIR}/renderer/feature/BatchGeometryArrowLines.frag
    ${SRC_DIR}/renderer/feature/BatchGeometryArrowLines.vert
    ${SRC_DIR}/renderer/feature/BatchGeometryMeshes.frag
    ${SRC_DIR}/renderer/feature/BatchGeometryMeshes.vert
    ...
    ${SRC_DIR}/renderer/feature/GLVectorTiles.cpp
...
set(takengine_util_COMMON_SRCS
    ...
    ${SRC_DIR}/util/CachingService.cpp
...
set(takengine_elevation_COMMON_HEADERS
    ...
    ${SRC_DIR}/elevation/ElevationTileClient.h
    ${SRC_DIR}/elevation/HeightmapParams.h
...
set(takengine_feature_COMMON_HEADERS
    ...
    ${SRC_DIR}/feature/DataDrivenStyleSheet.h
    ...
    ${SRC_DIR}/feature/FeatureCursor2Filter.h
    ${SRC_DIR}/feature/FeatureCursor3.h
    ...
    ${SRC_DIR}/feature/FeatureDataStore3.h
    ${SRC_DIR}/feature/FeatureDataStore3Adapter.h
    ...
    ${SRC_DIR}/feature/ReadOnlyFeatureDataStore2.h
...
set(takengine_formats_cesium3dtiles_COMMON_HEADERS
	...
	${SRC_DIR}/formats/c3dt/CesiumNative.h
	${SRC_DIR}/formats/c3dt/TakPrepareRendererResources.h
	${SRC_DIR}/formats/c3dt/TakTaskProcessor.h
)
...
set (takengine_formats_mbtiles_COMMON_HEADERS
    ${SRC_DIR}/formats/mbtiles/earcut.hpp
    ${SRC_DIR}/formats/mbtiles/MapBoxGLStyleSheet.h
    ...
    ${SRC_DIR}/formats/mbtiles/VectorTile.h
)
...
set(takengine_model_COMMON_HEADERS
    ...
    ${SRC_DIR}/model/MeshSimplification.h
...
set(takengine_renderer_base_COMMON_HEADERS
    ...
    ${SRC_DIR}/renderer/RenderContextAssociatedCache.h
    ${SRC_DIR}/renderer/RenderState.h
...
set(takengine_renderer_core_COMMON_HEADERS
    ...
    ${SRC_DIR}/renderer/core/ContentControl.h
    ...
    ${SRC_DIR}/renderer/core/GLLabel.h
    ${SRC_DIR}/renderer/core/GLLabelManager.h
    ${SRC_DIR}/renderer/core/GLGlyphBatch2.h
    ...
    ${SRC_DIR}/renderer/core/GLGlyphAtlas2.h
    ${SRC_DIR}/renderer/core/TiledGlobe.h
)

set(takengine_renderer_core_controls_COMMON_HEADERS
    ${SRC_DIR}/renderer/core/controls/ClampToGroundControl.h
    ${SRC_DIR}/renderer/core/controls/ElevationSourceControl.h
    ${SRC_DIR}/renderer/core/controls/SurfaceRendererControl.h
    ${SRC_DIR}/renderer/core/controls/FeaturesLabelControl.h
...
set(takengine_util_COMMON_HEADERS
    ...
    ${SRC_DIR}/util/StringMap.h
    ${SRC_DIR}/util/StringSet.h
