    ...
    namespace Engine {
        namespace Port {
            ...
            public: // constructors
                ...
                String(String&&) NOTHROWS;        // Copies supplied String.
            ...
            public: // operator overload
                ...
                String& operator= (String&&)NOTHROWS;
            ...
            private:
                struct {
                    ...
                    std::unique_ptr<char, void(*)(const char*)> heap{nullptr, nullptr};
                    bool heapAlloc{true};
                    bool shared{false};
                } data;

                friend ENGINE_API String String_intern(const char *value) NOTHROWS;
                friend ENGINE_API String String_intern(const String &value) NOTHROWS;
            };
            ...
            ENGINE_API TAK::Engine::Port::String String_intern(const char* value) NOTHROWS;
            ENGINE_API TAK::Engine::Port::String String_intern(const String &value) NOTHROWS;
