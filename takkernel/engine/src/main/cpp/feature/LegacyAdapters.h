...
namespace TAK {
    namespace Engine {
        namespace Feature {
            ...
            ENGINE_API Util::TAKErr LegacyAdapters_adapt(FeatureDefinition3Ptr &value, FeatureDefinition2 &legacy) NOTHROWS;
            ...
            ENGINE_API Util::TAKErr LegacyAdapters_adapt(FeatureCursor3Ptr &value, FeatureCursorPtr &legacy) NOTHROWS;
