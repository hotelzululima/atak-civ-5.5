...
namespace TAK {
    namespace Engine {
        namespace Feature {
            ...
            ENGINE_API Util::TAKErr GeometryTransformer_forward(Envelope2 *value, const Envelope2 &src, const TAK::Engine::Core::Projection2 &proj) NOTHROWS;
            ENGINE_API Util::TAKErr GeometryTransformer_inverse(Envelope2 *value, const Envelope2 &src, const TAK::Engine::Core::Projection2 &proj) NOTHROWS;
        }
    }
}
#endif
