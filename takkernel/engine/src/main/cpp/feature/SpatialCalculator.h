...
namespace atakmap {
    ...
    namespace feature {
        ...
        */
        ...
        private:
            std::unique_ptr<atakmap::db::Database> database;

            QuadBlob quad;

            std::unique_ptr<atakmap::db::Statement> insertGeomWkt;
            std::unique_ptr<atakmap::db::Statement> insertGeomBlob;
            std::unique_ptr<atakmap::db::Statement> bufferInsert;
            std::unique_ptr<atakmap::db::Statement> bufferUpdate;
            std::unique_ptr<atakmap::db::Statement> intersectionInsert;
            std::unique_ptr<atakmap::db::Statement> intersectionUpdate;
            std::unique_ptr<atakmap::db::Statement> unionInsert;
            std::unique_ptr<atakmap::db::Statement> unionUpdate;
            std::unique_ptr<atakmap::db::Statement> unaryUnionInsert;
            std::unique_ptr<atakmap::db::Statement> unaryUnionUpdate;
            std::unique_ptr<atakmap::db::Statement> differenceInsert;
            std::unique_ptr<atakmap::db::Statement> differenceUpdate;
            std::unique_ptr<atakmap::db::Statement> simplifyInsert;
            std::unique_ptr<atakmap::db::Statement> simplifyUpdate;
            std::unique_ptr<atakmap::db::Statement> simplifyPreserveTopologyInsert;
            std::unique_ptr<atakmap::db::Statement> simplifyPreserveTopologyUpdate;
            std::unique_ptr<atakmap::db::Statement> clearMem;
            std::unique_ptr<atakmap::db::Statement> deleteGeom;

            std::unique_ptr<atakmap::db::Statement> updateGeomBlob;
            std::unique_ptr<atakmap::db::Statement> updateGeomWkt;
        };
