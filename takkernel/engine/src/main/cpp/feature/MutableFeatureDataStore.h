////============================================================================
////
////    FILE:           MutableFeatureDataStore.h
////
...
#ifndef ATAKMAP_FEATURE_MUTABLE_FEATURE_DATA_STORE_H_INCLUDED
#define ATAKMAP_FEATURE_MUTABLE_FEATURE_DATA_STORE_H_INCLUDED
...
///=============================================================================
///
///  class atakmap::feature::MutableFeatureDataStore
///
...
class MutableFeatureDataStore
  ...
  public:                               //                      PUBLIC        //
    ...
    MutableFeatureDataStore (const char* filePath);

    ~MutableFeatureDataStore ()
        NOTHROWS
      { }
  ...
  private:                              //                      PRIVATE       //
    ...
    PGSC::String URI;
    std::unique_ptr<FeatureDatabase> featureDB;
    bool inTransaction;
...
#endif  // #ifndef ATAKMAP_FEATURE_MUTABLE_FEATURE_DATA_STORE_H_INCLUDED
