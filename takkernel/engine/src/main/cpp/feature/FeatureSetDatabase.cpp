...
FeatureSetDatabase::FeatureSetDatabase(int modificationFlags, int visibilityFlags) NOTHROWS :
    FeatureSetDatabase(modificationFlags, visibilityFlags, false)
{}

FeatureSetDatabase::FeatureSetDatabase(int modificationFlags, int visibilityFlags, bool readOnly) NOTHROWS :
    FDB(modificationFlags, visibilityFlags, readOnly)
{}
