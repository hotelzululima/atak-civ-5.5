        ...
        namespace Feature {
            ...
            */
            ...
            public :
                ...
                /** Deprecated - use Feature2(..., Traits traits, ...) */
                ...
                Feature2(const int64_t fid, const int64_t fsid, const char *name, const atakmap::feature::Geometry &geom,
                         const atakmap::feature::Style *style, const atakmap::util::AttributeSet &attributes, const Traits &traits,
                         const int64_t timestamp, const int64_t version) NOTHROWS;
                Feature2(const int64_t fid, const int64_t fsid, const char *name, GeometryPtr_const &&geom,
                         StylePtr_const &&style, AttributeSetPtr_const &&attributes, const Traits &traits,
                         const int64_t timestamp, const int64_t version) NOTHROWS;
            public :
                ~Feature2() NOTHROWS;
            ...
            public :
                ...
                */
                 ...
                 */
                /** Deprecated - use getTraits().altitudeMode */
                 ...
                 */
                /** Deprecated - use getTraits().extrude */
                const double getExtrude() const NOTHROWS;
                /**
                 * Returns traits for the feature.
                 *
                 * @return  The traits of the feature.
                 */
                const Traits getTraits() const NOTHROWS;
                /**
            ...
            ENGINE_API Util::TAKErr Feature_create(FeaturePtr_const &feature, const int64_t fid, const int64_t fsid, FeatureDefinition2 &def, const int64_t version) NOTHROWS;
            ENGINE_API Util::TAKErr Feature_create(FeaturePtr_const &feature, FeatureDefinition3 &def) NOTHROWS;
            ENGINE_API Util::TAKErr Feature_create(FeaturePtr_const &feature, const int64_t fid, const int64_t fsid, FeatureDefinition3 &def, const int64_t version) NOTHROWS;
