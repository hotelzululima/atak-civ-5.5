    ...
    namespace Engine {
        namespace Feature {
            ...
            public :
                ...
                PersistentDataSourceFeatureDataStore2(bool readOnly) NOTHROWS;
            public :
                ~PersistentDataSourceFeatureDataStore2() NOTHROWS;
            ...
            public:
                ...
                virtual Util::TAKErr setReadOnly(bool value) NOTHROWS;
            private :
            ...
            private :
                struct LT_featureSetName
                {
                    bool operator()(const std::shared_ptr<const FeatureDb> &a, const std::shared_ptr<const FeatureDb> &b) const
                    {
                        ...
                        // names are equal, deconflict on public FSID
