...
Feature2::Feature2(const int64_t fid_, const int64_t fsid_, const char *name_, const atakmap::feature::Geometry &geom_,
    ...
    traits(Traits{altitudeMode_, extrude_}),
...
Feature2::Feature2(const int64_t fid_, const int64_t fsid_, const char *name_, const atakmap::feature::Geometry &geom_,
         const TAK::Engine::Feature::AltitudeMode altitudeMode_, double extrude_, const atakmap::feature::Style *style_,
         const atakmap::util::AttributeSet &attributes_, const int64_t version_) NOTHROWS
    :
    id(fid_),
    setId(fsid_),
    ...
    geometry(geom_.clone(), atakmap::feature::destructGeometry),
    traits(Traits{altitudeMode_, extrude_}),
    style(style_ ? style_->clone() : nullptr, atakmap::feature::Style::destructStyle),
    attributes(new atakmap::util::AttributeSet(attributes_), deleter<const atakmap::util::AttributeSet>),
    timestamp(0)
{}
...
Feature2::Feature2(const int64_t fid_, const int64_t fsid_, const char *name_, const atakmap::feature::Geometry &geom_,
        ...
        traits(Traits{altitudeMode_,extrude_}),
        style(style_ ? style_->clone() : nullptr, atakmap::feature::Style::destructStyle),
        attributes(attributes_ ? new atakmap::util::AttributeSet(*attributes_) : nullptr, deleter<const atakmap::util::AttributeSet>),
        timestamp(0)
{}
...
Feature2::Feature2(const int64_t fid_, const int64_t fsid_, const char *name_, const atakmap::feature::Geometry &geom_,
                   const atakmap::feature::Style *style_, const atakmap::util::AttributeSet &attributes_, const Traits &traits_,
                   const int64_t timestamp_, const int64_t version_) NOTHROWS :
        id(fid_),
        setId(fsid_),
        version(version_),
...
Feature2::Feature2(const int64_t fid_, const int64_t fsid_, const char *name_, GeometryPtr_const &&geom_,
                   StylePtr_const &&style_, AttributeSetPtr_const &&attributes_, const Traits &traits_,
                   const int64_t timestamp_, const int64_t version_) NOTHROWS :
        id(fid_),
        setId(fsid_),
        version(version_),
...
{ 
    return this->traits.altitudeMode;
}

const double Feature2::getExtrude() const NOTHROWS 
{ 
    return this->traits.extrude;
}
...
const Traits Feature2::getTraits() const NOTHROWS
{
    return this->traits;
}
...
{
    return Feature_create(feature, FeatureDataStore2::FEATURE_ID_NONE,
                          FeatureDataStore2::FEATURESET_ID_NONE, def,
                          FeatureDataStore2::FEATURE_VERSION_NONE);
}

TAKErr TAK::Engine::Feature::Feature_create(FeaturePtr_const &feature, FeatureDefinition3 &def) NOTHROWS
{
    return Feature_create(feature, FeatureDataStore2::FEATURE_ID_NONE,
                          FeatureDataStore2::FEATURESET_ID_NONE, def,
                          FeatureDataStore2::FEATURE_VERSION_NONE);
...
{
    FeatureDefinition3Ptr def3(nullptr, nullptr);
    TAK::Engine::Feature::LegacyAdapters_adapt(def3, def);
    return Feature_create(feature, fid, fsid, *def3, version);
}

TAKErr TAK::Engine::Feature::Feature_create(FeaturePtr_const &feature, const int64_t fid, const int64_t fsid, FeatureDefinition3 &def, const int64_t version) NOTHROWS
{
    TAKErr code;
