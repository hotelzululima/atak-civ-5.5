    ...
    namespace Engine {
        namespace Elevation {
            ...
            */
            ...
            ENGINE_API Util::TAKErr ElevationManager_queryElevationSources(ElevationChunkCursorPtr &value, const std::shared_ptr<ElevationSource> *sources, const std::size_t numSources, const ElevationSource::QueryParameters &params) NOTHROWS;
            ...
            */
            ...
            /**
             * Constructs a heightmap from all available sources.
             * 
             * @param value     Returns the heightmap
             ...
             * @return  TE_Ok on success, TE_Done if one or more posts are not resolved; various
             *          codes on failure
             */
            Util::TAKErr ENGINE_API ElevationManager_createHeightmap(double* value, const double gsd, const HeightmapParams &params, const HeightmapStrategy strategy = HighestResolution) NOTHROWS;

            /**
             * Constructs a heightmap from the specified `ElevationSource`.
             * 
             * @param value     Returns the heightmap
             ...
             *          codes on failure
             */
            Util::TAKErr ENGINE_API ElevationManager_createHeightmap(double* value, ElevationSource &source, const double gsd, const HeightmapParams &params, const HeightmapStrategy strategy = HighestResolution) NOTHROWS;

            /**
             * Constructs a heightmap from the specified chunks.
             * 
             * @param value     Returns the heightmap
             * @param cursor    Provides the chunks that will populate the heightmap
             * @param params    The heightmap configuration
             * @return  TE_Ok on success, TE_Done if one or more posts are not resolved; various
             *          codes on failure
             */
            Util::TAKErr ENGINE_API ElevationManager_createHeightmap(double* value, ElevationChunkCursor &cursor, const HeightmapParams &params) NOTHROWS;
        }
    }
}
