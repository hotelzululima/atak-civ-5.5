...
namespace TAK {
    namespace Engine {
        namespace Elevation {
            ...
            ENGINE_API Util::TAKErr ElevationChunkFactory_meshFromHeightmap(Model::MeshPtr &value, const float *heightmap, const std::size_t tileWidth, const std::size_t tileHeight, const Feature::Envelope2 &tileBounds, const HeightmapNoData noData, const Port::DataType posType = Port::TEDT_Float32) NOTHROWS;
            ENGINE_API Util::TAKErr ElevationChunkFactory_meshFromHeightmap(Model::MeshPtr &value, const double *heightmap, const std::size_t tileWidth, const std::size_t tileHeight, const Feature::Envelope2 &tileBounds, const HeightmapNoData noData, const Port::DataType posType = Port::TEDT_Float64) NOTHROWS;
        }
    }
}
