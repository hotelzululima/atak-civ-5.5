  ...
  (JNIEnv *env, jclass clazz, jstring jpath, jboolean readOnly)
{
    ...
    DataStoreImplPtr retval(new PersistentDataSourceFeatureDataStore2(readOnly), Memory_deleter_const<PersistentDataSourceFeatureDataStore2>);
...
JNIEXPORT void JNICALL Java_com_atakmap_map_layer_feature_PersistentDataSourceFeatureDataStore2_setReadOnly
