#include "gov_tak_api_engine_map_coords_GeoCalculations.h"
...
#define TEJNI_GC_HAS_FLAG(b, f) \
    ((b)&(gov_tak_api_engine_map_coords_GeoCalculations_##f))

JNIEXPORT jdouble JNICALL Java_gov_tak_api_engine_map_coords_GeoCalculations_distance
        (JNIEnv *, jclass, jdouble lat1, jdouble lng1, jdouble alt1, jdouble lat2, jdouble lng2, jdouble alt2, jint flags)
{
...
JNIEXPORT jdouble JNICALL Java_gov_tak_api_engine_map_coords_GeoCalculations_slantAngle
...
JNIEXPORT jdouble JNICALL Java_gov_tak_api_engine_map_coords_GeoCalculations_bearing
...
JNIEXPORT jobject JNICALL Java_gov_tak_api_engine_map_coords_GeoCalculations_midpoint
  (JNIEnv *env, jclass clazz, jdouble lat1, jdouble lng1, jdouble alt1, jdouble lat2, jdouble lng2, jdouble alt2, jint flags)
{
    const GeoPoint2 a(lat1, lng1, alt1, AltitudeReference::HAE);
    const GeoPoint2 b(lat2, lng2, alt2, AltitudeReference::HAE);
...
JNIEXPORT jobject JNICALL Java_gov_tak_api_engine_map_coords_GeoCalculations_pointAtDistance__DDDDI
...
JNIEXPORT jobject JNICALL Java_gov_tak_api_engine_map_coords_GeoCalculations_pointAtDistance__DDDDDDI
...
JNIEXPORT jobject JNICALL Java_gov_tak_api_engine_map_coords_GeoCalculations_lineOfBearingIntersect
...
namespace
{
    bool init(JNIEnv &env) NOTHROWS
    {
        GeoPoint_class.id = ATAKMapEngineJNI_findClass(&env, "gov/tak/api/engine/map/coords/GeoPoint");
