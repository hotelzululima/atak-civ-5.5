...
JNIEXPORT jobject JNICALL Java_com_atakmap_map_layer_feature_NativeFeatureCursor_wrap
  (JNIEnv *env, jclass clazz, jobject mcursor)
{
    FeatureCursorPtr retval(new ManagedFeatureCursor(*env, mcursor), Memory_deleter_const<FeatureCursor2, ManagedFeatureCursor>);
    return NewPointer(env, std::move(retval));
}
JNIEXPORT jboolean JNICALL Java_com_atakmap_map_layer_feature_NativeFeatureCursor_hasObject
  (JNIEnv *env, jclass clazz, jlong ptr)
{
    auto ccursor = JLONG_TO_INTPTR(const FeatureCursor2, ptr);
    return !!dynamic_cast<const ManagedFeatureCursor *>(ccursor);
}
JNIEXPORT jobject JNICALL Java_com_atakmap_map_layer_feature_NativeFeatureCursor_getObject
  (JNIEnv *env, jclass clazz, jlong ptr)
{
    auto ccursor = JLONG_TO_INTPTR(const FeatureCursor2, ptr);
    auto cimpl = dynamic_cast<const ManagedFeatureCursor *>(ccursor);
    return !!cimpl ? cimpl->cimpl.impl : nullptr;
}
...
JNIEXPORT jlong JNICALL Java_com_atakmap_map_layer_feature_NativeFeatureCursor_asFeatureDefinition
  (JNIEnv *env, jclass clazz, jlong ptr)
{
    return INTPTR_TO_JLONG(static_cast<FeatureDefinition2 *>(JLONG_TO_INTPTR(FeatureCursor2, ptr)));
}
...
JNIEXPORT jlong JNICALL Java_com_atakmap_map_layer_feature_NativeFeatureCursor_getTimestamp
  (JNIEnv *env, jclass clazz, jlong pointer)
{
    auto ccursor = JLONG_TO_INTPTR(FeatureCursor2, pointer);
    auto cimpl = dynamic_cast<ManagedFeatureCursor *>(ccursor);
...
JNIEXPORT jobject JNICALL Java_com_atakmap_map_layer_feature_NativeFeatureCursor_getTraits
        (JNIEnv *env, jclass clazz, jlong ptr)
{
    FeatureCursor2 *result = JLONG_TO_INTPTR(FeatureCursor2, ptr);
    if(!result) {
    ...
    Traits traits;
    auto result3 = dynamic_cast<FeatureCursor3 *>(result);
    if (result3) {
