...
public class GLMapRenderer implements GLSurfaceView.Renderer
{
    ...
    private String currentFramerateStr = "";
    ...
    public void onDrawFrame(GL10 arg0)
    {
        ...
        } else if (count > 1000)
        {
            ...
            currentFramerateStr = String.format("FPS %.2f", currentFramerate);
        ...
        if (mapView.isRenderDiagnosticsEnabled())
             mapView.addRenderDiagnostic(currentFramerateStr);
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height)
    {
        ...
        this.mapView.currentScene.left = 0;
        this.mapView.currentScene.bottom = 0;
        this.mapView.currentScene.right = GLMapView.MATCH_SURFACE;
        this.mapView.currentScene.top = GLMapView.MATCH_SURFACE;
    ...
    public void onSurfaceCreated(GL10 arg0, EGLConfig arg1)
    {
        ...
        // Set unpack alignment to 1; we do not pad image rows
