...
public final class Log
{
    ...
    static int android_util_Log_println(int priority, String tag, String msg)
    {
        ...
        {
            case VERBOSE:
                return android_util_Log_v(tag, msg, null);
            case DEBUG:
                return android_util_Log_d(tag, msg, null);
            case INFO:
                return android_util_Log_i(tag, msg, null);
            case WARN:
                return android_util_Log_w(tag, msg, null);
            case ERROR:
                return android_util_Log_e(tag, msg, null);
            default:
                return android_util_Log_i(tag, msg, null);
        }
    }
