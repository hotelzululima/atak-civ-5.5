...
public class GeometryFactoryTests extends KernelJniTest {
    ...
    public void createEllipse2() {
        ...
        // Observed failures here because of the theoretical double precision limit (15 digits),
        // so adding delta of +-1 at 15th fixes it
        assertEquals(-0.9709150725244005, lineString.getY(222), 1e-15);
    ...
    public void createRectangle3() {
        ...
        // Observed failures here because of the theoretical double precision limit (15 digits),
        // so adding delta of +-1 at 15th fixes it
        assertEquals(0.999933546966112, lineString.getY(0), 1e-15);
