...
public class IconPointStyleTests extends KernelJniTest {
    ...
    public void IconPointStyle_constructor_2_align_CC_roundtrip() {
        ...
        IconPointStyle style = new IconPointStyle(color, uri, width, height,
                offsetX, offsetY, alignX, alignY, rotation, rotationAbsolute);
        Assert.assertEquals(style.getColor(), color);
        Assert.assertEquals(style.getIconUri(), uri);
        ...
        Assert.assertEquals(offsetX, style.getIconOffsetX(), 0.0);
        Assert.assertEquals(offsetY, style.getIconOffsetY(), 0.0);
    }
    ...
    static IconPointStyle random() {
        ...
        final int offsetX = 50 - RandomUtils.rng().nextInt(100);
        final int offsetY = 50 - RandomUtils.rng().nextInt(100);
        return new IconPointStyle(color, uri, width, height, offsetX, offsetY,
