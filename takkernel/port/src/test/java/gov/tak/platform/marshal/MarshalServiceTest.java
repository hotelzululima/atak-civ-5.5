...
public class MarshalServiceTest
{
    ...
    public void registerArrayPing()
    {
        ...
        Assert.assertNull(output, service.marshal(new Integer[] {input}, Integer.class, String.class));
        service.registerMarshal(m, Integer.class, String.class);

        Assert.assertSame(output, service.marshal(new Integer[] {input}, Integer.class, String.class)[0]);
    }
