...
public class Matrix
{
                                  ...
                                  float[] lhs, int lhsOffset, float[] rhs, int rhsOffset)
    {
        ...
        result[resultOffset + 0] = rm00;
        result[resultOffset + 4] = rm01;
        result[resultOffset + 8] = rm02;
        result[resultOffset + 12] = rm03;
        result[resultOffset + 1] = rm10;
        result[resultOffset + 5] = rm11;
        result[resultOffset + 9] = rm12;
        result[resultOffset + 13] = rm13;
        result[resultOffset + 2] = rm20;
        result[resultOffset + 6] = rm21;
        result[resultOffset + 10] = rm22;
        result[resultOffset + 14] = rm23;
        result[resultOffset + 3] = rm30;
        result[resultOffset + 7] = rm31;
        result[resultOffset + 11] = rm32;
        result[resultOffset + 15] = rm33;
    }
