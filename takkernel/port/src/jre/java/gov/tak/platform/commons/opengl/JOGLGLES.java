...
public final class JOGLGLES
{
    ...
    final static IdentityHashMap<GLContext, VertexAttribArrays> vertexAttribArrays = new IdentityHashMap<>();
    ...
    public static VertexAttribArrays vertexAttribArrays()
    {
        GLContext currentContext = GLContext.getCurrent();
        if (currentContext == null)
            throw new IllegalStateException("No current GL context");
        return vertexAttribArrays.computeIfAbsent(currentContext, c -> new VertexAttribArrays());
    }
