...
public final class MotionEvent
{
    ...
    private static class PointerNode
    {
        ...
        public void copyFrom(PointerCoords coords, PointerProperties props)
        {
    ...
    private void initOverheadValues(long downTime, long eventTime, int action,
                                    int metaState, int buttonState, int clickGestureCount, float xPrecision, float yPrecision,
                                    int deviceId, int edgeFlags, int source, int flags)
    {
        ...
        this.clickGestureCount = clickGestureCount;
     ...
     * @param metaState
     * @param buttonState
     * @param clickGestureCount number of click gestures detected
     * @param xPrecision
     * @param yPrecision
     * @param deviceId
     * @param edgeFlags
                                     ...
                                     int deviceId, int edgeFlags, int source, int flags)
    {
        ...
        event.initOverheadValues(downTime, eventTime, action, metaState, buttonState, clickGestureCount,
    ...
    public static MotionEvent obtain(long downTime, long eventTime, int action, int pointerCount,
        ...
        return obtain(downTime, eventTime, action, pointerCount, pointerProperties, pointerCoords,
                metaState, buttonState, 0, xPrecision, yPrecision, deviceId, edgeFlags, source, flags);
    }
                                     ...
                                     float yPrecision, int deviceId, int edgeFlags)
    {
        ...
        event.initOverheadValues(downTime, eventTime, action, metaState, 0, 0, xPrecision, yPrecision,
    ...
    public static MotionEvent obtain(MotionEvent other)
    {
        ...
        event.initOverheadValues(other.downTime, other.eventTime, other.action, other.metaState, other.buttonState,
                other.clickGestureCount, other.xPrecision, other.yPrecision, other.deviceId, other.edgeFlags, other.source, other.flags);
    ...
    /**
     * Get the click gesture count when repeated press/release cycles produce gestures
     * like double-click
     *
     * @return number of clicks detected
     */
    public int getClickGestureCount() { return clickGestureCount; }
    ...
    public static String axisToString(int axis)
    {
        switch (axis)
        {
            ...
            case AXIS_GENERIC_10:
                return "AXIS_GENERIC_10";
            case AXIS_GENERIC_11:
                return "AXIS_GENERIC_11";
            case AXIS_GENERIC_12:
                return "AXIS_GENERIC_12";
            case AXIS_GENERIC_13:
                return "AXIS_GENERIC_13";
            case AXIS_GENERIC_14:
                return "AXIS_GENERIC_14";
            case AXIS_GENERIC_15:
                return "AXIS_GENERIC_15";
            case AXIS_GENERIC_16:
