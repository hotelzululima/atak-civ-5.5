...
public class Color
{
    ...
    public static void colorToHSV(int color, float[] hsv)
    {
        ...
        final float R = red(color) / 255f;
        final float G = green(color) / 255f;
        final float B = blue(color) / 255f;

        final float Cmax = Math.max(R, Math.max(G, B));
