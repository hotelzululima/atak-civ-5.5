...
2. Download and install [CMake 3.21.0 or later](https://cmake.org/download/). Make sure it is added to `PATH`.

3. Download and install [Python 3+](https://www.python.org/downloads/). Make sure it is added to `PATH`.

4. Install Conan using Python by executing the following command: `pip3 install --upgrade "conan==1.65.0"`
